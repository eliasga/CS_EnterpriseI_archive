...
#
# File    : NonlinearPassiveObserver.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= NonlinearPassiveObserver
MODULES         		:= NIVeriStand_main.c NonlinearPassiveObserver_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE        		:= NonlinearPassiveObserver.mk
...
MODELLIB                  := NonlinearPassiveObserverlib.lib
MODELREF_LINK_LIBS   	  := 
MODELREF_INC_PATH         := 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\NonlinearPassiveObserver_niVeriStand_VxWorks_rtw
