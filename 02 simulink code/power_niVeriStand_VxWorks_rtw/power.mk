...
#
# File    : power.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= power
MODULES         		:= NIVeriStand_main.c power_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		:= power.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\DOCUME~1\GitHub\CS_ENT~1\02SIMU~1\power_niVeriStand_VxWorks_rtw
