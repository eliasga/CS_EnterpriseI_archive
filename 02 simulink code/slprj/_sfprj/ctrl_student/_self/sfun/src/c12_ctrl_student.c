...
static void initialize_c12_ctrl_student(SFc12_ctrl_studentInstanceStruct
  *chartInstance);
static void initialize_params_c12_ctrl_student(SFc12_ctrl_studentInstanceStruct *
  chartInstance);
static void enable_c12_ctrl_student(SFc12_ctrl_studentInstanceStruct
  *chartInstance);
static void disable_c12_ctrl_student(SFc12_ctrl_studentInstanceStruct
  *chartInstance);
static void c12_update_debugger_state_c12_ctrl_student
  (SFc12_ctrl_studentInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_ctrl_student
  (SFc12_ctrl_studentInstanceStruct *chartInstance);
static void set_sim_state_c12_ctrl_student(SFc12_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c12_st);
static void finalize_c12_ctrl_student(SFc12_ctrl_studentInstanceStruct
  *chartInstance);
static void sf_gateway_c12_ctrl_student(SFc12_ctrl_studentInstanceStruct
  *chartInstance);
static void initSimStructsc12_ctrl_student(SFc12_ctrl_studentInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber, uint32_T c12_instanceNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_emlrt_marshallIn(SFc12_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c12_tau_r, const char_T *c12_identifier);
static real_T c12_b_emlrt_marshallIn(SFc12_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_b_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_c_emlrt_marshallIn(SFc12_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId,
  real_T c12_y[3]);
...
static void c12_eml_scalar_eg(SFc12_ctrl_studentInstanceStruct *chartInstance);
static void c12_eml_xgemm(SFc12_ctrl_studentInstanceStruct *chartInstance,
...
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_d_emlrt_marshallIn(SFc12_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_e_emlrt_marshallIn(SFc12_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c12_b_is_active_c12_ctrl_student, const char_T *
  c12_identifier);
static uint8_T c12_f_emlrt_marshallIn(SFc12_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_b_eml_xgemm(SFc12_ctrl_studentInstanceStruct *chartInstance,
  real_T c12_A[9], real_T c12_B[3], real_T c12_C[3]);
static void init_dsm_address_info(SFc12_ctrl_studentInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_ctrl_student = 0U;
}
  ...
  (SFc12_ctrl_studentInstanceStruct *chartInstance)
{
  ...
  c12_d_hoistedGlobal = chartInstance->c12_is_active_c12_ctrl_student;
  ...
  *chartInstance, const mxArray *c12_st)
{
  ...
  *c12_tau_v = c12_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c12_u, 2)), "tau_v");
  chartInstance->c12_is_active_c12_ctrl_student = c12_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 3)),
     "is_active_c12_ctrl_student");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_ctrl_student(chartInstance);
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_ctrl_studentInstanceStruct *chartInstance;
  chartInstance = (SFc12_ctrl_studentInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c12_ctrl_student_get_eml_resolved_functions_info(void)
{
  ...
  c12_identifier)
{
  ...
  c12_y = c12_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_ctrl_student), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_ctrl_student);
  return c12_y;
}
...
void sf_c12_ctrl_student_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c12_ctrl_student_get_autoinheritance_info(void)
{
...
mxArray *sf_c12_ctrl_student_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c12_ctrl_student_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c12_ctrl_student(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[9],T\"tau_r\",},{M[1],M[5],T\"tau_u\",},{M[1],M[8],T\"tau_v\",},{M[8],M[0],T\"is_active_c12_ctrl_student\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_ctrl_student_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc12_ctrl_studentInstanceStruct *)
...
static void sf_opaque_initialize_c12_ctrl_student(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_ctrl_studentInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_ctrl_student((SFc12_ctrl_studentInstanceStruct*)
    chartInstanceVar);
  initialize_c12_ctrl_student((SFc12_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c12_ctrl_student(void *chartInstanceVar)
{
  enable_c12_ctrl_student((SFc12_ctrl_studentInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_ctrl_student(void *chartInstanceVar)
{
  disable_c12_ctrl_student((SFc12_ctrl_studentInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_ctrl_student(void *chartInstanceVar)
{
  sf_gateway_c12_ctrl_student((SFc12_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c12_ctrl_student(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_ctrl_student
    ((SFc12_ctrl_studentInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c12_ctrl_student();/* state var info */
...
extern void sf_internal_set_sim_state_c12_ctrl_student(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c12_ctrl_student();/* state var info */
  ...
  set_sim_state_c12_ctrl_student((SFc12_ctrl_studentInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c12_ctrl_student(SimStruct* S)
{
  return sf_internal_get_sim_state_c12_ctrl_student(S);
}

static void sf_opaque_set_sim_state_c12_ctrl_student(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c12_ctrl_student(S, st);
}

static void sf_opaque_terminate_c12_ctrl_student(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_ctrl_studentInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c12_ctrl_student((SFc12_ctrl_studentInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc12_ctrl_student((SFc12_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_ctrl_student(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c12_ctrl_student(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c12_ctrl_student(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_ctrl_student(SimStruct *S)
{
  SFc12_ctrl_studentInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc12_ctrl_studentInstanceStruct *)utMalloc(sizeof
    (SFc12_ctrl_studentInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_ctrl_studentInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c12_ctrl_student;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_ctrl_student;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c12_ctrl_student;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_ctrl_student;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c12_ctrl_student;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_ctrl_student;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_ctrl_student;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_ctrl_student;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_ctrl_student;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_ctrl_student;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c12_ctrl_student;
...
void c12_ctrl_student_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_ctrl_student(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_ctrl_student(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_ctrl_student(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_ctrl_student_method_dispatcher.\n"
