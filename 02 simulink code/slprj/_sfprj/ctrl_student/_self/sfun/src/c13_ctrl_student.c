...
static void initialize_c13_ctrl_student(SFc13_ctrl_studentInstanceStruct
  *chartInstance);
static void initialize_params_c13_ctrl_student(SFc13_ctrl_studentInstanceStruct *
  chartInstance);
static void enable_c13_ctrl_student(SFc13_ctrl_studentInstanceStruct
  *chartInstance);
static void disable_c13_ctrl_student(SFc13_ctrl_studentInstanceStruct
  *chartInstance);
static void c13_update_debugger_state_c13_ctrl_student
  (SFc13_ctrl_studentInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_ctrl_student
  (SFc13_ctrl_studentInstanceStruct *chartInstance);
static void set_sim_state_c13_ctrl_student(SFc13_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c13_st);
static void finalize_c13_ctrl_student(SFc13_ctrl_studentInstanceStruct
  *chartInstance);
static void sf_gateway_c13_ctrl_student(SFc13_ctrl_studentInstanceStruct
  *chartInstance);
static void initSimStructsc13_ctrl_student(SFc13_ctrl_studentInstanceStruct
  *chartInstance);
...
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_emlrt_marshallIn(SFc13_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c13_F_y, const char_T *c13_identifier);
static real_T c13_b_emlrt_marshallIn(SFc13_ctrl_studentInstanceStruct
...
static const mxArray *c13_c_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_c_emlrt_marshallIn(SFc13_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData);
static uint8_T c13_d_emlrt_marshallIn(SFc13_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_ctrl_student, const char_T *
  c13_identifier);
static uint8_T c13_e_emlrt_marshallIn(SFc13_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void init_dsm_address_info(SFc13_ctrl_studentInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_ctrl_student = 0U;
}
  ...
  (SFc13_ctrl_studentInstanceStruct *chartInstance)
{
  ...
  c13_b_hoistedGlobal = chartInstance->c13_is_active_c13_ctrl_student;
  ...
  *chartInstance, const mxArray *c13_st)
{
  ...
  *c13_F_y = c13_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c13_u,
    0)), "F_y");
  chartInstance->c13_is_active_c13_ctrl_student = c13_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 1)),
     "is_active_c13_ctrl_student");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_ctrl_student(chartInstance);
  ...
  *c13_inData)
{
  ...
  const mxArray *c13_y = NULL;
  SFc13_ctrl_studentInstanceStruct *chartInstance;
  chartInstance = (SFc13_ctrl_studentInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c13_ctrl_student_get_eml_resolved_functions_info(void)
{
  ...
  c13_identifier)
{
  ...
  c13_y = c13_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_ctrl_student), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_ctrl_student);
  return c13_y;
}
...
void sf_c13_ctrl_student_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_ctrl_student_get_autoinheritance_info(void)
{
...
mxArray *sf_c13_ctrl_student_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c13_ctrl_student_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c13_ctrl_student(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"F_y\",},{M[8],M[0],T\"is_active_c13_ctrl_student\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_ctrl_student_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc13_ctrl_studentInstanceStruct *)
...
static void sf_opaque_initialize_c13_ctrl_student(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_ctrl_studentInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c13_ctrl_student((SFc13_ctrl_studentInstanceStruct*)
    chartInstanceVar);
  initialize_c13_ctrl_student((SFc13_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c13_ctrl_student(void *chartInstanceVar)
{
  enable_c13_ctrl_student((SFc13_ctrl_studentInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_ctrl_student(void *chartInstanceVar)
{
  disable_c13_ctrl_student((SFc13_ctrl_studentInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_ctrl_student(void *chartInstanceVar)
{
  sf_gateway_c13_ctrl_student((SFc13_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_ctrl_student(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_ctrl_student
    ((SFc13_ctrl_studentInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_ctrl_student();/* state var info */
...
extern void sf_internal_set_sim_state_c13_ctrl_student(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c13_ctrl_student();/* state var info */
  ...
  set_sim_state_c13_ctrl_student((SFc13_ctrl_studentInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_ctrl_student(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_ctrl_student(S);
}

static void sf_opaque_set_sim_state_c13_ctrl_student(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c13_ctrl_student(S, st);
}

static void sf_opaque_terminate_c13_ctrl_student(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_ctrl_studentInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c13_ctrl_student((SFc13_ctrl_studentInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc13_ctrl_student((SFc13_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_ctrl_student(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_ctrl_student(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c13_ctrl_student(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_ctrl_student(SimStruct *S)
{
  SFc13_ctrl_studentInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc13_ctrl_studentInstanceStruct *)utMalloc(sizeof
    (SFc13_ctrl_studentInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_ctrl_studentInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c13_ctrl_student;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_ctrl_student;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c13_ctrl_student;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_ctrl_student;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_ctrl_student;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_ctrl_student;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_ctrl_student;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_ctrl_student;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_ctrl_student;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_ctrl_student;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c13_ctrl_student;
...
void c13_ctrl_student_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_ctrl_student(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_ctrl_student(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_ctrl_student(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_ctrl_student_method_dispatcher.\n"
