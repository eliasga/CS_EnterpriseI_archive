...
static void initSimStructsc14_ctrl_student(SFc14_ctrl_studentInstanceStruct
  *chartInstance);
static void c14_D(SFc14_ctrl_studentInstanceStruct *chartInstance, real_T c14_u,
  ...
  c14_chartNumber, uint32_T c14_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c14_chartNumber, c14_instanceNumber, 0U,
    ...
    "C:\\Users\\mclab\\Documents\\GitHub\\CS_EnterpriseI\\02 simulink code\\D.m"));
}
...
static void c14_info_helper(const mxArray **c14_info)
{
  ...
  sf_mex_addfield(*c14_info, c14_emlrt_marshallOut(
    "[E]C:/Users/mclab/Documents/GitHub/CS_EnterpriseI/02 simulink code/D.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c14_info, c14_b_emlrt_marshallOut(1449662471U), "fileTimeLo",
                  "fileTimeLo", 0);
...
static void mdlSetWorkWidths_c14_ctrl_student(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1550204759U));
  ssSetChecksum1(S,(3560752001U));
  ssSetChecksum2(S,(482632733U));
  ssSetChecksum3(S,(22903446U));
