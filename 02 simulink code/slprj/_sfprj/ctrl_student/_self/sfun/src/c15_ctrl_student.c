...
static void initialize_c15_ctrl_student(SFc15_ctrl_studentInstanceStruct
  *chartInstance);
static void initialize_params_c15_ctrl_student(SFc15_ctrl_studentInstanceStruct *
  chartInstance);
static void enable_c15_ctrl_student(SFc15_ctrl_studentInstanceStruct
  *chartInstance);
static void disable_c15_ctrl_student(SFc15_ctrl_studentInstanceStruct
  *chartInstance);
static void c15_update_debugger_state_c15_ctrl_student
  (SFc15_ctrl_studentInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c15_ctrl_student
  (SFc15_ctrl_studentInstanceStruct *chartInstance);
static void set_sim_state_c15_ctrl_student(SFc15_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c15_st);
static void finalize_c15_ctrl_student(SFc15_ctrl_studentInstanceStruct
  *chartInstance);
static void sf_gateway_c15_ctrl_student(SFc15_ctrl_studentInstanceStruct
  *chartInstance);
static void initSimStructsc15_ctrl_student(SFc15_ctrl_studentInstanceStruct
  *chartInstance);
...
static const mxArray *c15_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static void c15_emlrt_marshallIn(SFc15_ctrl_studentInstanceStruct *chartInstance,
  const mxArray *c15_C_nl, const char_T *c15_identifier, real_T c15_y[3]);
static void c15_b_emlrt_marshallIn(SFc15_ctrl_studentInstanceStruct
...
static const mxArray *c15_b_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static real_T c15_c_emlrt_marshallIn(SFc15_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
...
static const mxArray *c15_c_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static void c15_d_emlrt_marshallIn(SFc15_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId,
  real_T c15_y[9]);
...
static void c15_eml_scalar_eg(SFc15_ctrl_studentInstanceStruct *chartInstance);
static void c15_eml_xgemm(SFc15_ctrl_studentInstanceStruct *chartInstance,
  real_T c15_A[9], real_T c15_B[3], real_T c15_C[3], real_T c15_b_C[3]);
static const mxArray *c15_d_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static int32_T c15_e_emlrt_marshallIn(SFc15_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c15_mxArrayInData, const char_T *c15_varName, void *c15_outData);
static uint8_T c15_f_emlrt_marshallIn(SFc15_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c15_b_is_active_c15_ctrl_student, const char_T *
  c15_identifier);
static uint8_T c15_g_emlrt_marshallIn(SFc15_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_b_eml_xgemm(SFc15_ctrl_studentInstanceStruct *chartInstance,
  real_T c15_A[9], real_T c15_B[3], real_T c15_C[3]);
static void init_dsm_address_info(SFc15_ctrl_studentInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_ctrl_student = 0U;
}
  ...
  (SFc15_ctrl_studentInstanceStruct *chartInstance)
{
  ...
  c15_hoistedGlobal = chartInstance->c15_is_active_c15_ctrl_student;
  ...
  *chartInstance, const mxArray *c15_st)
{
  ...
  chartInstance->c15_is_active_c15_ctrl_student = c15_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c15_u, 1)),
     "is_active_c15_ctrl_student");
  sf_mex_destroy(&c15_u);
  c15_update_debugger_state_c15_ctrl_student(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 6U, chartInstance->c15_sfEvent);
  for (c15_i2 = 0; c15_i2 < 3; c15_i2++) {
    _SFD_DATA_RANGE_CHECK((*c15_b_nu_hat)[c15_i2], 0U);
  }

  chartInstance->c15_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 6U, chartInstance->c15_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 6U, chartInstance->c15_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  c15_chartNumber, uint32_T c15_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c15_chartNumber, c15_instanceNumber, 0U,
    ...
    "C:\\Users\\mclab\\Documents\\GitHub\\CS_EnterpriseI\\02 simulink code\\ctrl_student_observer_C.m"));
}
  ...
  *c15_inData)
{
  ...
  const mxArray *c15_y = NULL;
  SFc15_ctrl_studentInstanceStruct *chartInstance;
  chartInstance = (SFc15_ctrl_studentInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c15_ctrl_student_get_eml_resolved_functions_info(void)
{
...
static void c15_info_helper(const mxArray **c15_info)
{
  ...
  sf_mex_addfield(*c15_info, c15_emlrt_marshallOut("ctrl_student_observer_C"),
                  "name", "name", 0);
  sf_mex_addfield(*c15_info, c15_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 0);
  sf_mex_addfield(*c15_info, c15_emlrt_marshallOut(
    "[E]C:/Users/mclab/Documents/GitHub/CS_EnterpriseI/02 simulink code/ctrl_student_observer_C.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c15_info, c15_b_emlrt_marshallOut(1450276706U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  c15_identifier)
{
  ...
  c15_y = c15_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c15_b_is_active_c15_ctrl_student), &c15_thisId);
  sf_mex_destroy(&c15_b_is_active_c15_ctrl_student);
  return c15_y;
}
...
void sf_c15_ctrl_student_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(178189820U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2082601809U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1836486637U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(103127062U);
}

mxArray *sf_c15_ctrl_student_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Xq3QrWc2oXaP0PqytUUyDG");
...
mxArray *sf_c15_ctrl_student_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c15_ctrl_student_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c15_ctrl_student(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"C_nl\",},{M[8],M[0],T\"is_active_c15_ctrl_student\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_ctrl_student_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc15_ctrl_studentInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_SCRIPT_FCN(0,0,"ctrl_student_observer_C",0,-1,332);
...
{
  return "1p2JWRIdTHsdd8tDJSAE8E";
}

static void sf_opaque_initialize_c15_ctrl_student(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc15_ctrl_studentInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c15_ctrl_student((SFc15_ctrl_studentInstanceStruct*)
    chartInstanceVar);
  initialize_c15_ctrl_student((SFc15_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c15_ctrl_student(void *chartInstanceVar)
{
  enable_c15_ctrl_student((SFc15_ctrl_studentInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c15_ctrl_student(void *chartInstanceVar)
{
  disable_c15_ctrl_student((SFc15_ctrl_studentInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c15_ctrl_student(void *chartInstanceVar)
{
  sf_gateway_c15_ctrl_student((SFc15_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c15_ctrl_student(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c15_ctrl_student
    ((SFc15_ctrl_studentInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c15_ctrl_student();/* state var info */
...
extern void sf_internal_set_sim_state_c15_ctrl_student(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c15_ctrl_student();/* state var info */
  ...
  set_sim_state_c15_ctrl_student((SFc15_ctrl_studentInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c15_ctrl_student(SimStruct* S)
{
  return sf_internal_get_sim_state_c15_ctrl_student(S);
}

static void sf_opaque_set_sim_state_c15_ctrl_student(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c15_ctrl_student(S, st);
}

static void sf_opaque_terminate_c15_ctrl_student(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_ctrl_studentInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c15_ctrl_student((SFc15_ctrl_studentInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc15_ctrl_student((SFc15_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_ctrl_student(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c15_ctrl_student(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3266746413U));
  ssSetChecksum1(S,(1734177890U));
  ssSetChecksum2(S,(101002515U));
  ssSetChecksum3(S,(4164546918U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c15_ctrl_student(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c15_ctrl_student(SimStruct *S)
{
  SFc15_ctrl_studentInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc15_ctrl_studentInstanceStruct *)utMalloc(sizeof
    (SFc15_ctrl_studentInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_ctrl_studentInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c15_ctrl_student;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c15_ctrl_student;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c15_ctrl_student;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_ctrl_student;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c15_ctrl_student;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c15_ctrl_student;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c15_ctrl_student;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c15_ctrl_student;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_ctrl_student;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_ctrl_student;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c15_ctrl_student;
...
void c15_ctrl_student_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_ctrl_student(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_ctrl_student(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_ctrl_student(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_ctrl_student_method_dispatcher.\n"
