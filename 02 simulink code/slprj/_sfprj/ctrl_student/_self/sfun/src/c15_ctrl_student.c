  ...
  c15_chartNumber, uint32_T c15_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c15_chartNumber, c15_instanceNumber, 0U,
    ...
    "C:\\Users\\mclab\\Documents\\GitHub\\CS_EnterpriseI\\02 simulink code\\C.m"));
}
...
static void c15_info_helper(const mxArray **c15_info)
{
  ...
  sf_mex_addfield(*c15_info, c15_emlrt_marshallOut(
    "[E]C:/Users/mclab/Documents/GitHub/CS_EnterpriseI/02 simulink code/C.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c15_info, c15_b_emlrt_marshallOut(1449662472U), "fileTimeLo",
                  "fileTimeLo", 0);
...
static void mdlSetWorkWidths_c15_ctrl_student(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1335358901U));
  ssSetChecksum1(S,(540243505U));
  ssSetChecksum2(S,(1896638324U));
  ssSetChecksum3(S,(2374788694U));
