...
static const char * c29_debug_family_names[4] = { "nargin", "nargout", "K_p1",
  "K_p" };

/* Function Declarations */
static void initialize_c29_ctrl_student(SFc29_ctrl_studentInstanceStruct
  *chartInstance);
static void initialize_params_c29_ctrl_student(SFc29_ctrl_studentInstanceStruct *
  chartInstance);
static void enable_c29_ctrl_student(SFc29_ctrl_studentInstanceStruct
  *chartInstance);
static void disable_c29_ctrl_student(SFc29_ctrl_studentInstanceStruct
  *chartInstance);
static void c29_update_debugger_state_c29_ctrl_student
  (SFc29_ctrl_studentInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c29_ctrl_student
  (SFc29_ctrl_studentInstanceStruct *chartInstance);
static void set_sim_state_c29_ctrl_student(SFc29_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c29_st);
static void finalize_c29_ctrl_student(SFc29_ctrl_studentInstanceStruct
  *chartInstance);
static void sf_gateway_c29_ctrl_student(SFc29_ctrl_studentInstanceStruct
  *chartInstance);
static void initSimStructsc29_ctrl_student(SFc29_ctrl_studentInstanceStruct
  *chartInstance);
...
static const mxArray *c29_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static void c29_emlrt_marshallIn(SFc29_ctrl_studentInstanceStruct *chartInstance,
  const mxArray *c29_K_p, const char_T *c29_identifier, real_T c29_y[9]);
static void c29_b_emlrt_marshallIn(SFc29_ctrl_studentInstanceStruct
...
static const mxArray *c29_c_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static real_T c29_c_emlrt_marshallIn(SFc29_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId);
...
static const mxArray *c29_d_sf_marshallOut(void *chartInstanceVoid, void
  *c29_inData);
static int32_T c29_d_emlrt_marshallIn(SFc29_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId);
static void c29_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c29_mxArrayInData, const char_T *c29_varName, void *c29_outData);
static uint8_T c29_e_emlrt_marshallIn(SFc29_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c29_b_is_active_c29_ctrl_student, const char_T *
  c29_identifier);
static uint8_T c29_f_emlrt_marshallIn(SFc29_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId);
static void init_dsm_address_info(SFc29_ctrl_studentInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c29_is_active_c29_ctrl_student = 0U;
}
  ...
  (SFc29_ctrl_studentInstanceStruct *chartInstance)
{
  ...
  real_T (*c29_K_p)[9];
  c29_K_p = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  c29_st = NULL;
  c29_st = NULL;
  c29_y = NULL;
  sf_mex_assign(&c29_y, sf_mex_createcellmatrix(2, 1), false);
  for (c29_i0 = 0; c29_i0 < 9; c29_i0++) {
    c29_u[c29_i0] = (*c29_K_p)[c29_i0];
  }
  ...
  c29_hoistedGlobal = chartInstance->c29_is_active_c29_ctrl_student;
  ...
  *chartInstance, const mxArray *c29_st)
{
  ...
  for (c29_i1 = 0; c29_i1 < 9; c29_i1++) {
    (*c29_K_p)[c29_i1] = c29_dv0[c29_i1];
  }

  chartInstance->c29_is_active_c29_ctrl_student = c29_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c29_u, 1)),
     "is_active_c29_ctrl_student");
  sf_mex_destroy(&c29_u);
  c29_update_debugger_state_c29_ctrl_student(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T (*c29_b_K_p)[9];
  real_T (*c29_b_K_p1)[3];
  c29_b_K_p1 = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  c29_b_K_p = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c29_i2 = 0; c29_i2 < 3; c29_i2++) {
    c29_K_p1[c29_i2] = (*c29_b_K_p1)[c29_i2];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c29_nargout, 1U, c29_c_sf_marshallOut,
    c29_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c29_K_p1, 2U, c29_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c29_K_p, 3U, c29_sf_marshallOut,
    c29_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c29_sfEvent, 4);
  for (c29_i3 = 0; c29_i3 < 3; c29_i3++) {
    c29_v[c29_i3] = c29_K_p1[c29_i3];
  }
  ...
  for (c29_j = 1; c29_j < 4; c29_j++) {
    c29_b_j = c29_j;
    c29_K_p[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
               (real_T)c29_b_j), 1, 3, 1, 0) + 3 * (_SFD_EML_ARRAY_BOUNDS_CHECK(
               "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c29_b_j), 1, 3, 2, 0)
              - 1)) - 1] = c29_v[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c29_b_j), 1, 3, 1, 0) - 1];
  }

  _SFD_EML_CALL(0U, chartInstance->c29_sfEvent, -4);
  _SFD_SYMBOL_SCOPE_POP();
  for (c29_i5 = 0; c29_i5 < 9; c29_i5++) {
    (*c29_b_K_p)[c29_i5] = c29_K_p[c29_i5];
  }
  ...
  for (c29_i6 = 0; c29_i6 < 9; c29_i6++) {
    _SFD_DATA_RANGE_CHECK((*c29_b_K_p)[c29_i6], 0U);
  }

  for (c29_i7 = 0; c29_i7 < 3; c29_i7++) {
    _SFD_DATA_RANGE_CHECK((*c29_b_K_p1)[c29_i7], 1U);
  }
}
  ...
  *c29_inData)
{
  ...
  const mxArray *c29_y = NULL;
  SFc29_ctrl_studentInstanceStruct *chartInstance;
  chartInstance = (SFc29_ctrl_studentInstanceStruct *)chartInstanceVoid;
  c29_mxArrayOutData = NULL;
  c29_i8 = 0;
  for (c29_i9 = 0; c29_i9 < 3; c29_i9++) {
    for (c29_i10 = 0; c29_i10 < 3; c29_i10++) {
      c29_b_inData[c29_i10 + c29_i8] = (*(real_T (*)[9])c29_inData)[c29_i10 +
        c29_i8];
    }
  ...
  for (c29_i12 = 0; c29_i12 < 3; c29_i12++) {
    for (c29_i13 = 0; c29_i13 < 3; c29_i13++) {
      c29_u[c29_i13 + c29_i11] = c29_b_inData[c29_i13 + c29_i11];
    }
  ...
  const mxArray *c29_K_p, const char_T *c29_identifier, real_T c29_y[9])
{
  ...
  c29_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c29_K_p), &c29_thisId, c29_y);
  sf_mex_destroy(&c29_K_p);
}
  ...
  real_T c29_y[9])
{
  ...
  int32_T c29_i14;
  (void)chartInstance;
  sf_mex_import(c29_parentId, sf_mex_dup(c29_u), c29_dv1, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c29_i14 = 0; c29_i14 < 9; c29_i14++) {
    c29_y[c29_i14] = c29_dv1[c29_i14];
  }
  ...
  *c29_mxArrayInData, const char_T *c29_varName, void *c29_outData)
{
  ...
  SFc29_ctrl_studentInstanceStruct *chartInstance;
  chartInstance = (SFc29_ctrl_studentInstanceStruct *)chartInstanceVoid;
  c29_K_p = sf_mex_dup(c29_mxArrayInData);
  ...
  for (c29_i16 = 0; c29_i16 < 3; c29_i16++) {
    for (c29_i17 = 0; c29_i17 < 3; c29_i17++) {
      (*(real_T (*)[9])c29_outData)[c29_i17 + c29_i15] = c29_y[c29_i17 + c29_i15];
    }
  ...
  *c29_inData)
{
  ...
  for (c29_i18 = 0; c29_i18 < 3; c29_i18++) {
    c29_b_inData[c29_i18] = (*(real_T (*)[3])c29_inData)[c29_i18];
  }

  for (c29_i19 = 0; c29_i19 < 3; c29_i19++) {
    c29_u[c29_i19] = c29_b_inData[c29_i19];
  }
...
const mxArray *sf_c29_ctrl_student_get_eml_resolved_functions_info(void)
{
  const mxArray *c29_nameCaptureInfo = NULL;
  c29_nameCaptureInfo = NULL;
  sf_mex_assign(&c29_nameCaptureInfo, sf_mex_createstruct("structure", 2, 8, 1),
                false);
...
static void c29_info_helper(const mxArray **c29_info)
{
  ...
  sf_mex_addfield(*c29_info, c29_emlrt_marshallOut("diag"), "name", "name", 0);
  ...
  sf_mex_addfield(*c29_info, c29_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(1363713854U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c29_info, c29_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m"), "context",
                  "context", 1);
  sf_mex_addfield(*c29_info, c29_emlrt_marshallOut("ismatrix"), "name", "name",
                  1);
  sf_mex_addfield(*c29_info, c29_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 1);
  sf_mex_addfield(*c29_info, c29_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/ismatrix.m"), "resolved",
                  "resolved", 1);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(1331304858U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c29_info, c29_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m"), "resolved",
                  "resolved", 3);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(1375980688U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c29_info, c29_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/scalarEg.p"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(1389307920U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c29_info, c29_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
                  "resolved", 6);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(1362261882U), "fileTimeLo",
                  "fileTimeLo", 6);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 6);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c29_info, c29_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_switch_helper.m"),
                  "resolved", "resolved", 7);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(1381850300U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c29_info, c29_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  *chartInstance, const mxArray *c29_u, const emlrtMsgIdentifier *c29_parentId)
{
  ...
  int32_T c29_i20;
  (void)chartInstance;
  sf_mex_import(c29_parentId, sf_mex_dup(c29_u), &c29_i20, 1, 6, 0U, 0, 0U, 0);
  c29_y = c29_i20;
  sf_mex_destroy(&c29_u);
  return c29_y;
}
  ...
  c29_identifier)
{
  ...
  c29_y = c29_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c29_b_is_active_c29_ctrl_student), &c29_thisId);
  sf_mex_destroy(&c29_b_is_active_c29_ctrl_student);
  return c29_y;
}
...
void sf_c29_ctrl_student_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c29_ctrl_student_get_autoinheritance_info(void)
{
...
mxArray *sf_c29_ctrl_student_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c29_ctrl_student_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c29_ctrl_student(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"K_p\",},{M[8],M[0],T\"is_active_c29_ctrl_student\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c29_ctrl_student_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc29_ctrl_studentInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          real_T (*c29_K_p)[9];
          real_T (*c29_K_p1)[3];
          c29_K_p1 = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
          c29_K_p = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, *c29_K_p);
          _SFD_SET_DATA_VALUE_PTR(1U, *c29_K_p1);
        }
      }
    } else {
...
static void sf_opaque_initialize_c29_ctrl_student(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc29_ctrl_studentInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c29_ctrl_student((SFc29_ctrl_studentInstanceStruct*)
    chartInstanceVar);
  initialize_c29_ctrl_student((SFc29_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c29_ctrl_student(void *chartInstanceVar)
{
  enable_c29_ctrl_student((SFc29_ctrl_studentInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c29_ctrl_student(void *chartInstanceVar)
{
  disable_c29_ctrl_student((SFc29_ctrl_studentInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c29_ctrl_student(void *chartInstanceVar)
{
  sf_gateway_c29_ctrl_student((SFc29_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c29_ctrl_student(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c29_ctrl_student
    ((SFc29_ctrl_studentInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c29_ctrl_student();/* state var info */
...
extern void sf_internal_set_sim_state_c29_ctrl_student(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c29_ctrl_student();/* state var info */
  ...
  set_sim_state_c29_ctrl_student((SFc29_ctrl_studentInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c29_ctrl_student(SimStruct* S)
{
  return sf_internal_get_sim_state_c29_ctrl_student(S);
}

static void sf_opaque_set_sim_state_c29_ctrl_student(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c29_ctrl_student(S, st);
}

static void sf_opaque_terminate_c29_ctrl_student(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc29_ctrl_studentInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c29_ctrl_student((SFc29_ctrl_studentInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc29_ctrl_student((SFc29_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c29_ctrl_student(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c29_ctrl_student(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c29_ctrl_student(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c29_ctrl_student(SimStruct *S)
{
  SFc29_ctrl_studentInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc29_ctrl_studentInstanceStruct *)utMalloc(sizeof
    (SFc29_ctrl_studentInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc29_ctrl_studentInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c29_ctrl_student;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c29_ctrl_student;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c29_ctrl_student;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c29_ctrl_student;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c29_ctrl_student;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c29_ctrl_student;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c29_ctrl_student;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c29_ctrl_student;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c29_ctrl_student;
  chartInstance->chartInfo.mdlStart = mdlStart_c29_ctrl_student;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c29_ctrl_student;
...
void c29_ctrl_student_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c29_ctrl_student(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c29_ctrl_student(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c29_ctrl_student(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c29_ctrl_student_method_dispatcher.\n"
