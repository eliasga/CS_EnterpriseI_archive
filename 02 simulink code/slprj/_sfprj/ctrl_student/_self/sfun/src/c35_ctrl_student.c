...
static void initialize_c35_ctrl_student(SFc35_ctrl_studentInstanceStruct
  *chartInstance);
static void initialize_params_c35_ctrl_student(SFc35_ctrl_studentInstanceStruct *
  chartInstance);
static void enable_c35_ctrl_student(SFc35_ctrl_studentInstanceStruct
  *chartInstance);
static void disable_c35_ctrl_student(SFc35_ctrl_studentInstanceStruct
  *chartInstance);
static void c35_update_debugger_state_c35_ctrl_student
  (SFc35_ctrl_studentInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c35_ctrl_student
  (SFc35_ctrl_studentInstanceStruct *chartInstance);
static void set_sim_state_c35_ctrl_student(SFc35_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c35_st);
static void finalize_c35_ctrl_student(SFc35_ctrl_studentInstanceStruct
  *chartInstance);
static void sf_gateway_c35_ctrl_student(SFc35_ctrl_studentInstanceStruct
  *chartInstance);
static void initSimStructsc35_ctrl_student(SFc35_ctrl_studentInstanceStruct
  *chartInstance);
...
static const mxArray *c35_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static void c35_emlrt_marshallIn(SFc35_ctrl_studentInstanceStruct *chartInstance,
  const mxArray *c35_nu, const char_T *c35_identifier, real_T c35_y[3]);
static void c35_b_emlrt_marshallIn(SFc35_ctrl_studentInstanceStruct
...
static const mxArray *c35_b_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static real_T c35_c_emlrt_marshallIn(SFc35_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
...
static const mxArray *c35_c_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static void c35_d_emlrt_marshallIn(SFc35_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId,
  real_T c35_y[9]);
...
static void c35_eml_scalar_eg(SFc35_ctrl_studentInstanceStruct *chartInstance);
static void c35_eml_xgemm(SFc35_ctrl_studentInstanceStruct *chartInstance,
...
static const mxArray *c35_d_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static int32_T c35_e_emlrt_marshallIn(SFc35_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
static void c35_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c35_mxArrayInData, const char_T *c35_varName, void *c35_outData);
static uint8_T c35_f_emlrt_marshallIn(SFc35_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c35_b_is_active_c35_ctrl_student, const char_T *
  c35_identifier);
static uint8_T c35_g_emlrt_marshallIn(SFc35_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
static void c35_b_eml_xgemm(SFc35_ctrl_studentInstanceStruct *chartInstance,
  real_T c35_A[9], real_T c35_B[3], real_T c35_C[3]);
static void init_dsm_address_info(SFc35_ctrl_studentInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c35_is_active_c35_ctrl_student = 0U;
}
  ...
  (SFc35_ctrl_studentInstanceStruct *chartInstance)
{
  ...
  c35_hoistedGlobal = chartInstance->c35_is_active_c35_ctrl_student;
  ...
  *chartInstance, const mxArray *c35_st)
{
  ...
  chartInstance->c35_is_active_c35_ctrl_student = c35_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c35_u, 1)),
     "is_active_c35_ctrl_student");
  sf_mex_destroy(&c35_u);
  c35_update_debugger_state_c35_ctrl_student(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 14U, chartInstance->c35_sfEvent);
  for (c35_i2 = 0; c35_i2 < 3; c35_i2++) {
    _SFD_DATA_RANGE_CHECK((*c35_b_eta_dot)[c35_i2], 0U);
  }

  chartInstance->c35_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 14U, chartInstance->c35_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 14U, chartInstance->c35_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c35_inData)
{
  ...
  const mxArray *c35_y = NULL;
  SFc35_ctrl_studentInstanceStruct *chartInstance;
  chartInstance = (SFc35_ctrl_studentInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c35_ctrl_student_get_eml_resolved_functions_info(void)
{
  ...
  c35_identifier)
{
  ...
  c35_y = c35_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c35_b_is_active_c35_ctrl_student), &c35_thisId);
  sf_mex_destroy(&c35_b_is_active_c35_ctrl_student);
  return c35_y;
}
...
void sf_c35_ctrl_student_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c35_ctrl_student_get_autoinheritance_info(void)
{
...
mxArray *sf_c35_ctrl_student_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c35_ctrl_student_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c35_ctrl_student(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"nu\",},{M[8],M[0],T\"is_active_c35_ctrl_student\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c35_ctrl_student_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc35_ctrl_studentInstanceStruct *)
...
static void sf_opaque_initialize_c35_ctrl_student(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc35_ctrl_studentInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c35_ctrl_student((SFc35_ctrl_studentInstanceStruct*)
    chartInstanceVar);
  initialize_c35_ctrl_student((SFc35_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c35_ctrl_student(void *chartInstanceVar)
{
  enable_c35_ctrl_student((SFc35_ctrl_studentInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c35_ctrl_student(void *chartInstanceVar)
{
  disable_c35_ctrl_student((SFc35_ctrl_studentInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c35_ctrl_student(void *chartInstanceVar)
{
  sf_gateway_c35_ctrl_student((SFc35_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c35_ctrl_student(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c35_ctrl_student
    ((SFc35_ctrl_studentInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c35_ctrl_student();/* state var info */
...
extern void sf_internal_set_sim_state_c35_ctrl_student(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c35_ctrl_student();/* state var info */
  ...
  set_sim_state_c35_ctrl_student((SFc35_ctrl_studentInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c35_ctrl_student(SimStruct* S)
{
  return sf_internal_get_sim_state_c35_ctrl_student(S);
}

static void sf_opaque_set_sim_state_c35_ctrl_student(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c35_ctrl_student(S, st);
}

static void sf_opaque_terminate_c35_ctrl_student(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc35_ctrl_studentInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c35_ctrl_student((SFc35_ctrl_studentInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc35_ctrl_student((SFc35_ctrl_studentInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c35_ctrl_student(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c35_ctrl_student(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c35_ctrl_student(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c35_ctrl_student(SimStruct *S)
{
  SFc35_ctrl_studentInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc35_ctrl_studentInstanceStruct *)utMalloc(sizeof
    (SFc35_ctrl_studentInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc35_ctrl_studentInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c35_ctrl_student;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c35_ctrl_student;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c35_ctrl_student;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c35_ctrl_student;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c35_ctrl_student;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c35_ctrl_student;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c35_ctrl_student;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c35_ctrl_student;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c35_ctrl_student;
  chartInstance->chartInfo.mdlStart = mdlStart_c35_ctrl_student;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c35_ctrl_student;
...
void c35_ctrl_student_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c35_ctrl_student(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c35_ctrl_student(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c35_ctrl_student(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c35_ctrl_student_method_dispatcher.\n"
