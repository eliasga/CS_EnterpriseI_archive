...
static void ctrl_switch_output(void)
{
   ...
   *  Memory: '<S1>/Memory'
   */
  /* MATLAB Function 'Switch_subsystem/Switch_function': '<S9>:1' */
  ...
  /* MATLAB Function 'indicator/C': '<S10>:1' */
  /* '<S10>:1:3' */
...
static NI_Parameter NI_ParamList[] DataSection(".NIVS.paramlist") =
{
  ...
  { 1, "ctrl_switch/Saturation4/UpperLimit", offsetof(P_ctrl_switch_T,
    Saturation4_UpperSat), 22, 1, 2, 2, 0 },

  { 2, "ctrl_switch/Saturation4/LowerLimit", offsetof(P_ctrl_switch_T,
    Saturation4_LowerSat), 22, 1, 2, 4, 0 },

  { 3, "ctrl_switch/Saturation/UpperLimit", offsetof(P_ctrl_switch_T,
    Saturation_UpperSat), 22, 1, 2, 6, 0 },

  { 4, "ctrl_switch/Saturation/LowerLimit", offsetof(P_ctrl_switch_T,
    Saturation_LowerSat), 22, 1, 2, 8, 0 },

  { 5, "ctrl_switch/Saturation1/UpperLimit", offsetof(P_ctrl_switch_T,
    Saturation1_UpperSat), 22, 1, 2, 10, 0 },

  { 6, "ctrl_switch/Saturation1/LowerLimit", offsetof(P_ctrl_switch_T,
    Saturation1_LowerSat), 22, 1, 2, 12, 0 },

  { 7, "ctrl_switch/Saturation2/UpperLimit", offsetof(P_ctrl_switch_T,
    Saturation2_UpperSat), 22, 1, 2, 14, 0 },

  { 8, "ctrl_switch/Saturation2/LowerLimit", offsetof(P_ctrl_switch_T,
    Saturation2_LowerSat), 22, 1, 2, 16, 0 },

  { 9, "ctrl_switch/Saturation3/UpperLimit", offsetof(P_ctrl_switch_T,
    Saturation3_UpperSat), 22, 1, 2, 18, 0 },

  { 10, "ctrl_switch/Saturation3/LowerLimit", offsetof(P_ctrl_switch_T,
    Saturation3_LowerSat), 22, 1, 2, 20, 0 },

  { 11, "ctrl_switch/Saturation5/UpperLimit", offsetof(P_ctrl_switch_T,
    Saturation5_UpperSat), 22, 1, 2, 22, 0 },

  { 12, "ctrl_switch/Saturation5/LowerLimit", offsetof(P_ctrl_switch_T,
    Saturation5_LowerSat), 22, 1, 2, 24, 0 },

  { 13, "ctrl_switch/Saturation6/UpperLimit", offsetof(P_ctrl_switch_T,
    Saturation6_UpperSat), 22, 1, 2, 26, 0 },

  { 14, "ctrl_switch/Saturation6/LowerLimit", offsetof(P_ctrl_switch_T,
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 32, "ctrl_switch/Saturation4", 0, "", offsetof(B_ctrl_switch_T, Saturation4)
    +0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 64, 0 },

  { 33, "ctrl_switch/Saturation", 0, "", offsetof(B_ctrl_switch_T, Saturation)+0*
    sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 66, 0 },

  { 34, "ctrl_switch/Saturation1", 0, "", offsetof(B_ctrl_switch_T, Saturation1)
    +0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 68, 0 },

  { 35, "ctrl_switch/Saturation2", 0, "", offsetof(B_ctrl_switch_T, Saturation2)
    +0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 70, 0 },

  { 36, "ctrl_switch/Saturation3", 0, "", offsetof(B_ctrl_switch_T, Saturation3)
    +0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 72, 0 },

  { 37, "ctrl_switch/Saturation5", 0, "", offsetof(B_ctrl_switch_T, Saturation5)
    +0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 74, 0 },

  { 38, "ctrl_switch/Saturation6", 0, "", offsetof(B_ctrl_switch_T, Saturation6)
...
static NI_ExternalIO NI_ExtList[] DataSection(".NIVS.extlist") =
{
  ...
  { 1, "u_BT", 0, EXT_OUT, 1, 1, 1 },

  { 2, "u_VSP1", 0, EXT_OUT, 1, 1, 1 },
  ...
  { 7, "control input u exceeds bounds", 0, EXT_OUT, 1, 1, 1 },

  { 8, "indicator/ctrl_student", 0, EXT_OUT, 1, 1, 1 },

  { 9, "indicator/ctrl_DP_basic", 0, EXT_OUT, 1, 1, 1 },

  { 10, "indicator/ctrl_sixaxis2force", 0, EXT_OUT, 1, 1, 1 },
...
static char* NI_CompiledModelName DataSection(".NIVS.compiledmodelname") =
  "ctrl_switch";
static char* NI_CompiledModelVersion = "1.14";
static char* NI_CompiledModelDateTime = "Thu Mar 19 12:56:15 2015";
  ...
  * discStates, long* numClockTicks, char* clockTicksNames, long* clockTicks)
{
  ...
  if (discStates && discStatesNames) {
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_switch_DW.alpha_VSP2_DWORK1_m, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_switch_DW.alpha_VSP2_DWORK1_m");
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_switch_DW.u_BT_DWORK1_i, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_switch_DW.u_BT_DWORK1_i");
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_switch_DW.u_VSP1_DWORK1_d, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_switch_DW.u_VSP1_DWORK1_d");
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_switch_DW.u_VSP2_DWORK1_l, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_switch_DW.u_VSP2_DWORK1_l");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_switch_DW.alpha_VSP1_DWORK1_c, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_switch_DW.alpha_VSP1_DWORK1_c");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_switch_DW.omega_VSP1_DWORK1_k, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_switch_DW.omega_VSP1_DWORK1_k");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_switch_DW.omega_VSP2_DWORK1_l5, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_switch_DW.omega_VSP2_DWORK1_l5");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_switch_DW.alpha_VSP2_DWORK2_mq, count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_switch_DW.alpha_VSP2_DWORK2_mq");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_switch_DW.u_BT_DWORK2_n,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_switch_DW.u_BT_DWORK2_n");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_switch_DW.u_VSP1_DWORK2_n,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_switch_DW.u_VSP1_DWORK2_n");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_switch_DW.u_VSP2_DWORK2_ih,
        count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_switch_DW.u_VSP2_DWORK2_ih");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_switch_DW.alpha_VSP1_DWORK2_n, count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_switch_DW.alpha_VSP1_DWORK2_n");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_switch_DW.omega_VSP1_DWORK2_d, count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_switch_DW.omega_VSP1_DWORK2_d");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_switch_DW.omega_VSP2_DWORK2_er, count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_switch_DW.omega_VSP2_DWORK2_er");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_switch_DW.controlinputuexceedsbounds_DW_h, count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_switch_DW.controlinputuexceedsbounds_DW_h");
    }
  ...
  * clockTicks)
{
  ...
  if (discStates) {
    ...
    NIRT_SetValueByDataType(&ctrl_switch_DW.alpha_VSP2_DWORK1_e, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_switch_DW.alpha_VSP2_DWORK1_m, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_switch_DW.u_BT_DWORK1_i, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_switch_DW.u_VSP1_DWORK1_d, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_switch_DW.u_VSP2_DWORK1_l, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_switch_DW.alpha_VSP1_DWORK1_c, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_switch_DW.omega_VSP1_DWORK1_k, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_switch_DW.omega_VSP2_DWORK1_l5, 0,
      discStates[idx++], 0, 0);
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_switch_DW.alpha_VSP2_DWORK2_mq, count,
        discStates[idx++], 18, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_switch_DW.u_BT_DWORK2_n, count,
        discStates[idx++], 18, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_switch_DW.u_VSP1_DWORK2_n, count,
        discStates[idx++], 18, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_switch_DW.u_VSP2_DWORK2_ih, count,
        discStates[idx++], 18, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_switch_DW.alpha_VSP1_DWORK2_n, count,
        discStates[idx++], 18, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_switch_DW.omega_VSP1_DWORK2_d, count,
        discStates[idx++], 18, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_switch_DW.omega_VSP2_DWORK2_er, count,
        discStates[idx++], 18, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_switch_DW.controlinputuexceedsbounds_DW_h,
