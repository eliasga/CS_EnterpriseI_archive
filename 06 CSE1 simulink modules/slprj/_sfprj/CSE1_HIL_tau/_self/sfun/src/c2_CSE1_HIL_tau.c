...
static void initialize_c2_CSE1_HIL_tau(SFc2_CSE1_HIL_tauInstanceStruct
  *chartInstance);
static void initialize_params_c2_CSE1_HIL_tau(SFc2_CSE1_HIL_tauInstanceStruct
  *chartInstance);
static void enable_c2_CSE1_HIL_tau(SFc2_CSE1_HIL_tauInstanceStruct
  *chartInstance);
static void disable_c2_CSE1_HIL_tau(SFc2_CSE1_HIL_tauInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_CSE1_HIL_tau
  (SFc2_CSE1_HIL_tauInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_CSE1_HIL_tau
  (SFc2_CSE1_HIL_tauInstanceStruct *chartInstance);
static void set_sim_state_c2_CSE1_HIL_tau(SFc2_CSE1_HIL_tauInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_CSE1_HIL_tau(SFc2_CSE1_HIL_tauInstanceStruct
  *chartInstance);
static void sf_gateway_c2_CSE1_HIL_tau(SFc2_CSE1_HIL_tauInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_CSE1_HIL_tau(SFc2_CSE1_HIL_tauInstanceStruct
  *chartInstance);
static void initSimStructsc2_CSE1_HIL_tau(SFc2_CSE1_HIL_tauInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_CSE1_HIL_tauInstanceStruct *chartInstance,
  const mxArray *c2_nu_dot, const char_T *c2_identifier, real_T c2_y[3]);
static void c2_b_emlrt_marshallIn(SFc2_CSE1_HIL_tauInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[3]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_CSE1_HIL_tauInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_CSE1_HIL_tauInstanceStruct *chartInstance,
...
static real_T c2_mpower(SFc2_CSE1_HIL_tauInstanceStruct *chartInstance, real_T
  c2_a);
static void c2_eml_scalar_eg(SFc2_CSE1_HIL_tauInstanceStruct *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_CSE1_HIL_tauInstanceStruct *chartInstance);
static void c2_eml_xgemm(SFc2_CSE1_HIL_tauInstanceStruct *chartInstance, real_T
  c2_A[9], real_T c2_B[3], real_T c2_C[3], real_T c2_b_C[3]);
static void c2_mldivide(SFc2_CSE1_HIL_tauInstanceStruct *chartInstance, real_T
  c2_A[9], real_T c2_B[3], real_T c2_Y[3]);
static void c2_eml_warning(SFc2_CSE1_HIL_tauInstanceStruct *chartInstance);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_e_emlrt_marshallIn(SFc2_CSE1_HIL_tauInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_f_emlrt_marshallIn(SFc2_CSE1_HIL_tauInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_CSE1_HIL_tau, const char_T
  *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn(SFc2_CSE1_HIL_tauInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_eml_xgemm(SFc2_CSE1_HIL_tauInstanceStruct *chartInstance,
  real_T c2_A[9], real_T c2_B[3], real_T c2_C[3]);
static void init_dsm_address_info(SFc2_CSE1_HIL_tauInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_CSE1_HIL_tau = 0U;
}
  ...
  (SFc2_CSE1_HIL_tauInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_CSE1_HIL_tau;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_CSE1_HIL_tau = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_CSE1_HIL_tau");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_CSE1_HIL_tau(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_CSE1_HIL_tau(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_CSE1_HIL_tauInstanceStruct *chartInstance;
  chartInstance = (SFc2_CSE1_HIL_tauInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_CSE1_HIL_tau_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_CSE1_HIL_tau), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_CSE1_HIL_tau);
  return c2_y;
}
...
void sf_c2_CSE1_HIL_tau_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_CSE1_HIL_tau_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_CSE1_HIL_tau_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_CSE1_HIL_tau_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_CSE1_HIL_tau(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"nu_dot\",},{M[8],M[0],T\"is_active_c2_CSE1_HIL_tau\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_CSE1_HIL_tau_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_CSE1_HIL_tauInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c2_CSE1_HIL_tau(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_CSE1_HIL_tauInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_CSE1_HIL_tau((SFc2_CSE1_HIL_tauInstanceStruct*)
    chartInstanceVar);
  initialize_c2_CSE1_HIL_tau((SFc2_CSE1_HIL_tauInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_CSE1_HIL_tau(void *chartInstanceVar)
{
  enable_c2_CSE1_HIL_tau((SFc2_CSE1_HIL_tauInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_CSE1_HIL_tau(void *chartInstanceVar)
{
  disable_c2_CSE1_HIL_tau((SFc2_CSE1_HIL_tauInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_CSE1_HIL_tau(void *chartInstanceVar)
{
  sf_gateway_c2_CSE1_HIL_tau((SFc2_CSE1_HIL_tauInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_CSE1_HIL_tau(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_CSE1_HIL_tau
    ((SFc2_CSE1_HIL_tauInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_CSE1_HIL_tau();/* state var info */
...
extern void sf_internal_set_sim_state_c2_CSE1_HIL_tau(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_CSE1_HIL_tau();/* state var info */
  ...
  set_sim_state_c2_CSE1_HIL_tau((SFc2_CSE1_HIL_tauInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_CSE1_HIL_tau(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_CSE1_HIL_tau(S);
}

static void sf_opaque_set_sim_state_c2_CSE1_HIL_tau(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c2_CSE1_HIL_tau(S, st);
}

static void sf_opaque_terminate_c2_CSE1_HIL_tau(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_CSE1_HIL_tauInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_CSE1_HIL_tau((SFc2_CSE1_HIL_tauInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_CSE1_HIL_tau((SFc2_CSE1_HIL_tauInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_CSE1_HIL_tau(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_CSE1_HIL_tau(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_CSE1_HIL_tau(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_CSE1_HIL_tau(SimStruct *S)
{
  SFc2_CSE1_HIL_tauInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_CSE1_HIL_tauInstanceStruct *)utMalloc(sizeof
    (SFc2_CSE1_HIL_tauInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_CSE1_HIL_tauInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_CSE1_HIL_tau;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_CSE1_HIL_tau;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_CSE1_HIL_tau;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_CSE1_HIL_tau;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_CSE1_HIL_tau;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_CSE1_HIL_tau;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_CSE1_HIL_tau;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_CSE1_HIL_tau;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_CSE1_HIL_tau;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_CSE1_HIL_tau;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_CSE1_HIL_tau;
...
void c2_CSE1_HIL_tau_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_CSE1_HIL_tau(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_CSE1_HIL_tau(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_CSE1_HIL_tau(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_CSE1_HIL_tau_method_dispatcher.\n"
