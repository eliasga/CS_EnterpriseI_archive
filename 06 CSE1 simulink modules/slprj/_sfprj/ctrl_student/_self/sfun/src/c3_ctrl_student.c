...
static const char * c3_debug_family_names[8] = { "h", "a", "nargin", "nargout",
  "eta", "eta_prev", "eta_dot_prev", "eta_dot" };
...
static void c3_emlrt_marshallIn(SFc3_ctrl_studentInstanceStruct *chartInstance,
  const mxArray *c3_eta_dot, const char_T *c3_identifier, real_T c3_y[3]);
...
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_ctrl_studentInstanceStruct
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_ctrl_student, const char_T
  *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
  ...
  (SFc3_ctrl_studentInstanceStruct *chartInstance)
{
  ...
  real_T (*c3_eta_dot)[3];
  c3_eta_dot = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c3_st = NULL;
  c3_st = NULL;
  c3_y = NULL;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_ctrl_student = c3_e_emlrt_marshallIn
  ...
  *chartInstance)
{
  ...
  real_T c3_eta[3];
  int32_T c3_i4;
  real_T c3_eta_prev[3];
  int32_T c3_i5;
  real_T c3_eta_dot_prev[3];
  ...
  int32_T c3_i15;
  int32_T c3_i16;
  real_T (*c3_b_eta_dot)[3];
  real_T (*c3_b_eta_dot_prev)[3];
  real_T (*c3_b_eta_prev)[3];
  real_T (*c3_b_eta)[3];
  c3_b_eta_dot_prev = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 2);
  c3_b_eta_prev = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  c3_b_eta_dot = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c3_i2 = 0; c3_i2 < 3; c3_i2++) {
    _SFD_DATA_RANGE_CHECK((*c3_b_eta)[c3_i2], 0U);
  }
  ...
  for (c3_i4 = 0; c3_i4 < 3; c3_i4++) {
    c3_eta_prev[c3_i4] = (*c3_b_eta_prev)[c3_i4];
  }

  for (c3_i5 = 0; c3_i5 < 3; c3_i5++) {
    c3_eta_dot_prev[c3_i5] = (*c3_b_eta_dot_prev)[c3_i5];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 8U, 8U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_h, 0U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_a, 1U, c3_b_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 3U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_eta, 4U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_eta_prev, 5U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_eta_dot_prev, 6U, c3_sf_marshallOut);
  ...
  for (c3_i6 = 0; c3_i6 < 3; c3_i6++) {
    c3_x[c3_i6] = c3_eta[c3_i6] - c3_eta_prev[c3_i6];
  }

  for (c3_i7 = 0; c3_i7 < 3; c3_i7++) {
    c3_eta_dot[c3_i7] = c3_x[c3_i7] / 0.01;
  }
  ...
  for (c3_i10 = 0; c3_i10 < 3; c3_i10++) {
    c3_b[c3_i10] = c3_eta_dot_prev[c3_i10];
  }
  ...
  for (c3_i12 = 0; c3_i12 < 3; c3_i12++) {
    c3_eta_dot[c3_i12] = c3_x[c3_i12] + c3_b[c3_i12];
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -9);
  _SFD_SYMBOL_SCOPE_POP();
  for (c3_i13 = 0; c3_i13 < 3; c3_i13++) {
    (*c3_b_eta_dot)[c3_i13] = c3_eta_dot[c3_i13];
  }
  ...
  for (c3_i14 = 0; c3_i14 < 3; c3_i14++) {
    _SFD_DATA_RANGE_CHECK((*c3_b_eta_dot)[c3_i14], 1U);
  }

  for (c3_i15 = 0; c3_i15 < 3; c3_i15++) {
    _SFD_DATA_RANGE_CHECK((*c3_b_eta_prev)[c3_i15], 2U);
  }

  for (c3_i16 = 0; c3_i16 < 3; c3_i16++) {
    _SFD_DATA_RANGE_CHECK((*c3_b_eta_dot_prev)[c3_i16], 3U);
  }
}
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  for (c3_i20 = 0; c3_i20 < 3; c3_i20++) {
    (*(real_T (*)[3])c3_outData)[c3_i20] = c3_y[c3_i20];
  }
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("rdivide"), "name", "name", 0);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 3);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_div"), "name", "name", 3);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 3);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1909479844U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1153675027U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1685096677U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(571296301U);
}
...
mxArray *sf_c3_ctrl_student_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("sORURxp7BbX0GjRukpLxtF");
...
static const mxArray *sf_get_sim_state_info_c3_ctrl_student(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"eta_dot\",},{M[8],M[0],T\"is_active_c3_ctrl_student\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,1,1,0,"eta_prev");
          _SFD_SET_DATA_PROPS(3,1,1,0,"eta_dot_prev");
...

        {
          ...
          real_T (*c3_eta_prev)[3];
          real_T (*c3_eta_dot_prev)[3];
          c3_eta_dot_prev = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S,
            2);
          c3_eta_prev = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
          c3_eta_dot = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
          ...
          _SFD_SET_DATA_VALUE_PTR(2U, *c3_eta_prev);
          _SFD_SET_DATA_VALUE_PTR(3U, *c3_eta_dot_prev);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c3_ctrl_student(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3808135580U));
  ssSetChecksum1(S,(1649082931U));
  ssSetChecksum2(S,(2813173675U));
  ssSetChecksum3(S,(2124869341U));
