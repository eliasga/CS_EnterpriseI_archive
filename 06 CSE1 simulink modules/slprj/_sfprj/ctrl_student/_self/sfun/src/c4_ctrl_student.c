...
static const char * c4_debug_family_names[6] = { "R_inv", "nargin", "nargout",
  "eta_dot", "psi", "nu" };
...
static void c4_emlrt_marshallIn(SFc4_ctrl_studentInstanceStruct *chartInstance,
  const mxArray *c4_nu, const char_T *c4_identifier, real_T c4_y[3]);
...
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_d_emlrt_marshallIn(SFc4_ctrl_studentInstanceStruct *chartInstance,
...
static void c4_eml_xgemm(SFc4_ctrl_studentInstanceStruct *chartInstance, real_T
  c4_A[9], real_T c4_B[3], real_T c4_C[3], real_T c4_b_C[3]);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_e_emlrt_marshallIn(SFc4_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static uint8_T c4_f_emlrt_marshallIn(SFc4_ctrl_studentInstanceStruct
  ...
  *c4_identifier);
static uint8_T c4_g_emlrt_marshallIn(SFc4_ctrl_studentInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_eml_xgemm(SFc4_ctrl_studentInstanceStruct *chartInstance,
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 0)), "nu",
                      c4_dv0);
  for (c4_i1 = 0; c4_i1 < 3; c4_i1++) {
    (*c4_nu)[c4_i1] = c4_dv0[c4_i1];
  }

  chartInstance->c4_is_active_c4_ctrl_student = c4_f_emlrt_marshallIn
  ...
  *chartInstance)
{
  ...
  real_T *c4_b_psi;
  real_T (*c4_b_nu)[3];
  real_T (*c4_b_eta_dot)[3];
  c4_b_psi = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c4_b_nu = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c4_b_eta_dot = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, chartInstance->c4_sfEvent);
  for (c4_i2 = 0; c4_i2 < 3; c4_i2++) {
    _SFD_DATA_RANGE_CHECK((*c4_b_eta_dot)[c4_i2], 0U);
  }

  chartInstance->c4_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c4_sfEvent);
  c4_hoistedGlobal = *c4_b_psi;
  for (c4_i3 = 0; c4_i3 < 3; c4_i3++) {
    c4_eta_dot[c4_i3] = (*c4_b_eta_dot)[c4_i3];
  }

  c4_psi = c4_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 6U, 6U, c4_debug_family_names,
    c4_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_R_inv, 0U, c4_c_sf_marshallOut,
    c4_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 2U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c4_eta_dot, 3U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_psi, 4U, c4_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_nu, 5U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c4_i5 = 0; c4_i5 < 3; c4_i5++) {
    c4_R_inv[c4_i4 + 2] = c4_dv1[c4_i5];
    c4_i4 += 3;
  }

  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 6);
  for (c4_i6 = 0; c4_i6 < 9; c4_i6++) {
    c4_a[c4_i6] = c4_R_inv[c4_i6];
  }

  for (c4_i7 = 0; c4_i7 < 3; c4_i7++) {
    c4_b[c4_i7] = c4_eta_dot[c4_i7];
  }
  ...
  for (c4_i10 = 0; c4_i10 < 9; c4_i10++) {
    c4_dv2[c4_i10] = c4_a[c4_i10];
  }

  for (c4_i11 = 0; c4_i11 < 3; c4_i11++) {
    c4_dv3[c4_i11] = c4_b[c4_i11];
  }

  for (c4_i12 = 0; c4_i12 < 9; c4_i12++) {
    c4_dv4[c4_i12] = c4_dv2[c4_i12];
  }

  for (c4_i13 = 0; c4_i13 < 3; c4_i13++) {
    c4_dv5[c4_i13] = c4_dv3[c4_i13];
  }

  c4_b_eml_xgemm(chartInstance, c4_dv4, c4_dv5, c4_nu);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, -6);
  _SFD_SYMBOL_SCOPE_POP();
  for (c4_i14 = 0; c4_i14 < 3; c4_i14++) {
    (*c4_b_nu)[c4_i14] = c4_nu[c4_i14];
  }
  ...
  for (c4_i15 = 0; c4_i15 < 3; c4_i15++) {
    _SFD_DATA_RANGE_CHECK((*c4_b_nu)[c4_i15], 1U);
  }

  _SFD_DATA_RANGE_CHECK(*c4_b_psi, 2U);
}
  ...
  const mxArray *c4_nu, const char_T *c4_identifier, real_T c4_y[3])
{
  ...
  c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_nu), &c4_thisId, c4_y);
  ...
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[9])
{
  ...
  int32_T c4_i26;
  (void)chartInstance;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv7, 1, 0, 0U, 1, 0U, 2, 3, 3);
  for (c4_i26 = 0; c4_i26 < 9; c4_i26++) {
    c4_y[c4_i26] = c4_dv7[c4_i26];
  }
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  SFc4_ctrl_studentInstanceStruct *chartInstance;
  chartInstance = (SFc4_ctrl_studentInstanceStruct *)chartInstanceVoid;
  c4_R_inv = sf_mex_dup(c4_mxArrayInData);
  c4_identifier = c4_varName;
  c4_thisId.fIdentifier = c4_identifier;
  c4_thisId.fParent = NULL;
  c4_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_R_inv), &c4_thisId, c4_y);
  sf_mex_destroy(&c4_R_inv);
  c4_i27 = 0;
...
static const mxArray *sf_get_sim_state_info_c4_ctrl_student(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"nu\",},{M[8],M[0],T\"is_active_c4_ctrl_student\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c4_eta_dot)[3];
          real_T (*c4_nu)[3];
          c4_psi = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c4_nu = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
          c4_eta_dot = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c4_eta_dot);
          _SFD_SET_DATA_VALUE_PTR(1U, *c4_nu);
