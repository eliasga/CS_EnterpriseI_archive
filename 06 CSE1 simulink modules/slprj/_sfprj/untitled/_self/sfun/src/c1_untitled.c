...
static void c1_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_b_eta_dot, const char_T *c1_identifier, real_T c1_y[3]);
...
static void c1_eml_xgemm(SFc1_untitledInstanceStruct *chartInstance, real_T
...
static uint8_T c1_g_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_eml_xgemm(SFc1_untitledInstanceStruct *chartInstance, real_T
  ...
  *chartInstance)
{
  ...
  for (c1_i0 = 0; c1_i0 < 3; c1_i0++) {
    c1_u[c1_i0] = (*chartInstance->c1_eta_dot)[c1_i0];
  }
  ...
  const mxArray *c1_st)
{
  ...
  for (c1_i1 = 0; c1_i1 < 3; c1_i1++) {
    (*chartInstance->c1_eta_dot)[c1_i1] = c1_dv0[c1_i1];
  }
...
static void sf_gateway_c1_untitled(SFc1_untitledInstanceStruct *chartInstance)
{
  ...
  for (c1_i2 = 0; c1_i2 < 3; c1_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c1_nu)[c1_i2], 0U);
  }

  chartInstance->c1_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  for (c1_i3 = 0; c1_i3 < 3; c1_i3++) {
    c1_b_nu[c1_i3] = (*chartInstance->c1_nu)[c1_i3];
  }

  for (c1_i4 = 0; c1_i4 < 3; c1_i4++) {
    c1_b_eta[c1_i4] = (*chartInstance->c1_eta)[c1_i4];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 3U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_b_nu, 4U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_b_eta, 5U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_b_eta_dot, 6U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c1_i8 = 0; c1_i8 < 3; c1_i8++) {
    c1_b[c1_i8] = c1_b_nu[c1_i8];
  }

  c1_eml_scalar_eg(chartInstance);
  c1_eml_scalar_eg(chartInstance);
  for (c1_i9 = 0; c1_i9 < 3; c1_i9++) {
    c1_b_eta_dot[c1_i9] = 0.0;
  }
  ...
  for (c1_i13 = 0; c1_i13 < 3; c1_i13++) {
    c1_b_eta_dot[c1_i13] = c1_dv2[c1_i13];
  }

  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -9);
  _SFD_SYMBOL_SCOPE_POP();
  for (c1_i14 = 0; c1_i14 < 3; c1_i14++) {
    (*chartInstance->c1_eta_dot)[c1_i14] = c1_b_eta_dot[c1_i14];
  }
  ...
  for (c1_i15 = 0; c1_i15 < 3; c1_i15++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c1_eta_dot)[c1_i15], 1U);
  }

  for (c1_i16 = 0; c1_i16 < 3; c1_i16++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c1_eta)[c1_i16], 2U);
  }
}
  ...
  const mxArray *c1_b_eta_dot, const char_T *c1_identifier, real_T c1_y[3])
{
  ...
  c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_eta_dot), &c1_thisId,
                        c1_y);
  sf_mex_destroy(&c1_b_eta_dot);
}
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  SFc1_untitledInstanceStruct *chartInstance;
  chartInstance = (SFc1_untitledInstanceStruct *)chartInstanceVoid;
  c1_b_eta_dot = sf_mex_dup(c1_mxArrayInData);
  ...
  c1_A[9], real_T c1_B[3], real_T c1_C[3])
{
  ...
  for (c1_i35 = 0; c1_i35 < 3; c1_i35++) {
    ...
    for (c1_i37 = 0; c1_i37 < 3; c1_i37++) {
      c1_C[c1_i35] += c1_A[c1_i36 + c1_i35] * c1_B[c1_i37];
      c1_i36 += 3;
    }
  }
}
...
static void init_simulink_io_address(SFc1_untitledInstanceStruct *chartInstance)
{
  chartInstance->c1_nu = (real_T (*)[3])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c1_eta_dot = (real_T (*)[3])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3412785862U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1823776822U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4172983039U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1662341695U);
}
...
mxArray *sf_c1_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("tY2FGniD4BUrUwWlysSdGB");
...
static const mxArray *sf_get_sim_state_info_c1_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"eta_dot\",},{M[8],M[0],T\"is_active_c1_untitled\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c1_nu);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c1_eta_dot);
        _SFD_SET_DATA_VALUE_PTR(2U, *chartInstance->c1_eta);
      }
    } else {
...
static void mdlSetWorkWidths_c1_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3528057366U));
  ssSetChecksum1(S,(1981630204U));
  ssSetChecksum2(S,(396887292U));
  ssSetChecksum3(S,(879871898U));
