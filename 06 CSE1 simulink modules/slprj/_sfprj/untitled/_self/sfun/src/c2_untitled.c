...
static void c2_emlrt_marshallIn(SFc2_untitledInstanceStruct *chartInstance,
  const mxArray *c2_b_nu_dot, const char_T *c2_identifier, real_T c2_y[3]);
...
static void c2_eml_xgemm(SFc2_untitledInstanceStruct *chartInstance, real_T
...
static real_T c2_rdivide(SFc2_untitledInstanceStruct *chartInstance, real_T c2_x,
  real_T c2_y);
...
static uint8_T c2_g_emlrt_marshallIn(SFc2_untitledInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_eml_xgemm(SFc2_untitledInstanceStruct *chartInstance, real_T
  ...
  *chartInstance)
{
  ...
  for (c2_i0 = 0; c2_i0 < 3; c2_i0++) {
    c2_u[c2_i0] = (*chartInstance->c2_nu_dot)[c2_i0];
  }
  ...
  const mxArray *c2_st)
{
  ...
  for (c2_i1 = 0; c2_i1 < 3; c2_i1++) {
    (*chartInstance->c2_nu_dot)[c2_i1] = c2_dv0[c2_i1];
  }
...
static void sf_gateway_c2_untitled(SFc2_untitledInstanceStruct *chartInstance)
{
  ...
  for (c2_i2 = 0; c2_i2 < 3; c2_i2++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c2_tau)[c2_i2], 0U);
  }
  ...
  for (c2_i3 = 0; c2_i3 < 3; c2_i3++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c2_nu_dot)[c2_i3], 1U);
  }

  for (c2_i4 = 0; c2_i4 < 3; c2_i4++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c2_nu)[c2_i4], 2U);
  }
}
...
static void c2_chartstep_c2_untitled(SFc2_untitledInstanceStruct *chartInstance)
{
  ...
  for (c2_i5 = 0; c2_i5 < 3; c2_i5++) {
    c2_b_tau[c2_i5] = (*chartInstance->c2_tau)[c2_i5];
  }

  for (c2_i6 = 0; c2_i6 < 3; c2_i6++) {
    c2_b_nu[c2_i6] = (*chartInstance->c2_nu)[c2_i6];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 50U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_b_tau, 51U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_b_nu, 52U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_b_nu_dot, 53U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c2_i14 = 0; c2_i14 < 3; c2_i14++) {
    c2_f_tau[c2_i14] = c2_b_tau[c2_i14] - c2_g_y[c2_i14];
  }

  c2_mldivide(chartInstance, c2_dv2, c2_f_tau, c2_dv3);
  for (c2_i15 = 0; c2_i15 < 3; c2_i15++) {
    c2_b_nu_dot[c2_i15] = c2_dv3[c2_i15];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -70);
  _SFD_SYMBOL_SCOPE_POP();
  for (c2_i16 = 0; c2_i16 < 3; c2_i16++) {
    (*chartInstance->c2_nu_dot)[c2_i16] = c2_b_nu_dot[c2_i16];
  }
  ...
  const mxArray *c2_b_nu_dot, const char_T *c2_identifier, real_T c2_y[3])
{
  ...
  c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_nu_dot), &c2_thisId, c2_y);
  sf_mex_destroy(&c2_b_nu_dot);
}
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  SFc2_untitledInstanceStruct *chartInstance;
  chartInstance = (SFc2_untitledInstanceStruct *)chartInstanceVoid;
  c2_b_nu_dot = sf_mex_dup(c2_mxArrayInData);
...
static void init_simulink_io_address(SFc2_untitledInstanceStruct *chartInstance)
{
  chartInstance->c2_tau = (real_T (*)[3])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c2_nu_dot = (real_T (*)[3])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_nu = (real_T (*)[3])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3683616510U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1838537846U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4259242757U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(399783929U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("3V0LXLa9qXQmz77X1voJGE");
...
static const mxArray *sf_get_sim_state_info_c2_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"nu_dot\",},{M[8],M[0],T\"is_active_c2_untitled\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c2_tau);
        _SFD_SET_DATA_VALUE_PTR(1U, *chartInstance->c2_nu_dot);
        _SFD_SET_DATA_VALUE_PTR(2U, *chartInstance->c2_nu);
      }
    } else {
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1724931449U));
  ssSetChecksum1(S,(2291840916U));
  ssSetChecksum2(S,(3162144507U));
  ssSetChecksum3(S,(3687713441U));
