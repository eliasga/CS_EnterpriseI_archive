 ...
 * C source code generated on : Fri May 15 18:46:19 2015
 *
...
static void u2pwm_output(void)
{
  ...
  if (u2pwm_B.omega_VSP1 > u2pwm_P.Saturation1_UpperSat) {
    rtb_Product5 = u2pwm_P.Saturation1_UpperSat;
  } else if (u2pwm_B.omega_VSP1 < u2pwm_P.Saturation1_LowerSat) {
    rtb_Product5 = u2pwm_P.Saturation1_LowerSat;
  } else {
    rtb_Product5 = u2pwm_B.omega_VSP1;
  }
   ...
   *  Saturate: '<Root>/Saturation1'
   */
  u2pwm_B.Sum1 = u2pwm_P.VSP_u2pwm_gain * rtb_Product5 + u2pwm_P.VSP_zero_pwm;

  /* Saturate: '<Root>/Saturation2' */
  if (u2pwm_B.omega_VSP2 > u2pwm_P.Saturation2_UpperSat) {
    rtb_Product5 = u2pwm_P.Saturation2_UpperSat;
  } else if (u2pwm_B.omega_VSP2 < u2pwm_P.Saturation2_LowerSat) {
    rtb_Product5 = u2pwm_P.Saturation2_LowerSat;
  } else {
    rtb_Product5 = u2pwm_B.omega_VSP2;
  }
   ...
   *  Saturate: '<Root>/Saturation2'
   */
  u2pwm_B.Sum = u2pwm_P.VSP_u2pwm_gain * rtb_Product5 + u2pwm_P.VSP_zero_pwm;

  /* Saturate: '<Root>/Saturation' */
  if (u2pwm_B.u_BT > u2pwm_P.Saturation_UpperSat) {
    rtb_Product5 = u2pwm_P.Saturation_UpperSat;
  } else if (u2pwm_B.u_BT < u2pwm_P.Saturation_LowerSat) {
    rtb_Product5 = u2pwm_P.Saturation_LowerSat;
  } else {
    rtb_Product5 = u2pwm_B.u_BT;
  }
   ...
   *  Saturate: '<Root>/Saturation'
   */
  u2pwm_B.Sum2 = u2pwm_P.BT_u2pwm_gain * rtb_Product5 + u2pwm_P.BT_zero_pwm;

  /* Saturate: '<Root>/Saturation3' */
  if (u2pwm_B.u_VSP2 > u2pwm_P.Saturation3_UpperSat) {
    rtb_Product5 = u2pwm_P.Saturation3_UpperSat;
  } else if (u2pwm_B.u_VSP2 < u2pwm_P.Saturation3_LowerSat) {
    rtb_Product5 = u2pwm_P.Saturation3_LowerSat;
  } else {
    rtb_Product5 = u2pwm_B.u_VSP2;
  }
   ...
   */
  rtb_Gain1 = u2pwm_P.Constant1_Value + u2pwm_B.alpha_VSP2;
   ...
   */
  u2pwm_B.DLookupTable3 = look2_binlxpw(rtb_Product5 * cos(rtb_Gain1) *
    u2pwm_P.Gain3_Gain, rtb_Product5 * sin(rtb_Gain1),
   ...
   */
  rtb_Product9 = rtb_Product5 * cos(rtb_Gain1) * u2pwm_P.Gain2_Gain;
  ...
  u2pwm_B.DLookupTable2 = look2_binlxpw(rtb_Product9, rtb_Product5,
  ...
  if (u2pwm_B.u_VSP1 > u2pwm_P.Saturation4_UpperSat) {
    rtb_Product5 = u2pwm_P.Saturation4_UpperSat;
  } else if (u2pwm_B.u_VSP1 < u2pwm_P.Saturation4_LowerSat) {
    rtb_Product5 = u2pwm_P.Saturation4_LowerSat;
  } else {
    rtb_Product5 = u2pwm_B.u_VSP1;
  }

  /* Gain: '<Root>/Gain4' incorporates:
   *  Saturate: '<Root>/Saturation4'
   */
  rtb_Product9 = u2pwm_P.Gain4_Gain * rtb_Product5;

  /* Sum: '<Root>/Sum3' incorporates:
   *  Constant: '<Root>/Constant'
   */
  rtb_Product5 = u2pwm_B.alpha_VSP1 - u2pwm_P.Constant_Value;
   ...
   */
  u2pwm_B.DLookupTable = look2_binlxpw(rtb_Product9 * cos(rtb_Product5) *
    u2pwm_P.Gain_Gain, rtb_Product9 * sin(rtb_Product5),
   ...
   */
  rtb_Gain1 = rtb_Product9 * cos(rtb_Product5) * u2pwm_P.Gain1_Gain;
  ...
  u2pwm_B.DLookupTable1 = look2_binlxpw(rtb_Gain1, rtb_Product9,
...
RT_MODEL_u2pwm_T *u2pwm(void)
{
  ...
  u2pwm_M->Sizes.numBlocks = (57);     /* Number of blocks */
  u2pwm_M->Sizes.numBlockIO = (14);    /* Number of block outputs */
  u2pwm_M->Sizes.numBlockPrms = (254); /* Sum of parameter "widths" */
  return u2pwm_M;
}
...
void SetExternalOutputs(double* data, int* TaskSampleHit)
{
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&u2pwm_B.DLookupTable3,0,0,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&u2pwm_B.DLookupTable2,0,0,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&u2pwm_B.DLookupTable,0,0,0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&u2pwm_B.DLookupTable1,0,0,0);
  } else {
    index += 1;
  }
...
{
  { 0, "u2pwm/VPS_Speed_Gain1/Gain", offsetof(P_u2pwm_T, BT_u2pwm_gain), 26, 1,
    2, 0, 0 },

  { 1, "u2pwm/VPS_Power_Offset1/Value", offsetof(P_u2pwm_T, BT_zero_pwm), 26, 1,
    2, 2, 0 },

  { 2, "u2pwm/VPS_Speed_Gain/Gain", offsetof(P_u2pwm_T, VSP_u2pwm_gain), 26, 1,
    2, 4, 0 },

  { 3, "u2pwm/VPS_Speed_Gain2/Gain", offsetof(P_u2pwm_T, VSP_u2pwm_gain), 26, 1,
    2, 6, 0 },

  { 4, "u2pwm/VPS_Power_Offset/Value", offsetof(P_u2pwm_T, VSP_zero_pwm), 26, 1,
    2, 8, 0 },

  { 5, "u2pwm/Saturation1/UpperLimit", offsetof(P_u2pwm_T, Saturation1_UpperSat),
    26, 1, 2, 10, 0 },

  { 6, "u2pwm/Saturation1/LowerLimit", offsetof(P_u2pwm_T, Saturation1_LowerSat),
    26, 1, 2, 12, 0 },

  { 7, "u2pwm/Saturation2/UpperLimit", offsetof(P_u2pwm_T, Saturation2_UpperSat),
    26, 1, 2, 14, 0 },

  { 8, "u2pwm/Saturation2/LowerLimit", offsetof(P_u2pwm_T, Saturation2_LowerSat),
    26, 1, 2, 16, 0 },

  { 9, "u2pwm/Saturation/UpperLimit", offsetof(P_u2pwm_T, Saturation_UpperSat),
    26, 1, 2, 18, 0 },

  { 10, "u2pwm/Saturation/LowerLimit", offsetof(P_u2pwm_T, Saturation_LowerSat),
    26, 1, 2, 20, 0 },

  { 11, "u2pwm/Saturation3/UpperLimit", offsetof(P_u2pwm_T, Saturation3_UpperSat),
    26, 1, 2, 22, 0 },

  { 12, "u2pwm/Saturation3/LowerLimit", offsetof(P_u2pwm_T, Saturation3_LowerSat),
    26, 1, 2, 24, 0 },

  { 13, "u2pwm/Constant1/Value", offsetof(P_u2pwm_T, Constant1_Value), 26, 1, 2,
    26, 0 },

  { 14, "u2pwm/Gain3/Gain", offsetof(P_u2pwm_T, Gain3_Gain), 26, 1, 2, 28, 0 },

  { 15, "u2pwm/2-D Lookup Table3/Table", offsetof(P_u2pwm_T,
    DLookupTable3_tableData), 27, 25, 2, 30, 0 },

  { 16, "u2pwm/2-D Lookup Table3/BreakpointsForDimension1", offsetof(P_u2pwm_T,
    DLookupTable3_bp01Data), 28, 5, 2, 32, 0 },

  { 17, "u2pwm/2-D Lookup Table3/BreakpointsForDimension2", offsetof(P_u2pwm_T,
    DLookupTable3_bp02Data), 28, 5, 2, 34, 0 },

  { 18, "u2pwm/Gain2/Gain", offsetof(P_u2pwm_T, Gain2_Gain), 26, 1, 2, 36, 0 },

  { 19, "u2pwm/2-D Lookup Table2/Table", offsetof(P_u2pwm_T,
    DLookupTable2_tableData), 27, 25, 2, 38, 0 },

  { 20, "u2pwm/2-D Lookup Table2/BreakpointsForDimension1", offsetof(P_u2pwm_T,
    DLookupTable2_bp01Data), 28, 5, 2, 40, 0 },

  { 21, "u2pwm/2-D Lookup Table2/BreakpointsForDimension2", offsetof(P_u2pwm_T,
    DLookupTable2_bp02Data), 28, 5, 2, 42, 0 },

  { 22, "u2pwm/Saturation4/UpperLimit", offsetof(P_u2pwm_T, Saturation4_UpperSat),
    26, 1, 2, 44, 0 },

  { 23, "u2pwm/Saturation4/LowerLimit", offsetof(P_u2pwm_T, Saturation4_LowerSat),
    26, 1, 2, 46, 0 },

  { 24, "u2pwm/Gain4/Gain", offsetof(P_u2pwm_T, Gain4_Gain), 26, 1, 2, 48, 0 },

  { 25, "u2pwm/Constant/Value", offsetof(P_u2pwm_T, Constant_Value), 26, 1, 2,
    50, 0 },

  { 26, "u2pwm/Gain/Gain", offsetof(P_u2pwm_T, Gain_Gain), 26, 1, 2, 52, 0 },

  { 27, "u2pwm/2-D Lookup Table/Table", offsetof(P_u2pwm_T,
    DLookupTable_tableData), 27, 25, 2, 54, 0 },

  { 28, "u2pwm/2-D Lookup Table/BreakpointsForDimension1", offsetof(P_u2pwm_T,
    DLookupTable_bp01Data), 28, 5, 2, 56, 0 },

  { 29, "u2pwm/2-D Lookup Table/BreakpointsForDimension2", offsetof(P_u2pwm_T,
    DLookupTable_bp02Data), 28, 5, 2, 58, 0 },

  { 30, "u2pwm/Gain1/Gain", offsetof(P_u2pwm_T, Gain1_Gain), 26, 1, 2, 60, 0 },

  { 31, "u2pwm/2-D Lookup Table1/Table", offsetof(P_u2pwm_T,
    DLookupTable1_tableData), 27, 25, 2, 62, 0 },

  { 32, "u2pwm/2-D Lookup Table1/BreakpointsForDimension1", offsetof(P_u2pwm_T,
    DLookupTable1_bp01Data), 28, 5, 2, 64, 0 },

  { 33, "u2pwm/2-D Lookup Table1/BreakpointsForDimension2", offsetof(P_u2pwm_T,
    DLookupTable1_bp02Data), 28, 5, 2, 66, 0 },

  { 34, "u2pwm/2-D Lookup Table3/maxIndex", offsetof(P_u2pwm_T,
  ...
  { 36, "u2pwm/2-D Lookup Table/maxIndex", offsetof(P_u2pwm_T,
    DLookupTable_maxIndex), 21, 2, 2, 72, 0 },

  { 37, "u2pwm/2-D Lookup Table1/maxIndex", offsetof(P_u2pwm_T,
...
{
  { 0, "u2pwm/alpha_VSP1", 0, "", offsetof(B_u2pwm_T, alpha_VSP1)+0*sizeof
    (real_T), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 1, "u2pwm/omega_VSP1", 0, "", offsetof(B_u2pwm_T, omega_VSP1)+0*sizeof
    (real_T), BLOCKIO_SIG, 0, 1, 2, 2, 0 },

  { 2, "u2pwm/Sum1", 0, "", offsetof(B_u2pwm_T, Sum1)+0*sizeof(real_T),
    BLOCKIO_SIG, 0, 1, 2, 4, 0 },

  { 3, "u2pwm/u_VSP1", 0, "", offsetof(B_u2pwm_T, u_VSP1)+0*sizeof(real_T),
    BLOCKIO_SIG, 0, 1, 2, 6, 0 },

  { 4, "u2pwm/omega_VSP2", 0, "", offsetof(B_u2pwm_T, omega_VSP2)+0*sizeof
    (real_T), BLOCKIO_SIG, 0, 1, 2, 8, 0 },

  { 5, "u2pwm/Sum", 0, "", offsetof(B_u2pwm_T, Sum)+0*sizeof(real_T),
    BLOCKIO_SIG, 0, 1, 2, 10, 0 },

  { 6, "u2pwm/alpha_VSP2", 0, "", offsetof(B_u2pwm_T, alpha_VSP2)+0*sizeof
    (real_T), BLOCKIO_SIG, 0, 1, 2, 12, 0 },

  { 7, "u2pwm/u_BT", 0, "", offsetof(B_u2pwm_T, u_BT)+0*sizeof(real_T),
    BLOCKIO_SIG, 0, 1, 2, 14, 0 },

  { 8, "u2pwm/Sum2", 0, "", offsetof(B_u2pwm_T, Sum2)+0*sizeof(real_T),
    BLOCKIO_SIG, 0, 1, 2, 16, 0 },

  { 9, "u2pwm/u_VSP2", 0, "", offsetof(B_u2pwm_T, u_VSP2)+0*sizeof(real_T),
    BLOCKIO_SIG, 0, 1, 2, 18, 0 },

  { 10, "u2pwm/2-D Lookup Table3", 0, "", offsetof(B_u2pwm_T, DLookupTable3)+0*
    sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 20, 0 },

  { 11, "u2pwm/2-D Lookup Table2", 0, "", offsetof(B_u2pwm_T, DLookupTable2)+0*
    sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 22, 0 },

  { 12, "u2pwm/2-D Lookup Table", 0, "", offsetof(B_u2pwm_T, DLookupTable)+0*
    sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 24, 0 },

  { 13, "u2pwm/2-D Lookup Table1", 0, "", offsetof(B_u2pwm_T, DLookupTable1)+0*
...
static char* NI_CompiledModelDateTime = "Fri May 15 18:46:18 2015";
  ...
  * discStates, long* numClockTicks, char* clockTicksNames, long* clockTicks)
{
  ...
  if (discStates && discStatesNames) {
    ...
    for (count = 0; count < 49; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&u2pwm_DW.NIVeriStandSignalProbe_DWORK3, count, 18, 0);
      strcpy(discStatesNames + (idx++ * 100),
