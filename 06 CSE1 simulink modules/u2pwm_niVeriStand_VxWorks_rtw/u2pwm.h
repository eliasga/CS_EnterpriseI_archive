...
typedef struct {
  ...
  uint8_T alpha_VSP1_DWORK2[6];        /* '<Root>/alpha_VSP1' */
  uint8_T omega_VSP1_DWORK2[6];        /* '<Root>/omega_VSP1' */
  uint8_T pwm_VSP1_DWORK2[6];          /* '<Root>/pwm_VSP1' */
  uint8_T u_VSP1_DWORK2[6];            /* '<Root>/u_VSP1' */
  uint8_T omega_VSP2_DWORK2[6];        /* '<Root>/omega_VSP2' */
  uint8_T pwm_VSP2_DWORK2[6];          /* '<Root>/pwm_VSP2' */
  uint8_T alpha_VSP2_DWORK2[6];        /* '<Root>/alpha_VSP2' */
  uint8_T u_BT_DWORK2[6];              /* '<Root>/u_BT' */
  uint8_T pwm_BT_DWORK2[6];            /* '<Root>/pwm_BT' */
  uint8_T u_VSP2_DWORK2[6];            /* '<Root>/u_VSP2' */
  uint8_T pwm_servo4_DWORK2[6];        /* '<Root>/pwm_servo4' */
  uint8_T pwm_servo3_DWORK2[6];        /* '<Root>/pwm_servo3' */
  uint8_T pwm_servo1_DWORK2[6];        /* '<Root>/pwm_servo1' */
  uint8_T pwm_servo2_DWORK2[6];        /* '<Root>/pwm_servo2' */
