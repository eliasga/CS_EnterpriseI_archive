 ...
 */
#ifndef RTW_HEADER_uao2pwm_h_
#define RTW_HEADER_uao2pwm_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef uao2pwm_COMMON_INCLUDES_
# define uao2pwm_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_logging.h"
#endif                                 /* uao2pwm_COMMON_INCLUDES_ */

#include "uao2pwm_types.h"
...
#define uao2pwm_rtModel                RT_MODEL_uao2pwm_T

/* Block signals (auto storage) */
typedef struct {
  real_T alpha_VSP1;                   /* '<Root>/alpha_VSP1' */
  real_T omega_VSP1;                   /* '<Root>/omega_VSP1' */
  real_T Sum1;                         /* '<Root>/Sum1' */
  real_T u_VSP1;                       /* '<Root>/u_VSP1' */
  real_T omega_VSP2;                   /* '<Root>/omega_VSP2' */
  real_T Sum;                          /* '<Root>/Sum' */
  real_T alpha_VSP2;                   /* '<Root>/alpha_VSP2' */
  real_T u_BT;                         /* '<Root>/u_BT' */
  real_T Sum2;                         /* '<Root>/Sum2' */
  real_T u_VSP2;                       /* '<Root>/u_VSP2' */
  real_T DLookupTable3;                /* '<Root>/2-D Lookup Table3' */
  real_T DLookupTable2;                /* '<Root>/2-D Lookup Table2' */
  real_T DLookupTable;                 /* '<Root>/2-D Lookup Table' */
  real_T DLookupTable1;                /* '<Root>/2-D Lookup Table1' */
} B_uao2pwm_T;
...
typedef struct {
  ...
  real_T pwm_VSP1_DWORK1;              /* '<Root>/pwm_VSP1' */
  real_T u_VSP1_DWORK1;                /* '<Root>/u_VSP1' */
  real_T omega_VSP2_DWORK1;            /* '<Root>/omega_VSP2' */
  real_T pwm_VSP2_DWORK1;              /* '<Root>/pwm_VSP2' */
  real_T alpha_VSP2_DWORK1;            /* '<Root>/alpha_VSP2' */
  real_T u_BT_DWORK1;                  /* '<Root>/u_BT' */
  real_T pwm_BT_DWORK1;                /* '<Root>/pwm_BT' */
  real_T u_VSP2_DWORK1;                /* '<Root>/u_VSP2' */
  real_T pwm_servo4_DWORK1;            /* '<Root>/pwm_servo4' */
  real_T pwm_servo3_DWORK1;            /* '<Root>/pwm_servo3' */
  real_T pwm_servo1_DWORK1;            /* '<Root>/pwm_servo1' */
  real_T pwm_servo2_DWORK1;            /* '<Root>/pwm_servo2' */
  ...
  uint8_T pwm_VSP1_DWORK2[8];          /* '<Root>/pwm_VSP1' */
  uint8_T u_VSP1_DWORK2[8];            /* '<Root>/u_VSP1' */
  uint8_T omega_VSP2_DWORK2[8];        /* '<Root>/omega_VSP2' */
  uint8_T pwm_VSP2_DWORK2[8];          /* '<Root>/pwm_VSP2' */
  uint8_T alpha_VSP2_DWORK2[8];        /* '<Root>/alpha_VSP2' */
  uint8_T u_BT_DWORK2[8];              /* '<Root>/u_BT' */
  uint8_T pwm_BT_DWORK2[8];            /* '<Root>/pwm_BT' */
  uint8_T u_VSP2_DWORK2[8];            /* '<Root>/u_VSP2' */
  uint8_T pwm_servo4_DWORK2[8];        /* '<Root>/pwm_servo4' */
  uint8_T pwm_servo3_DWORK2[8];        /* '<Root>/pwm_servo3' */
  uint8_T pwm_servo1_DWORK2[8];        /* '<Root>/pwm_servo1' */
  uint8_T pwm_servo2_DWORK2[8];        /* '<Root>/pwm_servo2' */
  uint8_T NIVeriStandSignalProbe_DWORK1[8];/* '<Root>/NIVeriStandSignalProbe' */
  uint8_T NIVeriStandSignalProbe_DWORK3[51];/* '<Root>/NIVeriStandSignalProbe' */
} DW_uao2pwm_T;

/* Backward compatible GRT Identifiers */
#define rtB                            uao2pwm_B
#define BlockIO                        B_uao2pwm_T
#define rtP                            uao2pwm_P
#define Parameters                     P_uao2pwm_T
#define rtDWork                        uao2pwm_DW
#define D_Work                         DW_uao2pwm_T
...
extern P_uao2pwm_T uao2pwm_P;

/* Block signals (auto storage) */
extern B_uao2pwm_T uao2pwm_B;

/* Block states (auto storage) */
extern DW_uao2pwm_T uao2pwm_DW;

/* Real-time Model object */
extern RT_MODEL_uao2pwm_T *const uao2pwm_M;
...
P_uao2pwm_T rtParameter[NUMST+!TID01EQ];
P_uao2pwm_T *param_lookup[NUMST][2] = {
  { &rtParameter[0], &rtParameter[1] },
};

#else

P_uao2pwm_T rtParameter[2];
...
extern int tid;
extern P_uao2pwm_T* param_lookup[NUMST][2];

#else

extern P_uao2pwm_T rtParameter[];

#endif
#endif

#ifdef MULTITASKING
#define uao2pwm_P                      (*param_lookup[tid][READSIDE])
#else
#define uao2pwm_P                      rtParameter[READSIDE]
#endif
#endif
#endif
