...
#
# File    : uao2pwm.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= uao2pwm
MODULES         		:= NIVeriStand_main.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c uao2pwm_data.c 
MAKEFILE        		:= uao2pwm.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\uao2pwm_niVeriStand_VxWorks_rtw
