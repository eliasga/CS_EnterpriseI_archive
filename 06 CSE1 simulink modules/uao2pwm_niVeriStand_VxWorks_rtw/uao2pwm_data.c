...
# define uao2pwm_P                     uao2pwm_P DataSection(".NIVS.defaultparams")
#endif
...
NI_ParamSizeWidth P_uao2pwm_T_sizes[] DataSection(".NIVS.defaultparamsizes") = {
  { sizeof(P_uao2pwm_T), 1 },
