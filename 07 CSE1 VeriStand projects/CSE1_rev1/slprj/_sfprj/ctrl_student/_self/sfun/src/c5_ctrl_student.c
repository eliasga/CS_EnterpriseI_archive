...
static void c5_emlrt_marshallIn(SFc5_ctrl_studentInstanceStruct *chartInstance,
  const mxArray *c5_y, const char_T *c5_identifier, real_T c5_b_y[4]);
  ...
  (SFc5_ctrl_studentInstanceStruct *chartInstance)
{
  ...
  c5_b_y = NULL;
  sf_mex_assign(&c5_b_y, sf_mex_create("y", c5_u, 0, 0U, 1U, 0U, 2, 2, 2), false);
  ...
  *chartInstance)
{
  ...
  real_T (*c5_b_y)[4];
  real_T (*c5_b_u)[2];
  c5_b_y = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
  c5_b_u = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 0);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_nargout, 1U, c5_c_sf_marshallOut,
    c5_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c5_u, 2U, c5_b_sf_marshallOut);
  ...
  for (c5_j = 1; c5_j < 3; c5_j++) {
    ...
    c5_y[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c5_b_j), 1, 2, 1, 0) + ((_SFD_EML_ARRAY_BOUNDS_CHECK("",
             (int32_T)_SFD_INTEGER_CHECK("", (real_T)c5_b_j), 1, 2, 2, 0) - 1) <<
           1)) - 1] = c5_v[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c5_b_j), 1, 2, 1, 0) - 1];
  }

  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, -4);
  _SFD_SYMBOL_SCOPE_POP();
  for (c5_i5 = 0; c5_i5 < 4; c5_i5++) {
    (*c5_b_y)[c5_i5] = c5_y[c5_i5];
  }
  ...
  for (c5_i6 = 0; c5_i6 < 4; c5_i6++) {
    _SFD_DATA_RANGE_CHECK((*c5_b_y)[c5_i6], 1U);
  }
}
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  for (c5_i8 = 0; c5_i8 < 2; c5_i8++) {
    for (c5_i9 = 0; c5_i9 < 2; c5_i9++) {
      c5_b_inData[c5_i9 + c5_i7] = (*(real_T (*)[4])c5_inData)[c5_i9 + c5_i7];
    }
  ...
  for (c5_i11 = 0; c5_i11 < 2; c5_i11++) {
    for (c5_i12 = 0; c5_i12 < 2; c5_i12++) {
      c5_u[c5_i12 + c5_i10] = c5_b_inData[c5_i12 + c5_i10];
    }
  ...
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[4])
{
  ...
  int32_T c5_i13;
  (void)chartInstance;
  sf_mex_import(c5_parentId, sf_mex_dup(c5_u), c5_dv1, 1, 0, 0U, 1, 0U, 2, 2, 2);
  for (c5_i13 = 0; c5_i13 < 4; c5_i13++) {
    c5_y[c5_i13] = c5_dv1[c5_i13];
  }
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  for (c5_i15 = 0; c5_i15 < 2; c5_i15++) {
    for (c5_i16 = 0; c5_i16 < 2; c5_i16++) {
      (*(real_T (*)[4])c5_outData)[c5_i16 + c5_i14] = c5_b_y[c5_i16 + c5_i14];
    }
  ...
  *c5_inData)
{
  ...
  for (c5_i17 = 0; c5_i17 < 2; c5_i17++) {
    c5_b_inData[c5_i17] = (*(real_T (*)[2])c5_inData)[c5_i17];
  }
...
static const mxArray *sf_get_sim_state_info_c5_ctrl_student(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c5_ctrl_student\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c5_y)[4];
          c5_y = (real_T (*)[4])ssGetOutputPortSignal(chartInstance->S, 1);
          c5_u = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 0);
