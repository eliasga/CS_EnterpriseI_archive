...
typedef struct {
  ...
  uint8_T alpha_VSP2_DWORK2[13];       /* '<Root>/alpha_VSP2' */
  uint8_T omega_VSP1_DWORK2[13];       /* '<Root>/omega_VSP1' */
  uint8_T y_DWORK2[13];                /* '<Root>/y' */
  uint8_T omega_VSP2_DWORK2[13];       /* '<Root>/omega_VSP2' */
  uint8_T psi_DWORK2[13];              /* '<Root>/psi' */
  uint8_T alpha_VSP1_DWORK2[13];       /* '<Root>/alpha_VSP1' */
  uint8_T u_BT_DWORK2[13];             /* '<Root>/u_BT' */
  uint8_T u_VSP1_DWORK2[13];           /* '<Root>/u_VSP1' */
  uint8_T u_VSP2_DWORK2[13];           /* '<Root>/u_VSP2' */
 ...
 *
 * '<Root>' : 'ctrl_student'
 * '<S1>'   : 'ctrl_student/Thrust allocation'
 */
