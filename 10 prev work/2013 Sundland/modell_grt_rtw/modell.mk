...
#
# File    : grt_vc.tmf   $Revision: 1.71.4.29.2.1 $
#
# Abstract:
...
MODEL                = modell
MODULES              = modell_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c rt_rand.c rt_rem_snf.c rt_round_snf.c rt_zcfcn.c 
MAKEFILE             = modell.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:\DOCUME~1\mcl\MYDOCU~1\MATLAB\TESTCS~1
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = ode4.c
NUMST                = 2
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = modell_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\modell_grt_rtw
