...
#
# File    : modell.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           := modell
MODULES         := modell_data.c rtGetInf.c rtGetNaN.c rt_atan2_snf.c rt_hypot_snf.c rt_logging.c rt_nonfinite.c rt_rand.c rt_rem_snf.c rt_round_snf.c rt_zcfcn.c 
MAKEFILE        := modell.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\DOCUME~1\mcl\MYDOCU~1\LabView\CSENTE~1\modell_nidll_vxworks_rtw
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\DOCUME~1\mcl\MYDOCU~1\LabView\CSENTE~1
