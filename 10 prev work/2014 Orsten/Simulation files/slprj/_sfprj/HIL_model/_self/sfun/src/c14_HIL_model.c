...
static void initialize_c14_HIL_model(SFc14_HIL_modelInstanceStruct
  *chartInstance);
static void initialize_params_c14_HIL_model(SFc14_HIL_modelInstanceStruct
  *chartInstance);
static void enable_c14_HIL_model(SFc14_HIL_modelInstanceStruct *chartInstance);
static void disable_c14_HIL_model(SFc14_HIL_modelInstanceStruct *chartInstance);
static void c14_update_debugger_state_c14_HIL_model
  (SFc14_HIL_modelInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_HIL_model(SFc14_HIL_modelInstanceStruct *
  chartInstance);
static void set_sim_state_c14_HIL_model(SFc14_HIL_modelInstanceStruct
  *chartInstance, const mxArray *c14_st);
static void finalize_c14_HIL_model(SFc14_HIL_modelInstanceStruct *chartInstance);
static void sf_c14_HIL_model(SFc14_HIL_modelInstanceStruct *chartInstance);
static void initSimStructsc14_HIL_model(SFc14_HIL_modelInstanceStruct
  *chartInstance);
static void registerMessagesc14_HIL_model(SFc14_HIL_modelInstanceStruct
  *chartInstance);
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static void c14_emlrt_marshallIn(SFc14_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c14_Rst, const char_T *c14_identifier, real_T c14_y[9]);
static void c14_b_emlrt_marshallIn(SFc14_HIL_modelInstanceStruct *chartInstance,
...
static const mxArray *c14_c_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static real_T c14_c_emlrt_marshallIn(SFc14_HIL_modelInstanceStruct
...
static void c14_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData);
static void c14_d_emlrt_marshallIn(SFc14_HIL_modelInstanceStruct *chartInstance,
...
static const mxArray *c14_d_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static int32_T c14_e_emlrt_marshallIn(SFc14_HIL_modelInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void c14_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData);
static uint8_T c14_f_emlrt_marshallIn(SFc14_HIL_modelInstanceStruct
  *chartInstance, const mxArray *c14_b_is_active_c14_HIL_model, const char_T
  *c14_identifier);
static uint8_T c14_g_emlrt_marshallIn(SFc14_HIL_modelInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void init_dsm_address_info(SFc14_HIL_modelInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_HIL_model = 0U;
}
  ...
  chartInstance)
{
  ...
  c14_hoistedGlobal = chartInstance->c14_is_active_c14_HIL_model;
  ...
  *chartInstance, const mxArray *c14_st)
{
  ...
  chartInstance->c14_is_active_c14_HIL_model = c14_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c14_u, 2)),
     "is_active_c14_HIL_model");
  sf_mex_destroy(&c14_u);
  c14_update_debugger_state_c14_HIL_model(chartInstance);
  ...
  *c14_inData)
{
  ...
  const mxArray *c14_y = NULL;
  SFc14_HIL_modelInstanceStruct *chartInstance;
  chartInstance = (SFc14_HIL_modelInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c14_HIL_model_get_eml_resolved_functions_info(void)
{
  ...
  *c14_identifier)
{
  ...
  c14_y = c14_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_HIL_model), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_HIL_model);
  return c14_y;
}
...
void sf_c14_HIL_model_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c14_HIL_model_get_autoinheritance_info(void)
{
...
mxArray *sf_c14_HIL_model_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c14_HIL_model(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Rs\",},{M[1],M[6],T\"Rst\",},{M[8],M[0],T\"is_active_c14_HIL_model\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_HIL_model_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc14_HIL_modelInstanceStruct *chartInstance;
    chartInstance = (SFc14_HIL_modelInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c14_HIL_model(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc14_HIL_modelInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c14_HIL_model((SFc14_HIL_modelInstanceStruct*)
    chartInstanceVar);
  initialize_c14_HIL_model((SFc14_HIL_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c14_HIL_model(void *chartInstanceVar)
{
  enable_c14_HIL_model((SFc14_HIL_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c14_HIL_model(void *chartInstanceVar)
{
  disable_c14_HIL_model((SFc14_HIL_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c14_HIL_model(void *chartInstanceVar)
{
  sf_c14_HIL_model((SFc14_HIL_modelInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c14_HIL_model(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c14_HIL_model
    ((SFc14_HIL_modelInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c14_HIL_model();/* state var info */
...
extern void sf_internal_set_sim_state_c14_HIL_model(SimStruct* S, const mxArray *
  st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c14_HIL_model((SFc14_HIL_modelInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c14_HIL_model(SimStruct* S)
{
  return sf_internal_get_sim_state_c14_HIL_model(S);
}

static void sf_opaque_set_sim_state_c14_HIL_model(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c14_HIL_model(S, st);
}

static void sf_opaque_terminate_c14_HIL_model(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_HIL_modelInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_HIL_model_optimization_info();
    }

    finalize_c14_HIL_model((SFc14_HIL_modelInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc14_HIL_model((SFc14_HIL_modelInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_HIL_model(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c14_HIL_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c14_HIL_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c14_HIL_model(SimStruct *S)
{
  SFc14_HIL_modelInstanceStruct *chartInstance;
  chartInstance = (SFc14_HIL_modelInstanceStruct *)utMalloc(sizeof
    (SFc14_HIL_modelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_HIL_modelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c14_HIL_model;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c14_HIL_model;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c14_HIL_model;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c14_HIL_model;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c14_HIL_model;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c14_HIL_model;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c14_HIL_model;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c14_HIL_model;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_HIL_model;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_HIL_model;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c14_HIL_model;
...
void c14_HIL_model_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_HIL_model(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_HIL_model(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_HIL_model(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_HIL_model_method_dispatcher.\n"
