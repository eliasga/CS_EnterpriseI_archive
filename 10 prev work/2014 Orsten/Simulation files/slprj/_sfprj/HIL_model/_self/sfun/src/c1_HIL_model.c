...
static void initialize_c1_HIL_model(SFc1_HIL_modelInstanceStruct *chartInstance);
static void initialize_params_c1_HIL_model(SFc1_HIL_modelInstanceStruct
  *chartInstance);
static void enable_c1_HIL_model(SFc1_HIL_modelInstanceStruct *chartInstance);
static void disable_c1_HIL_model(SFc1_HIL_modelInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_HIL_model(SFc1_HIL_modelInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_HIL_model(SFc1_HIL_modelInstanceStruct
  *chartInstance);
static void set_sim_state_c1_HIL_model(SFc1_HIL_modelInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_HIL_model(SFc1_HIL_modelInstanceStruct *chartInstance);
static void sf_c1_HIL_model(SFc1_HIL_modelInstanceStruct *chartInstance);
static void initSimStructsc1_HIL_model(SFc1_HIL_modelInstanceStruct
  *chartInstance);
static void registerMessagesc1_HIL_model(SFc1_HIL_modelInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c1_eta_i, const char_T *c1_identifier, real_T c1_y[2]);
static void c1_b_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[2]);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c1_eta_s, const char_T *c1_identifier, real_T c1_y[3]);
static void c1_d_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[3]);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_e_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c1_error, const char_T *c1_identifier);
static real_T c1_f_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[27]);
static real_T c1_rand(SFc1_HIL_modelInstanceStruct *chartInstance);
static void c1_eml_rand_mt19937ar(SFc1_HIL_modelInstanceStruct *chartInstance,
  uint32_T c1_d_state[625]);
static void c1_twister_state_vector(SFc1_HIL_modelInstanceStruct *chartInstance,
  uint32_T c1_mt[625], real_T c1_seed, uint32_T c1_b_mt[625]);
static void c1_b_eml_rand_mt19937ar(SFc1_HIL_modelInstanceStruct *chartInstance,
  uint32_T c1_d_state[625], uint32_T c1_e_state[625], real_T *c1_r);
static void c1_eml_error(SFc1_HIL_modelInstanceStruct *chartInstance);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_g_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint32_T c1_h_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct
  *chartInstance, const mxArray *c1_b_method, const char_T *c1_identifier);
static uint32_T c1_i_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static uint32_T c1_j_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct
  *chartInstance, const mxArray *c1_d_state, const char_T *c1_identifier);
static uint32_T c1_k_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_l_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c1_d_state, const char_T *c1_identifier, uint32_T c1_y[625]);
static void c1_m_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, uint32_T c1_y[625]);
static void c1_n_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c1_d_state, const char_T *c1_identifier, uint32_T c1_y[2]);
static void c1_o_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, uint32_T c1_y[2]);
static uint8_T c1_p_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_HIL_model, const char_T *c1_identifier);
static uint8_T c1_q_emlrt_marshallIn(SFc1_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_twister_state_vector(SFc1_HIL_modelInstanceStruct
  *chartInstance, uint32_T c1_mt[625], real_T c1_seed);
static real_T c1_c_eml_rand_mt19937ar(SFc1_HIL_modelInstanceStruct
  *chartInstance, uint32_T c1_d_state[625]);
static void init_dsm_address_info(SFc1_HIL_modelInstanceStruct *chartInstance);
...
static void initialize_c1_HIL_model(SFc1_HIL_modelInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_HIL_model = 0U;
}
  ...
  *chartInstance)
{
  ...
  c1_d_hoistedGlobal = chartInstance->c1_is_active_c1_HIL_model;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_error = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c1_is_active_c1_HIL_model = c1_p_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 7)), "is_active_c1_HIL_model");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_HIL_model(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u[2];
  const mxArray *c1_y = NULL;
  SFc1_HIL_modelInstanceStruct *chartInstance;
  chartInstance = (SFc1_HIL_modelInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_HIL_model_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c1_b_is_active_c1_HIL_model, const char_T *c1_identifier)
{
  ...
  c1_y = c1_q_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_HIL_model), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_HIL_model);
  return c1_y;
}
...
void sf_c1_HIL_model_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_HIL_model_get_autoinheritance_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_HIL_modelInstanceStruct *chartInstance;
    chartInstance = (SFc1_HIL_modelInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_HIL_model(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_HIL_modelInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c1_HIL_model((SFc1_HIL_modelInstanceStruct*)
    chartInstanceVar);
  initialize_c1_HIL_model((SFc1_HIL_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_HIL_model(void *chartInstanceVar)
{
  enable_c1_HIL_model((SFc1_HIL_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_HIL_model(void *chartInstanceVar)
{
  disable_c1_HIL_model((SFc1_HIL_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_HIL_model(void *chartInstanceVar)
{
  sf_c1_HIL_model((SFc1_HIL_modelInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_HIL_model(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_HIL_model((SFc1_HIL_modelInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_HIL_model();/* state var info */
...
extern void sf_internal_set_sim_state_c1_HIL_model(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_HIL_model((SFc1_HIL_modelInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_HIL_model(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_HIL_model(S);
}

static void sf_opaque_set_sim_state_c1_HIL_model(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_HIL_model(S, st);
}

static void sf_opaque_terminate_c1_HIL_model(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_HIL_modelInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_HIL_model_optimization_info();
    }

    finalize_c1_HIL_model((SFc1_HIL_modelInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_HIL_model((SFc1_HIL_modelInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_HIL_model(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_HIL_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_HIL_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_HIL_model(SimStruct *S)
{
  SFc1_HIL_modelInstanceStruct *chartInstance;
  chartInstance = (SFc1_HIL_modelInstanceStruct *)utMalloc(sizeof
    (SFc1_HIL_modelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_HIL_modelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_HIL_model;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_HIL_model;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_HIL_model;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_HIL_model;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_HIL_model;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_HIL_model;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_HIL_model;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_HIL_model;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_HIL_model;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_HIL_model;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_HIL_model;
...
void c1_HIL_model_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_HIL_model(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_HIL_model(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_HIL_model(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_HIL_model_method_dispatcher.\n"
