...
static void initialize_c6_HIL_model(SFc6_HIL_modelInstanceStruct *chartInstance);
static void initialize_params_c6_HIL_model(SFc6_HIL_modelInstanceStruct
  *chartInstance);
static void enable_c6_HIL_model(SFc6_HIL_modelInstanceStruct *chartInstance);
static void disable_c6_HIL_model(SFc6_HIL_modelInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_HIL_model(SFc6_HIL_modelInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c6_HIL_model(SFc6_HIL_modelInstanceStruct
  *chartInstance);
static void set_sim_state_c6_HIL_model(SFc6_HIL_modelInstanceStruct
  *chartInstance, const mxArray *c6_st);
static void finalize_c6_HIL_model(SFc6_HIL_modelInstanceStruct *chartInstance);
static void sf_c6_HIL_model(SFc6_HIL_modelInstanceStruct *chartInstance);
static void c6_chartstep_c6_HIL_model(SFc6_HIL_modelInstanceStruct
  *chartInstance);
static void initSimStructsc6_HIL_model(SFc6_HIL_modelInstanceStruct
  *chartInstance);
static void registerMessagesc6_HIL_model(SFc6_HIL_modelInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c6_alphaIce_save, const char_T *c6_identifier);
static real_T c6_b_emlrt_marshallIn(SFc6_HIL_modelInstanceStruct *chartInstance,
...
static real_T c6_mpower(SFc6_HIL_modelInstanceStruct *chartInstance, real_T c6_a);
static void c6_eml_scalar_eg(SFc6_HIL_modelInstanceStruct *chartInstance);
static real_T c6_abs(SFc6_HIL_modelInstanceStruct *chartInstance, real_T c6_x);
static void c6_eml_error(SFc6_HIL_modelInstanceStruct *chartInstance);
static real_T c6_atan2(SFc6_HIL_modelInstanceStruct *chartInstance, real_T c6_y,
  real_T c6_x);
static const mxArray *c6_e_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_c_emlrt_marshallIn(SFc6_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_d_emlrt_marshallIn(SFc6_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_HIL_model, const char_T *c6_identifier);
static uint8_T c6_e_emlrt_marshallIn(SFc6_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_HIL_modelInstanceStruct *chartInstance);
...
static void initialize_c6_HIL_model(SFc6_HIL_modelInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_HIL_model = 0U;
}
  ...
  *chartInstance)
{
  ...
  c6_h_hoistedGlobal = chartInstance->c6_is_active_c6_HIL_model;
  ...
  *chartInstance, const mxArray *c6_st)
{
  ...
  *c6_y_mark = c6_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u,
    6)), "y_mark");
  chartInstance->c6_is_active_c6_HIL_model = c6_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 7)), "is_active_c6_HIL_model");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_HIL_model(chartInstance);
...
static void sf_c6_HIL_model(SFc6_HIL_modelInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_sfEvent = CALL_EVENT;
  c6_chartstep_c6_HIL_model(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  real_T c6_u;
  const mxArray *c6_y = NULL;
  SFc6_HIL_modelInstanceStruct *chartInstance;
  chartInstance = (SFc6_HIL_modelInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_HIL_model_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c6_b_is_active_c6_HIL_model, const char_T *c6_identifier)
{
  ...
  c6_y = c6_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_HIL_model), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_HIL_model);
  return c6_y;
}
...
void sf_c6_HIL_model_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_HIL_model_get_autoinheritance_info(void)
{
...
mxArray *sf_c6_HIL_model_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c6_HIL_model(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[12],T\"WPi_out\",},{M[1],M[22],T\"WPnormal\",},{M[1],M[30],T\"alphaIce_save\",},{M[1],M[23],T\"delta\",},{M[1],M[16],T\"deltaXlos\",},{M[1],M[21],T\"deltaYlos\",},{M[1],M[24],T\"y_mark\",},{M[8],M[0],T\"is_active_c6_HIL_model\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_HIL_model_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc6_HIL_modelInstanceStruct *chartInstance;
    chartInstance = (SFc6_HIL_modelInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c6_HIL_model(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_HIL_modelInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c6_HIL_model((SFc6_HIL_modelInstanceStruct*)
    chartInstanceVar);
  initialize_c6_HIL_model((SFc6_HIL_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_HIL_model(void *chartInstanceVar)
{
  enable_c6_HIL_model((SFc6_HIL_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_HIL_model(void *chartInstanceVar)
{
  disable_c6_HIL_model((SFc6_HIL_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_HIL_model(void *chartInstanceVar)
{
  sf_c6_HIL_model((SFc6_HIL_modelInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_HIL_model(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_HIL_model((SFc6_HIL_modelInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_HIL_model();/* state var info */
...
extern void sf_internal_set_sim_state_c6_HIL_model(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c6_HIL_model((SFc6_HIL_modelInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_HIL_model(SimStruct* S)
{
  return sf_internal_get_sim_state_c6_HIL_model(S);
}

static void sf_opaque_set_sim_state_c6_HIL_model(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c6_HIL_model(S, st);
}

static void sf_opaque_terminate_c6_HIL_model(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_HIL_modelInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_HIL_model_optimization_info();
    }

    finalize_c6_HIL_model((SFc6_HIL_modelInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_HIL_model((SFc6_HIL_modelInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_HIL_model(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_HIL_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_HIL_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_HIL_model(SimStruct *S)
{
  SFc6_HIL_modelInstanceStruct *chartInstance;
  chartInstance = (SFc6_HIL_modelInstanceStruct *)utMalloc(sizeof
    (SFc6_HIL_modelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_HIL_modelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_HIL_model;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c6_HIL_model;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_HIL_model;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_HIL_model;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_HIL_model;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_HIL_model;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_HIL_model;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c6_HIL_model;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_HIL_model;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_HIL_model;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_HIL_model;
...
void c6_HIL_model_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_HIL_model(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_HIL_model(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_HIL_model(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_HIL_model_method_dispatcher.\n"
