...
static void initialize_c8_HIL_model(SFc8_HIL_modelInstanceStruct *chartInstance);
static void initialize_params_c8_HIL_model(SFc8_HIL_modelInstanceStruct
  *chartInstance);
static void enable_c8_HIL_model(SFc8_HIL_modelInstanceStruct *chartInstance);
static void disable_c8_HIL_model(SFc8_HIL_modelInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_HIL_model(SFc8_HIL_modelInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c8_HIL_model(SFc8_HIL_modelInstanceStruct
  *chartInstance);
static void set_sim_state_c8_HIL_model(SFc8_HIL_modelInstanceStruct
  *chartInstance, const mxArray *c8_st);
static void finalize_c8_HIL_model(SFc8_HIL_modelInstanceStruct *chartInstance);
static void sf_c8_HIL_model(SFc8_HIL_modelInstanceStruct *chartInstance);
static void c8_chartstep_c8_HIL_model(SFc8_HIL_modelInstanceStruct
  *chartInstance);
static void initSimStructsc8_HIL_model(SFc8_HIL_modelInstanceStruct
  *chartInstance);
static void registerMessagesc8_HIL_model(SFc8_HIL_modelInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c8_e, const char_T *c8_identifier, real_T c8_y[3]);
static void c8_b_emlrt_marshallIn(SFc8_HIL_modelInstanceStruct *chartInstance,
...
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static void c8_d_emlrt_marshallIn(SFc8_HIL_modelInstanceStruct *chartInstance,
...
static void c8_eml_scalar_eg(SFc8_HIL_modelInstanceStruct *chartInstance);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_e_emlrt_marshallIn(SFc8_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_f_emlrt_marshallIn(SFc8_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c8_b_is_active_c8_HIL_model, const char_T *c8_identifier);
static uint8_T c8_g_emlrt_marshallIn(SFc8_HIL_modelInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_HIL_modelInstanceStruct *chartInstance);
...
static void initialize_c8_HIL_model(SFc8_HIL_modelInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_HIL_model = 0U;
}
  ...
  *chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_HIL_model;
  ...
  *chartInstance, const mxArray *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_HIL_model = c8_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c8_u, 6)), "is_active_c8_HIL_model");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_HIL_model(chartInstance);
...
static void sf_c8_HIL_model(SFc8_HIL_modelInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  c8_chartstep_c8_HIL_model(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_psi_s, 0U, c8_c_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c8_nu_ship, 1U, c8_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_cs, 2U, c8_c_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_ss, 3U, c8_c_sf_marshallOut,
    c8_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML(c8_b_s, 14U, c8_sf_marshallOut);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  real_T c8_u[3];
  const mxArray *c8_y = NULL;
  SFc8_HIL_modelInstanceStruct *chartInstance;
  chartInstance = (SFc8_HIL_modelInstanceStruct *)chartInstanceVoid;
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  c8_i105 = 0;
  for (c8_i106 = 0; c8_i106 < 3; c8_i106++) {
    for (c8_i107 = 0; c8_i107 < 3; c8_i107++) {
      (*(real_T (*)[9])c8_outData)[c8_i107 + c8_i105] = c8_y[c8_i107 + c8_i105];
    }
...
const mxArray *sf_c8_HIL_model_get_eml_resolved_functions_info(void)
{
  ...
  for (c8_i108 = 0; c8_i108 < 14; c8_i108++) {
    c8_r0 = &c8_info[c8_i108];
    ...
    sf_mex_addfield(c8_m0, sf_mex_create("nameCaptureInfo", c8_r0->name, 15, 0U,
      0U, 0U, 2, 1, strlen(c8_r0->name)), "name", "nameCaptureInfo", c8_i108);
  ...
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId)
{
  int32_T c8_y;
  int32_T c8_i109;
  sf_mex_import(c8_parentId, sf_mex_dup(c8_u), &c8_i109, 1, 6, 0U, 0, 0U, 0);
  c8_y = c8_i109;
  sf_mex_destroy(&c8_u);
  return c8_y;
}
  ...
  const mxArray *c8_b_is_active_c8_HIL_model, const char_T *c8_identifier)
{
  ...
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_HIL_model), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_HIL_model);
  return c8_y;
}
...
void sf_c8_HIL_model_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(792598804U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2675998567U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2043288225U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1341861924U);
}

mxArray *sf_c8_HIL_model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("qNiRYuDEYVYKaSj5LEmwtC");
...
mxArray *sf_c8_HIL_model_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c8_HIL_model(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[18],T\"a\",},{M[1],M[19],T\"b\",},{M[1],M[20],T\"c\",},{M[1],M[21],T\"d\",},{M[1],M[22],T\"e\",},{M[1],M[5],T\"tau\",},{M[8],M[0],T\"is_active_c8_HIL_model\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_HIL_model_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_HIL_modelInstanceStruct *chartInstance;
    chartInstance = (SFc8_HIL_modelInstanceStruct *) ((ChartInfoStruct *)
...
{
  return "maaAR6gSKSqM87jJ4EXSBC";
}

static void sf_opaque_initialize_c8_HIL_model(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_HIL_modelInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c8_HIL_model((SFc8_HIL_modelInstanceStruct*)
    chartInstanceVar);
  initialize_c8_HIL_model((SFc8_HIL_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_HIL_model(void *chartInstanceVar)
{
  enable_c8_HIL_model((SFc8_HIL_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_HIL_model(void *chartInstanceVar)
{
  disable_c8_HIL_model((SFc8_HIL_modelInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_HIL_model(void *chartInstanceVar)
{
  sf_c8_HIL_model((SFc8_HIL_modelInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_HIL_model(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_HIL_model((SFc8_HIL_modelInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_HIL_model();/* state var info */
...
extern void sf_internal_set_sim_state_c8_HIL_model(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_HIL_model((SFc8_HIL_modelInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_HIL_model(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_HIL_model(S);
}

static void sf_opaque_set_sim_state_c8_HIL_model(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c8_HIL_model(S, st);
}

static void sf_opaque_terminate_c8_HIL_model(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_HIL_modelInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_HIL_model_optimization_info();
    }

    finalize_c8_HIL_model((SFc8_HIL_modelInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_HIL_model((SFc8_HIL_modelInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_HIL_model(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_HIL_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(876124668U));
  ssSetChecksum1(S,(3307417156U));
  ssSetChecksum2(S,(2338772786U));
  ssSetChecksum3(S,(1331979688U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c8_HIL_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_HIL_model(SimStruct *S)
{
  SFc8_HIL_modelInstanceStruct *chartInstance;
  chartInstance = (SFc8_HIL_modelInstanceStruct *)utMalloc(sizeof
    (SFc8_HIL_modelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_HIL_modelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c8_HIL_model;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c8_HIL_model;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c8_HIL_model;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_HIL_model;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_HIL_model;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c8_HIL_model;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c8_HIL_model;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c8_HIL_model;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_HIL_model;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_HIL_model;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_HIL_model;
...
void c8_HIL_model_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_HIL_model(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_HIL_model(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_HIL_model(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_HIL_model_method_dispatcher.\n"
