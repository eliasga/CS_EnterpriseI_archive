...
static void initialize_c16_HIL_model_error(SFc16_HIL_model_errorInstanceStruct
  *chartInstance);
static void initialize_params_c16_HIL_model_error
  (SFc16_HIL_model_errorInstanceStruct *chartInstance);
static void enable_c16_HIL_model_error(SFc16_HIL_model_errorInstanceStruct
  *chartInstance);
static void disable_c16_HIL_model_error(SFc16_HIL_model_errorInstanceStruct
  *chartInstance);
static void c16_update_debugger_state_c16_HIL_model_error
  (SFc16_HIL_model_errorInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c16_HIL_model_error
  (SFc16_HIL_model_errorInstanceStruct *chartInstance);
static void set_sim_state_c16_HIL_model_error
  (SFc16_HIL_model_errorInstanceStruct *chartInstance, const mxArray *c16_st);
static void finalize_c16_HIL_model_error(SFc16_HIL_model_errorInstanceStruct
  *chartInstance);
static void sf_c16_HIL_model_error(SFc16_HIL_model_errorInstanceStruct
  *chartInstance);
static void initSimStructsc16_HIL_model_error
  (SFc16_HIL_model_errorInstanceStruct *chartInstance);
static void registerMessagesc16_HIL_model_error
  (SFc16_HIL_model_errorInstanceStruct *chartInstance);
...
static const mxArray *c16_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static void c16_emlrt_marshallIn(SFc16_HIL_model_errorInstanceStruct
  *chartInstance, const mxArray *c16_eta_ref, const char_T *c16_identifier,
  real_T c16_y[3]);
static void c16_b_emlrt_marshallIn(SFc16_HIL_model_errorInstanceStruct
...
static const mxArray *c16_c_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static real_T c16_c_emlrt_marshallIn(SFc16_HIL_model_errorInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
...
static const mxArray *c16_d_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static int32_T c16_d_emlrt_marshallIn(SFc16_HIL_model_errorInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void c16_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData);
static uint8_T c16_e_emlrt_marshallIn(SFc16_HIL_model_errorInstanceStruct
  *chartInstance, const mxArray *c16_b_is_active_c16_HIL_model_error, const
  char_T *c16_identifier);
static uint8_T c16_f_emlrt_marshallIn(SFc16_HIL_model_errorInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void init_dsm_address_info(SFc16_HIL_model_errorInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_HIL_model_error = 0U;
}
  ...
  (SFc16_HIL_model_errorInstanceStruct *chartInstance)
{
  ...
  c16_hoistedGlobal = chartInstance->c16_is_active_c16_HIL_model_error;
  ...
  (SFc16_HIL_model_errorInstanceStruct *chartInstance, const mxArray *c16_st)
{
  ...
  chartInstance->c16_is_active_c16_HIL_model_error = c16_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 1)),
     "is_active_c16_HIL_model_error");
  sf_mex_destroy(&c16_u);
  c16_update_debugger_state_c16_HIL_model_error(chartInstance);
  ...
  *c16_inData)
{
  ...
  const mxArray *c16_y = NULL;
  SFc16_HIL_model_errorInstanceStruct *chartInstance;
  chartInstance = (SFc16_HIL_model_errorInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c16_HIL_model_error_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c16_identifier)
{
  ...
  c16_y = c16_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_HIL_model_error), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_HIL_model_error);
  return c16_y;
}
...
void sf_c16_HIL_model_error_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c16_HIL_model_error_get_autoinheritance_info(void)
{
...
mxArray *sf_c16_HIL_model_error_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c16_HIL_model_error(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"eta_ref\",},{M[8],M[0],T\"is_active_c16_HIL_model_error\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_HIL_model_error_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc16_HIL_model_errorInstanceStruct *chartInstance;
    chartInstance = (SFc16_HIL_model_errorInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c16_HIL_model_error(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc16_HIL_model_errorInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c16_HIL_model_error((SFc16_HIL_model_errorInstanceStruct*)
    chartInstanceVar);
  initialize_c16_HIL_model_error((SFc16_HIL_model_errorInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c16_HIL_model_error(void *chartInstanceVar)
{
  enable_c16_HIL_model_error((SFc16_HIL_model_errorInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c16_HIL_model_error(void *chartInstanceVar)
{
  disable_c16_HIL_model_error((SFc16_HIL_model_errorInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c16_HIL_model_error(void *chartInstanceVar)
{
  sf_c16_HIL_model_error((SFc16_HIL_model_errorInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c16_HIL_model_error(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c16_HIL_model_error
    ((SFc16_HIL_model_errorInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c16_HIL_model_error();/* state var info */
...
extern void sf_internal_set_sim_state_c16_HIL_model_error(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c16_HIL_model_error((SFc16_HIL_model_errorInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c16_HIL_model_error(SimStruct* S)
{
  return sf_internal_get_sim_state_c16_HIL_model_error(S);
}

static void sf_opaque_set_sim_state_c16_HIL_model_error(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c16_HIL_model_error(S, st);
}

static void sf_opaque_terminate_c16_HIL_model_error(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_HIL_model_errorInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_HIL_model_error_optimization_info();
    }

    finalize_c16_HIL_model_error((SFc16_HIL_model_errorInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc16_HIL_model_error((SFc16_HIL_model_errorInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_HIL_model_error(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c16_HIL_model_error(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c16_HIL_model_error(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c16_HIL_model_error(SimStruct *S)
{
  SFc16_HIL_model_errorInstanceStruct *chartInstance;
  chartInstance = (SFc16_HIL_model_errorInstanceStruct *)utMalloc(sizeof
    (SFc16_HIL_model_errorInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc16_HIL_model_errorInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_HIL_model_error;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_HIL_model_error;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_HIL_model_error;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c16_HIL_model_error;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c16_HIL_model_error;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_HIL_model_error;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_HIL_model_error;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_HIL_model_error;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_HIL_model_error;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_HIL_model_error;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_HIL_model_error;
...
void c16_HIL_model_error_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_HIL_model_error(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_HIL_model_error(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_HIL_model_error(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_HIL_model_error_method_dispatcher.\n"
