...
static const char * c10_debug_family_names[7] = { "psi", "c", "s", "nargin",
  "nargout", "eta", "R" };

/* Function Declarations */
static void initialize_c10_HIL_model_experiments2
  (SFc10_HIL_model_experiments2InstanceStruct *chartInstance);
static void initialize_params_c10_HIL_model_experiments2
  (SFc10_HIL_model_experiments2InstanceStruct *chartInstance);
static void enable_c10_HIL_model_experiments2
  (SFc10_HIL_model_experiments2InstanceStruct *chartInstance);
static void disable_c10_HIL_model_experiments2
  (SFc10_HIL_model_experiments2InstanceStruct *chartInstance);
static void c10_update_debugger_state_c10_HIL_model_experiments2
  (SFc10_HIL_model_experiments2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_HIL_model_experiments2
  (SFc10_HIL_model_experiments2InstanceStruct *chartInstance);
static void set_sim_state_c10_HIL_model_experiments2
  (SFc10_HIL_model_experiments2InstanceStruct *chartInstance, const mxArray
   *c10_st);
static void finalize_c10_HIL_model_experiments2
  (SFc10_HIL_model_experiments2InstanceStruct *chartInstance);
static void sf_c10_HIL_model_experiments2
  (SFc10_HIL_model_experiments2InstanceStruct *chartInstance);
static void initSimStructsc10_HIL_model_experiments2
  (SFc10_HIL_model_experiments2InstanceStruct *chartInstance);
static void registerMessagesc10_HIL_model_experiments2
  (SFc10_HIL_model_experiments2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_emlrt_marshallIn(SFc10_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c10_R, const char_T *c10_identifier, real_T
  c10_y[9]);
static void c10_b_emlrt_marshallIn(SFc10_HIL_model_experiments2InstanceStruct
...
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_c_emlrt_marshallIn(SFc10_HIL_model_experiments2InstanceStruct *
  chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_d_emlrt_marshallIn(SFc10_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint8_T c10_e_emlrt_marshallIn(SFc10_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c10_b_is_active_c10_HIL_model_experiments2,
  const char_T *c10_identifier);
static uint8_T c10_f_emlrt_marshallIn(SFc10_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_HIL_model_experiments2InstanceStruct
  *chartInstance);
  ...
  (SFc10_HIL_model_experiments2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_HIL_model_experiments2 = 0U;
}
  ...
  (SFc10_HIL_model_experiments2InstanceStruct *chartInstance)
{
  ...
  c10_hoistedGlobal = chartInstance->c10_is_active_c10_HIL_model_experiments2;
   ...
   *c10_st)
{
  ...
  chartInstance->c10_is_active_c10_HIL_model_experiments2 =
    c10_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 1)),
    "is_active_c10_HIL_model_experiments2");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_HIL_model_experiments2(chartInstance);
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_y = NULL;
  SFc10_HIL_model_experiments2InstanceStruct *chartInstance;
  chartInstance = (SFc10_HIL_model_experiments2InstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c10_HIL_model_experiments2_get_eml_resolved_functions_info
  (void)
{
  ...
  (*c10_b_info)[3].fileTimeLo = 1343830386U;
  ...
  (*c10_b_info)[4].fileTimeLo = 1286818736U;
  ...
  for (c10_i20 = 0; c10_i20 < 5; c10_i20++) {
    c10_r0 = &c10_info[c10_i20];
  ...
  const char_T *c10_identifier)
{
  ...
  c10_y = c10_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_HIL_model_experiments2), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_HIL_model_experiments2);
  return c10_y;
}
...
void sf_c10_HIL_model_experiments2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3397257971U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(979106324U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2646524428U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3680317575U);
}

mxArray *sf_c10_HIL_model_experiments2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("pEoBLkO5VnHf2a36B3DZQF");
...
mxArray *sf_c10_HIL_model_experiments2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c10_HIL_model_experiments2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"R\",},{M[8],M[0],T\"is_active_c10_HIL_model_experiments2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_HIL_model_experiments2_get_check_sum(&mxChecksum);
...
{
  return "WZR3HGy77jnGmWyD2kcflF";
}

static void sf_opaque_initialize_c10_HIL_model_experiments2(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_HIL_model_experiments2
    ((SFc10_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
  initialize_c10_HIL_model_experiments2
    ((SFc10_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_HIL_model_experiments2(void *chartInstanceVar)
{
  enable_c10_HIL_model_experiments2((SFc10_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c10_HIL_model_experiments2(void *chartInstanceVar)
{
  disable_c10_HIL_model_experiments2((SFc10_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c10_HIL_model_experiments2(void *chartInstanceVar)
{
  sf_c10_HIL_model_experiments2((SFc10_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_HIL_model_experiments2
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_HIL_model_experiments2
    ((SFc10_HIL_model_experiments2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_HIL_model_experiments2();/* state var info */
...
extern void sf_internal_set_sim_state_c10_HIL_model_experiments2(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c10_HIL_model_experiments2
    ((SFc10_HIL_model_experiments2InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_HIL_model_experiments2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c10_HIL_model_experiments2(S);
}

static void sf_opaque_set_sim_state_c10_HIL_model_experiments2(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c10_HIL_model_experiments2(S, st);
}

static void sf_opaque_terminate_c10_HIL_model_experiments2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_HIL_model_experiments2InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c10_HIL_model_experiments2
      ((SFc10_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc10_HIL_model_experiments2
    ((SFc10_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_HIL_model_experiments2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c10_HIL_model_experiments2
      ((SFc10_HIL_model_experiments2InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c10_HIL_model_experiments2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(510330312U));
  ssSetChecksum1(S,(1709567165U));
  ssSetChecksum2(S,(2812296069U));
  ssSetChecksum3(S,(4232906864U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c10_HIL_model_experiments2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_HIL_model_experiments2(SimStruct *S)
{
  SFc10_HIL_model_experiments2InstanceStruct *chartInstance;
  chartInstance = (SFc10_HIL_model_experiments2InstanceStruct *)utMalloc(sizeof
    (SFc10_HIL_model_experiments2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_HIL_model_experiments2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_HIL_model_experiments2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_HIL_model_experiments2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c10_HIL_model_experiments2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c10_HIL_model_experiments2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c10_HIL_model_experiments2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_HIL_model_experiments2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_HIL_model_experiments2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_HIL_model_experiments2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_HIL_model_experiments2;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_HIL_model_experiments2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c10_HIL_model_experiments2;
...
void c10_HIL_model_experiments2_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_HIL_model_experiments2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_HIL_model_experiments2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_HIL_model_experiments2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_HIL_model_experiments2_method_dispatcher.\n"
