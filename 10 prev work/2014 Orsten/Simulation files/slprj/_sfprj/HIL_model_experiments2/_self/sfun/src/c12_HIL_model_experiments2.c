...
static void initialize_c12_HIL_model_experiments2
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance);
static void initialize_params_c12_HIL_model_experiments2
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance);
static void enable_c12_HIL_model_experiments2
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance);
static void disable_c12_HIL_model_experiments2
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_HIL_model_experiments2
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_HIL_model_experiments2
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance);
static void set_sim_state_c12_HIL_model_experiments2
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance, const mxArray
   *c12_st);
static void finalize_c12_HIL_model_experiments2
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance);
static void sf_c12_HIL_model_experiments2
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance);
static void initSimStructsc12_HIL_model_experiments2
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance);
static void registerMessagesc12_HIL_model_experiments2
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_emlrt_marshallIn(SFc12_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c12_y, const char_T *c12_identifier, real_T
  c12_b_y[3]);
static void c12_b_emlrt_marshallIn(SFc12_HIL_model_experiments2InstanceStruct
...
static const mxArray *c12_c_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_c_emlrt_marshallIn(SFc12_HIL_model_experiments2InstanceStruct *
  chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_d_emlrt_marshallIn(SFc12_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_e_emlrt_marshallIn(SFc12_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c12_b_is_active_c12_HIL_model_experiments2,
  const char_T *c12_identifier);
static uint8_T c12_f_emlrt_marshallIn(SFc12_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_HIL_model_experiments2InstanceStruct
  *chartInstance);
  ...
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_HIL_model_experiments2 = 0U;
}
  ...
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance)
{
  ...
  c12_hoistedGlobal = chartInstance->c12_is_active_c12_HIL_model_experiments2;
   ...
   *c12_st)
{
  ...
  chartInstance->c12_is_active_c12_HIL_model_experiments2 =
    c12_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 1)),
    "is_active_c12_HIL_model_experiments2");
  sf_mex_destroy(&c12_u);
  c12_update_debugger_state_c12_HIL_model_experiments2(chartInstance);
  ...
  (SFc12_HIL_model_experiments2InstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_nargout, 13U, c12_c_sf_marshallOut,
    c12_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c12_in, 14U, c12_b_sf_marshallOut);
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_HIL_model_experiments2InstanceStruct *chartInstance;
  chartInstance = (SFc12_HIL_model_experiments2InstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c12_HIL_model_experiments2_get_eml_resolved_functions_info
  (void)
{
  ...
  const char_T *c12_identifier)
{
  ...
  c12_y = c12_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_HIL_model_experiments2), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_HIL_model_experiments2);
  return c12_y;
}
...
void sf_c12_HIL_model_experiments2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4156947053U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2784103566U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(482806243U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(213608479U);
}

mxArray *sf_c12_HIL_model_experiments2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("PwUcqA1JNftzQq08W1JOxB");
...
mxArray *sf_c12_HIL_model_experiments2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c12_HIL_model_experiments2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c12_HIL_model_experiments2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_HIL_model_experiments2_get_check_sum(&mxChecksum);
...
{
  return "Ju093lUOjBkayZ14JuEk1C";
}

static void sf_opaque_initialize_c12_HIL_model_experiments2(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_HIL_model_experiments2
    ((SFc12_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
  initialize_c12_HIL_model_experiments2
    ((SFc12_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_HIL_model_experiments2(void *chartInstanceVar)
{
  enable_c12_HIL_model_experiments2((SFc12_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c12_HIL_model_experiments2(void *chartInstanceVar)
{
  disable_c12_HIL_model_experiments2((SFc12_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c12_HIL_model_experiments2(void *chartInstanceVar)
{
  sf_c12_HIL_model_experiments2((SFc12_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c12_HIL_model_experiments2
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_HIL_model_experiments2
    ((SFc12_HIL_model_experiments2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c12_HIL_model_experiments2();/* state var info */
...
extern void sf_internal_set_sim_state_c12_HIL_model_experiments2(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c12_HIL_model_experiments2
    ((SFc12_HIL_model_experiments2InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c12_HIL_model_experiments2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c12_HIL_model_experiments2(S);
}

static void sf_opaque_set_sim_state_c12_HIL_model_experiments2(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c12_HIL_model_experiments2(S, st);
}

static void sf_opaque_terminate_c12_HIL_model_experiments2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_HIL_model_experiments2InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c12_HIL_model_experiments2
      ((SFc12_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_HIL_model_experiments2
    ((SFc12_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_HIL_model_experiments2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c12_HIL_model_experiments2
      ((SFc12_HIL_model_experiments2InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c12_HIL_model_experiments2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3529580151U));
  ssSetChecksum1(S,(800066163U));
  ssSetChecksum2(S,(3349219345U));
  ssSetChecksum3(S,(1771469122U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c12_HIL_model_experiments2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_HIL_model_experiments2(SimStruct *S)
{
  SFc12_HIL_model_experiments2InstanceStruct *chartInstance;
  chartInstance = (SFc12_HIL_model_experiments2InstanceStruct *)utMalloc(sizeof
    (SFc12_HIL_model_experiments2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_HIL_model_experiments2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_HIL_model_experiments2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_HIL_model_experiments2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_HIL_model_experiments2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c12_HIL_model_experiments2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c12_HIL_model_experiments2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_HIL_model_experiments2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_HIL_model_experiments2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_HIL_model_experiments2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_HIL_model_experiments2;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_HIL_model_experiments2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_HIL_model_experiments2;
...
void c12_HIL_model_experiments2_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_HIL_model_experiments2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_HIL_model_experiments2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_HIL_model_experiments2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_HIL_model_experiments2_method_dispatcher.\n"
