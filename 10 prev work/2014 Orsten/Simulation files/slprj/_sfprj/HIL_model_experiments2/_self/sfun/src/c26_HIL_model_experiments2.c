...
static void initialize_c26_HIL_model_experiments2
  (SFc26_HIL_model_experiments2InstanceStruct *chartInstance);
static void initialize_params_c26_HIL_model_experiments2
  (SFc26_HIL_model_experiments2InstanceStruct *chartInstance);
static void enable_c26_HIL_model_experiments2
  (SFc26_HIL_model_experiments2InstanceStruct *chartInstance);
static void disable_c26_HIL_model_experiments2
  (SFc26_HIL_model_experiments2InstanceStruct *chartInstance);
static void c26_update_debugger_state_c26_HIL_model_experiments2
  (SFc26_HIL_model_experiments2InstanceStruct *chartInstance);
...
static void set_sim_state_c26_HIL_model_experiments2
   ...
   *c26_st);
static void finalize_c26_HIL_model_experiments2
  (SFc26_HIL_model_experiments2InstanceStruct *chartInstance);
static void sf_c26_HIL_model_experiments2
  (SFc26_HIL_model_experiments2InstanceStruct *chartInstance);
static void c26_chartstep_c26_HIL_model_experiments2
  (SFc26_HIL_model_experiments2InstanceStruct *chartInstance);
static void initSimStructsc26_HIL_model_experiments2
  (SFc26_HIL_model_experiments2InstanceStruct *chartInstance);
static void registerMessagesc26_HIL_model_experiments2
  (SFc26_HIL_model_experiments2InstanceStruct *chartInstance);
...
static const mxArray *c26_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static void c26_emlrt_marshallIn(SFc26_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c26_eta_dot_ref, const char_T *c26_identifier,
  real_T c26_y[3]);
static void c26_b_emlrt_marshallIn(SFc26_HIL_model_experiments2InstanceStruct
...
static const mxArray *c26_c_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static real_T c26_c_emlrt_marshallIn(SFc26_HIL_model_experiments2InstanceStruct *
  chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
...
static const mxArray *c26_d_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static void c26_d_emlrt_marshallIn(SFc26_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId,
  real_T c26_y[9]);
...
static void c26_eml_scalar_eg(SFc26_HIL_model_experiments2InstanceStruct
  *chartInstance);
static const mxArray *c26_e_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static int32_T c26_e_emlrt_marshallIn(SFc26_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
static void c26_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c26_mxArrayInData, const char_T *c26_varName, void *c26_outData);
static uint8_T c26_f_emlrt_marshallIn(SFc26_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c26_b_is_active_c26_HIL_model_experiments2,
  const char_T *c26_identifier);
static uint8_T c26_g_emlrt_marshallIn(SFc26_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
static void init_dsm_address_info(SFc26_HIL_model_experiments2InstanceStruct
  *chartInstance);
  ...
  (SFc26_HIL_model_experiments2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c26_is_active_c26_HIL_model_experiments2 = 0U;
}
  ...
  *c26_inData)
{
  ...
  for (c26_i26 = 0; c26_i26 < 3; c26_i26++) {
    c26_b_inData[c26_i26] = (*(real_T (*)[3])c26_inData)[c26_i26];
  }

  for (c26_i27 = 0; c26_i27 < 3; c26_i27++) {
    c26_u[c26_i27] = c26_b_inData[c26_i27];
  }
  ...
  *c26_inData)
{
  ...
  for (c26_i29 = 0; c26_i29 < 3; c26_i29++) {
    for (c26_i30 = 0; c26_i30 < 3; c26_i30++) {
      c26_b_inData[c26_i30 + c26_i28] = (*(real_T (*)[9])c26_inData)[c26_i30 +
        c26_i28];
    }
  ...
  for (c26_i32 = 0; c26_i32 < 3; c26_i32++) {
    for (c26_i33 = 0; c26_i33 < 3; c26_i33++) {
      c26_u[c26_i33 + c26_i31] = c26_b_inData[c26_i33 + c26_i31];
    }
  ...
  const char_T *c26_identifier)
{
  ...
  c26_y = c26_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c26_b_is_active_c26_HIL_model_experiments2), &c26_thisId);
  sf_mex_destroy(&c26_b_is_active_c26_HIL_model_experiments2);
  return c26_y;
}
...
void sf_c26_HIL_model_experiments2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2828896671U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(926234913U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3821149481U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3706836516U);
}

mxArray *sf_c26_HIL_model_experiments2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("kUQSkNUbM8KEn3yWViIVYE");
...
mxArray *sf_c26_HIL_model_experiments2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c26_HIL_model_experiments2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"eta_dot_ref\",},{M[8],M[0],T\"is_active_c26_HIL_model_experiments2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c26_HIL_model_experiments2_get_check_sum(&mxChecksum);
...
{
  return "6PvJhstczQ1UGa5LKiOXUG";
}

static void sf_opaque_initialize_c26_HIL_model_experiments2(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc26_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c26_HIL_model_experiments2
    ((SFc26_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
  initialize_c26_HIL_model_experiments2
    ((SFc26_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c26_HIL_model_experiments2(void *chartInstanceVar)
{
  enable_c26_HIL_model_experiments2((SFc26_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c26_HIL_model_experiments2(void *chartInstanceVar)
{
  disable_c26_HIL_model_experiments2((SFc26_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c26_HIL_model_experiments2(void *chartInstanceVar)
{
  sf_c26_HIL_model_experiments2((SFc26_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c26_HIL_model_experiments2
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c26_HIL_model_experiments2
    ((SFc26_HIL_model_experiments2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c26_HIL_model_experiments2();/* state var info */
...
extern void sf_internal_set_sim_state_c26_HIL_model_experiments2(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c26_HIL_model_experiments2
    ((SFc26_HIL_model_experiments2InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c26_HIL_model_experiments2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c26_HIL_model_experiments2(S);
}

static void sf_opaque_set_sim_state_c26_HIL_model_experiments2(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c26_HIL_model_experiments2(S, st);
}

static void sf_opaque_terminate_c26_HIL_model_experiments2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc26_HIL_model_experiments2InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c26_HIL_model_experiments2
      ((SFc26_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc26_HIL_model_experiments2
    ((SFc26_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c26_HIL_model_experiments2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c26_HIL_model_experiments2
      ((SFc26_HIL_model_experiments2InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c26_HIL_model_experiments2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1082410668U));
  ssSetChecksum1(S,(586103602U));
  ssSetChecksum2(S,(1697616150U));
  ssSetChecksum3(S,(2394953298U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c26_HIL_model_experiments2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c26_HIL_model_experiments2(SimStruct *S)
{
  SFc26_HIL_model_experiments2InstanceStruct *chartInstance;
  chartInstance = (SFc26_HIL_model_experiments2InstanceStruct *)utMalloc(sizeof
    (SFc26_HIL_model_experiments2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc26_HIL_model_experiments2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c26_HIL_model_experiments2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c26_HIL_model_experiments2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c26_HIL_model_experiments2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c26_HIL_model_experiments2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c26_HIL_model_experiments2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c26_HIL_model_experiments2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c26_HIL_model_experiments2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c26_HIL_model_experiments2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c26_HIL_model_experiments2;
  chartInstance->chartInfo.mdlStart = mdlStart_c26_HIL_model_experiments2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c26_HIL_model_experiments2;
...
void c26_HIL_model_experiments2_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c26_HIL_model_experiments2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c26_HIL_model_experiments2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c26_HIL_model_experiments2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c26_HIL_model_experiments2_method_dispatcher.\n"
