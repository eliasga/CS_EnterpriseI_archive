...
static void initialize_c3_HIL_model_experiments2
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance);
static void initialize_params_c3_HIL_model_experiments2
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance);
static void enable_c3_HIL_model_experiments2
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance);
static void disable_c3_HIL_model_experiments2
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_HIL_model_experiments2
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_HIL_model_experiments2
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance);
static void set_sim_state_c3_HIL_model_experiments2
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance, const mxArray
   *c3_st);
static void finalize_c3_HIL_model_experiments2
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance);
static void sf_c3_HIL_model_experiments2
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance);
static void c3_chartstep_c3_HIL_model_experiments2
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance);
static void initSimStructsc3_HIL_model_experiments2
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance);
static void registerMessagesc3_HIL_model_experiments2
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c3_saved_out, const char_T *c3_identifier,
  real_T c3_y[50]);
static void c3_b_emlrt_marshallIn(SFc3_HIL_model_experiments2InstanceStruct
...
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c3_StandardDev, const char_T *c3_identifier);
static real_T c3_d_emlrt_marshallIn(SFc3_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[18]);
static void c3_eml_scalar_eg(SFc3_HIL_model_experiments2InstanceStruct
  *chartInstance);
static void c3_eml_error(SFc3_HIL_model_experiments2InstanceStruct
  *chartInstance);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_e_emlrt_marshallIn(SFc3_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_f_emlrt_marshallIn(SFc3_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_HIL_model_experiments2, const
  char_T *c3_identifier);
static uint8_T c3_g_emlrt_marshallIn(SFc3_HIL_model_experiments2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_HIL_model_experiments2InstanceStruct
  *chartInstance);
  ...
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_HIL_model_experiments2 = 0U;
}
  ...
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance)
{
  ...
  c3_d_hoistedGlobal = chartInstance->c3_is_active_c3_HIL_model_experiments2;
   ...
   *c3_st)
{
  ...
  *c3_counter = c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c3_is_active_c3_HIL_model_experiments2 = c3_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 4)),
     "is_active_c3_HIL_model_experiments2");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_HIL_model_experiments2(chartInstance);
  ...
  (SFc3_HIL_model_experiments2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_HIL_model_experiments2(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_HIL_model_experiments2InstanceStruct *chartInstance;
  chartInstance = (SFc3_HIL_model_experiments2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_HIL_model_experiments2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_HIL_model_experiments2), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_HIL_model_experiments2);
  return c3_y;
}
...
void sf_c3_HIL_model_experiments2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_HIL_model_experiments2_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_HIL_model_experiments2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c3_HIL_model_experiments2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"Mean\",},{M[1],M[11],T\"StandardDev\",},{M[1],M[10],T\"counter\",},{M[1],M[8],T\"saved_out\",},{M[8],M[0],T\"is_active_c3_HIL_model_experiments2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_HIL_model_experiments2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_HIL_model_experiments2InstanceStruct *chartInstance;
    chartInstance = (SFc3_HIL_model_experiments2InstanceStruct *)
...
static void sf_opaque_initialize_c3_HIL_model_experiments2(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_HIL_model_experiments2
    ((SFc3_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
  initialize_c3_HIL_model_experiments2
    ((SFc3_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_HIL_model_experiments2(void *chartInstanceVar)
{
  enable_c3_HIL_model_experiments2((SFc3_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_HIL_model_experiments2(void *chartInstanceVar)
{
  disable_c3_HIL_model_experiments2((SFc3_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_HIL_model_experiments2(void *chartInstanceVar)
{
  sf_c3_HIL_model_experiments2((SFc3_HIL_model_experiments2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_HIL_model_experiments2
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_HIL_model_experiments2
    ((SFc3_HIL_model_experiments2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_HIL_model_experiments2();/* state var info */
...
extern void sf_internal_set_sim_state_c3_HIL_model_experiments2(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_HIL_model_experiments2
    ((SFc3_HIL_model_experiments2InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_HIL_model_experiments2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c3_HIL_model_experiments2(S);
}

static void sf_opaque_set_sim_state_c3_HIL_model_experiments2(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c3_HIL_model_experiments2(S, st);
}

static void sf_opaque_terminate_c3_HIL_model_experiments2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_HIL_model_experiments2InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c3_HIL_model_experiments2
      ((SFc3_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_HIL_model_experiments2
    ((SFc3_HIL_model_experiments2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_HIL_model_experiments2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_HIL_model_experiments2
      ((SFc3_HIL_model_experiments2InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_HIL_model_experiments2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_HIL_model_experiments2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_HIL_model_experiments2(SimStruct *S)
{
  SFc3_HIL_model_experiments2InstanceStruct *chartInstance;
  chartInstance = (SFc3_HIL_model_experiments2InstanceStruct *)utMalloc(sizeof
    (SFc3_HIL_model_experiments2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_HIL_model_experiments2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_HIL_model_experiments2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_HIL_model_experiments2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_HIL_model_experiments2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_HIL_model_experiments2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_HIL_model_experiments2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_HIL_model_experiments2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_HIL_model_experiments2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_HIL_model_experiments2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_HIL_model_experiments2;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_HIL_model_experiments2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_HIL_model_experiments2;
...
void c3_HIL_model_experiments2_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_HIL_model_experiments2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_HIL_model_experiments2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_HIL_model_experiments2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_HIL_model_experiments2_method_dispatcher.\n"
