...
static void initialize_c10_HIL_model_overall
  (SFc10_HIL_model_overallInstanceStruct *chartInstance);
static void initialize_params_c10_HIL_model_overall
  (SFc10_HIL_model_overallInstanceStruct *chartInstance);
static void enable_c10_HIL_model_overall(SFc10_HIL_model_overallInstanceStruct
  *chartInstance);
static void disable_c10_HIL_model_overall(SFc10_HIL_model_overallInstanceStruct *
  chartInstance);
static void c10_update_debugger_state_c10_HIL_model_overall
  (SFc10_HIL_model_overallInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_HIL_model_overall
  (SFc10_HIL_model_overallInstanceStruct *chartInstance);
static void set_sim_state_c10_HIL_model_overall
  (SFc10_HIL_model_overallInstanceStruct *chartInstance, const mxArray *c10_st);
static void finalize_c10_HIL_model_overall(SFc10_HIL_model_overallInstanceStruct
  *chartInstance);
static void sf_c10_HIL_model_overall(SFc10_HIL_model_overallInstanceStruct
  *chartInstance);
static void initSimStructsc10_HIL_model_overall
  (SFc10_HIL_model_overallInstanceStruct *chartInstance);
static void registerMessagesc10_HIL_model_overall
  (SFc10_HIL_model_overallInstanceStruct *chartInstance);
...
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_c_emlrt_marshallIn(SFc10_HIL_model_overallInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_d_emlrt_marshallIn(SFc10_HIL_model_overallInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint8_T c10_e_emlrt_marshallIn(SFc10_HIL_model_overallInstanceStruct
  *chartInstance, const mxArray *c10_b_is_active_c10_HIL_model_overall, const
  char_T *c10_identifier);
static uint8_T c10_f_emlrt_marshallIn(SFc10_HIL_model_overallInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_HIL_model_overallInstanceStruct
  *chartInstance);
  ...
  (SFc10_HIL_model_overallInstanceStruct *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_HIL_model_overall = 0U;
}
  ...
  (SFc10_HIL_model_overallInstanceStruct *chartInstance)
{
  ...
  c10_hoistedGlobal = chartInstance->c10_is_active_c10_HIL_model_overall;
...
const mxArray *sf_c10_HIL_model_overall_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c10_identifier)
{
  ...
  c10_y = c10_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_HIL_model_overall), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_HIL_model_overall);
  return c10_y;
}
...
void sf_c10_HIL_model_overall_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c10_HIL_model_overall_get_autoinheritance_info(void)
{
...
mxArray *sf_c10_HIL_model_overall_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c10_HIL_model_overall(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"R\",},{M[8],M[0],T\"is_active_c10_HIL_model_overall\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_HIL_model_overall_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c10_HIL_model_overall(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_HIL_model_overallInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_HIL_model_overall((SFc10_HIL_model_overallInstanceStruct*)
    chartInstanceVar);
  initialize_c10_HIL_model_overall((SFc10_HIL_model_overallInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c10_HIL_model_overall(void *chartInstanceVar)
{
  enable_c10_HIL_model_overall((SFc10_HIL_model_overallInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c10_HIL_model_overall(void *chartInstanceVar)
{
  disable_c10_HIL_model_overall((SFc10_HIL_model_overallInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c10_HIL_model_overall(void *chartInstanceVar)
{
  sf_c10_HIL_model_overall((SFc10_HIL_model_overallInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_HIL_model_overall(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_HIL_model_overall
    ((SFc10_HIL_model_overallInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_HIL_model_overall();/* state var info */
...
extern void sf_internal_set_sim_state_c10_HIL_model_overall(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c10_HIL_model_overall((SFc10_HIL_model_overallInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_HIL_model_overall(SimStruct* S)
{
  return sf_internal_get_sim_state_c10_HIL_model_overall(S);
}

static void sf_opaque_set_sim_state_c10_HIL_model_overall(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c10_HIL_model_overall(S, st);
}

static void sf_opaque_terminate_c10_HIL_model_overall(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_HIL_model_overallInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c10_HIL_model_overall((SFc10_HIL_model_overallInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc10_HIL_model_overall((SFc10_HIL_model_overallInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_HIL_model_overall(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c10_HIL_model_overall
      ((SFc10_HIL_model_overallInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c10_HIL_model_overall(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c10_HIL_model_overall(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_HIL_model_overall(SimStruct *S)
{
  SFc10_HIL_model_overallInstanceStruct *chartInstance;
  chartInstance = (SFc10_HIL_model_overallInstanceStruct *)utMalloc(sizeof
    (SFc10_HIL_model_overallInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_HIL_model_overallInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_HIL_model_overall;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_HIL_model_overall;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c10_HIL_model_overall;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_HIL_model_overall;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c10_HIL_model_overall;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_HIL_model_overall;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_HIL_model_overall;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_HIL_model_overall;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_HIL_model_overall;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_HIL_model_overall;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c10_HIL_model_overall;
...
void c10_HIL_model_overall_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_HIL_model_overall(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_HIL_model_overall(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_HIL_model_overall(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_HIL_model_overall_method_dispatcher.\n"
