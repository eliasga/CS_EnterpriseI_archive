...
static void initialize_c25_HIL_model_overall
  (SFc25_HIL_model_overallInstanceStruct *chartInstance);
static void initialize_params_c25_HIL_model_overall
  (SFc25_HIL_model_overallInstanceStruct *chartInstance);
static void enable_c25_HIL_model_overall(SFc25_HIL_model_overallInstanceStruct
  *chartInstance);
static void disable_c25_HIL_model_overall(SFc25_HIL_model_overallInstanceStruct *
  chartInstance);
static void c25_update_debugger_state_c25_HIL_model_overall
  (SFc25_HIL_model_overallInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c25_HIL_model_overall
  (SFc25_HIL_model_overallInstanceStruct *chartInstance);
static void set_sim_state_c25_HIL_model_overall
  (SFc25_HIL_model_overallInstanceStruct *chartInstance, const mxArray *c25_st);
static void finalize_c25_HIL_model_overall(SFc25_HIL_model_overallInstanceStruct
  *chartInstance);
static void sf_c25_HIL_model_overall(SFc25_HIL_model_overallInstanceStruct
  *chartInstance);
static void initSimStructsc25_HIL_model_overall
  (SFc25_HIL_model_overallInstanceStruct *chartInstance);
static void registerMessagesc25_HIL_model_overall
  (SFc25_HIL_model_overallInstanceStruct *chartInstance);
...
static const mxArray *c25_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static void c25_emlrt_marshallIn(SFc25_HIL_model_overallInstanceStruct
  *chartInstance, const mxArray *c25_nu_ref_end, const char_T *c25_identifier,
  real_T c25_y[3]);
static void c25_b_emlrt_marshallIn(SFc25_HIL_model_overallInstanceStruct
...
static const mxArray *c25_c_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static real_T c25_c_emlrt_marshallIn(SFc25_HIL_model_overallInstanceStruct
  *chartInstance, const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId);
...
static const mxArray *c25_d_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static int32_T c25_d_emlrt_marshallIn(SFc25_HIL_model_overallInstanceStruct
  *chartInstance, const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId);
static void c25_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c25_mxArrayInData, const char_T *c25_varName, void *c25_outData);
static uint8_T c25_e_emlrt_marshallIn(SFc25_HIL_model_overallInstanceStruct
  *chartInstance, const mxArray *c25_b_is_active_c25_HIL_model_overall, const
  char_T *c25_identifier);
static uint8_T c25_f_emlrt_marshallIn(SFc25_HIL_model_overallInstanceStruct
  *chartInstance, const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId);
static void init_dsm_address_info(SFc25_HIL_model_overallInstanceStruct
  *chartInstance);
  ...
  (SFc25_HIL_model_overallInstanceStruct *chartInstance)
{
  ...
  chartInstance->c25_is_active_c25_HIL_model_overall = 0U;
}
  ...
  (SFc25_HIL_model_overallInstanceStruct *chartInstance)
{
  ...
  c25_hoistedGlobal = chartInstance->c25_is_active_c25_HIL_model_overall;
  ...
  (SFc25_HIL_model_overallInstanceStruct *chartInstance, const mxArray *c25_st)
{
  ...
  chartInstance->c25_is_active_c25_HIL_model_overall = c25_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c25_u, 2)),
     "is_active_c25_HIL_model_overall");
  sf_mex_destroy(&c25_u);
  c25_update_debugger_state_c25_HIL_model_overall(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 18U, chartInstance->c25_sfEvent);
  ...
  chartInstance->c25_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 18U, chartInstance->c25_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 18U, chartInstance->c25_sfEvent);
  ...
  *c25_inData)
{
  ...
  const mxArray *c25_y = NULL;
  SFc25_HIL_model_overallInstanceStruct *chartInstance;
  chartInstance = (SFc25_HIL_model_overallInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c25_HIL_model_overall_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c25_identifier)
{
  ...
  c25_y = c25_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c25_b_is_active_c25_HIL_model_overall), &c25_thisId);
  sf_mex_destroy(&c25_b_is_active_c25_HIL_model_overall);
  return c25_y;
}
...
void sf_c25_HIL_model_overall_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c25_HIL_model_overall_get_autoinheritance_info(void)
{
...
mxArray *sf_c25_HIL_model_overall_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c25_HIL_model_overall(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[8],T\"eta_ref_end\",},{M[1],M[13],T\"nu_ref_end\",},{M[8],M[0],T\"is_active_c25_HIL_model_overall\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c25_HIL_model_overall_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc25_HIL_model_overallInstanceStruct *chartInstance;
    chartInstance = (SFc25_HIL_model_overallInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c25_HIL_model_overall(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc25_HIL_model_overallInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c25_HIL_model_overall((SFc25_HIL_model_overallInstanceStruct*)
    chartInstanceVar);
  initialize_c25_HIL_model_overall((SFc25_HIL_model_overallInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c25_HIL_model_overall(void *chartInstanceVar)
{
  enable_c25_HIL_model_overall((SFc25_HIL_model_overallInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c25_HIL_model_overall(void *chartInstanceVar)
{
  disable_c25_HIL_model_overall((SFc25_HIL_model_overallInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c25_HIL_model_overall(void *chartInstanceVar)
{
  sf_c25_HIL_model_overall((SFc25_HIL_model_overallInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c25_HIL_model_overall(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c25_HIL_model_overall
    ((SFc25_HIL_model_overallInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c25_HIL_model_overall();/* state var info */
...
extern void sf_internal_set_sim_state_c25_HIL_model_overall(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c25_HIL_model_overall((SFc25_HIL_model_overallInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c25_HIL_model_overall(SimStruct* S)
{
  return sf_internal_get_sim_state_c25_HIL_model_overall(S);
}

static void sf_opaque_set_sim_state_c25_HIL_model_overall(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c25_HIL_model_overall(S, st);
}

static void sf_opaque_terminate_c25_HIL_model_overall(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc25_HIL_model_overallInstanceStruct*) chartInstanceVar)
      ->S;
    ...
    finalize_c25_HIL_model_overall((SFc25_HIL_model_overallInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc25_HIL_model_overall((SFc25_HIL_model_overallInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c25_HIL_model_overall(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c25_HIL_model_overall
      ((SFc25_HIL_model_overallInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c25_HIL_model_overall(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c25_HIL_model_overall(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c25_HIL_model_overall(SimStruct *S)
{
  SFc25_HIL_model_overallInstanceStruct *chartInstance;
  chartInstance = (SFc25_HIL_model_overallInstanceStruct *)utMalloc(sizeof
    (SFc25_HIL_model_overallInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc25_HIL_model_overallInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c25_HIL_model_overall;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c25_HIL_model_overall;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c25_HIL_model_overall;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c25_HIL_model_overall;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c25_HIL_model_overall;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c25_HIL_model_overall;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c25_HIL_model_overall;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c25_HIL_model_overall;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c25_HIL_model_overall;
  chartInstance->chartInfo.mdlStart = mdlStart_c25_HIL_model_overall;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c25_HIL_model_overall;
...
void c25_HIL_model_overall_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c25_HIL_model_overall(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c25_HIL_model_overall(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c25_HIL_model_overall(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c25_HIL_model_overall_method_dispatcher.\n"
