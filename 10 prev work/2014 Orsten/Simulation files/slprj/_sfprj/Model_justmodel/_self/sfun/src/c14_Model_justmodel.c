...
static void initialize_c14_Model_justmodel(SFc14_Model_justmodelInstanceStruct
  *chartInstance);
static void initialize_params_c14_Model_justmodel
  (SFc14_Model_justmodelInstanceStruct *chartInstance);
static void enable_c14_Model_justmodel(SFc14_Model_justmodelInstanceStruct
  *chartInstance);
static void disable_c14_Model_justmodel(SFc14_Model_justmodelInstanceStruct
  *chartInstance);
static void c14_update_debugger_state_c14_Model_justmodel
  (SFc14_Model_justmodelInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_Model_justmodel
  (SFc14_Model_justmodelInstanceStruct *chartInstance);
static void set_sim_state_c14_Model_justmodel
  (SFc14_Model_justmodelInstanceStruct *chartInstance, const mxArray *c14_st);
static void finalize_c14_Model_justmodel(SFc14_Model_justmodelInstanceStruct
  *chartInstance);
static void sf_c14_Model_justmodel(SFc14_Model_justmodelInstanceStruct
  *chartInstance);
static void initSimStructsc14_Model_justmodel
  (SFc14_Model_justmodelInstanceStruct *chartInstance);
static void registerMessagesc14_Model_justmodel
  (SFc14_Model_justmodelInstanceStruct *chartInstance);
...
static const mxArray *c14_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static void c14_emlrt_marshallIn(SFc14_Model_justmodelInstanceStruct
...
static const mxArray *c14_c_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static real_T c14_c_emlrt_marshallIn(SFc14_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void c14_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData);
static void c14_d_emlrt_marshallIn(SFc14_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId,
  real_T c14_y[3]);
...
static const mxArray *c14_d_sf_marshallOut(void *chartInstanceVoid, void
  *c14_inData);
static int32_T c14_e_emlrt_marshallIn(SFc14_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void c14_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c14_mxArrayInData, const char_T *c14_varName, void *c14_outData);
static uint8_T c14_f_emlrt_marshallIn(SFc14_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c14_b_is_active_c14_Model_justmodel, const
  char_T *c14_identifier);
static uint8_T c14_g_emlrt_marshallIn(SFc14_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void init_dsm_address_info(SFc14_Model_justmodelInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c14_is_active_c14_Model_justmodel = 0U;
}
  ...
  (SFc14_Model_justmodelInstanceStruct *chartInstance)
{
  ...
  c14_hoistedGlobal = chartInstance->c14_is_active_c14_Model_justmodel;
...
const mxArray *sf_c14_Model_justmodel_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c14_identifier)
{
  ...
  c14_y = c14_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_Model_justmodel), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_Model_justmodel);
  return c14_y;
}
...
void sf_c14_Model_justmodel_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c14_Model_justmodel_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c14_Model_justmodel(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"Rs\",},{M[1],M[6],T\"Rst\",},{M[8],M[0],T\"is_active_c14_Model_justmodel\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_Model_justmodel_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc14_Model_justmodelInstanceStruct *chartInstance;
    chartInstance = (SFc14_Model_justmodelInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c14_Model_justmodel(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc14_Model_justmodelInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c14_Model_justmodel((SFc14_Model_justmodelInstanceStruct*)
    chartInstanceVar);
  initialize_c14_Model_justmodel((SFc14_Model_justmodelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c14_Model_justmodel(void *chartInstanceVar)
{
  enable_c14_Model_justmodel((SFc14_Model_justmodelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c14_Model_justmodel(void *chartInstanceVar)
{
  disable_c14_Model_justmodel((SFc14_Model_justmodelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c14_Model_justmodel(void *chartInstanceVar)
{
  sf_c14_Model_justmodel((SFc14_Model_justmodelInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c14_Model_justmodel(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c14_Model_justmodel
    ((SFc14_Model_justmodelInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c14_Model_justmodel();/* state var info */
...
extern void sf_internal_set_sim_state_c14_Model_justmodel(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c14_Model_justmodel((SFc14_Model_justmodelInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c14_Model_justmodel(SimStruct* S)
{
  return sf_internal_get_sim_state_c14_Model_justmodel(S);
}

static void sf_opaque_set_sim_state_c14_Model_justmodel(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c14_Model_justmodel(S, st);
}

static void sf_opaque_terminate_c14_Model_justmodel(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_Model_justmodelInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Model_justmodel_optimization_info();
    }

    finalize_c14_Model_justmodel((SFc14_Model_justmodelInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc14_Model_justmodel((SFc14_Model_justmodelInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_Model_justmodel(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c14_Model_justmodel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c14_Model_justmodel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c14_Model_justmodel(SimStruct *S)
{
  SFc14_Model_justmodelInstanceStruct *chartInstance;
  chartInstance = (SFc14_Model_justmodelInstanceStruct *)utMalloc(sizeof
    (SFc14_Model_justmodelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_Model_justmodelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c14_Model_justmodel;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c14_Model_justmodel;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c14_Model_justmodel;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c14_Model_justmodel;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c14_Model_justmodel;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c14_Model_justmodel;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c14_Model_justmodel;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c14_Model_justmodel;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_Model_justmodel;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_Model_justmodel;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c14_Model_justmodel;
...
void c14_Model_justmodel_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_Model_justmodel(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_Model_justmodel(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_Model_justmodel(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_Model_justmodel_method_dispatcher.\n"
