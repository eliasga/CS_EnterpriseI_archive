...
static void initialize_c26_Model_justmodel(SFc26_Model_justmodelInstanceStruct
  *chartInstance);
static void initialize_params_c26_Model_justmodel
  (SFc26_Model_justmodelInstanceStruct *chartInstance);
static void enable_c26_Model_justmodel(SFc26_Model_justmodelInstanceStruct
  *chartInstance);
static void disable_c26_Model_justmodel(SFc26_Model_justmodelInstanceStruct
  *chartInstance);
static void c26_update_debugger_state_c26_Model_justmodel
  (SFc26_Model_justmodelInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c26_Model_justmodel
  (SFc26_Model_justmodelInstanceStruct *chartInstance);
static void set_sim_state_c26_Model_justmodel
  (SFc26_Model_justmodelInstanceStruct *chartInstance, const mxArray *c26_st);
static void finalize_c26_Model_justmodel(SFc26_Model_justmodelInstanceStruct
  *chartInstance);
static void sf_c26_Model_justmodel(SFc26_Model_justmodelInstanceStruct
  *chartInstance);
static void c26_chartstep_c26_Model_justmodel
  (SFc26_Model_justmodelInstanceStruct *chartInstance);
static void initSimStructsc26_Model_justmodel
  (SFc26_Model_justmodelInstanceStruct *chartInstance);
static void registerMessagesc26_Model_justmodel
  (SFc26_Model_justmodelInstanceStruct *chartInstance);
...
static const mxArray *c26_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static void c26_emlrt_marshallIn(SFc26_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c26_eta_dot_ref, const char_T *c26_identifier,
  real_T c26_y[3]);
static void c26_b_emlrt_marshallIn(SFc26_Model_justmodelInstanceStruct
...
static const mxArray *c26_b_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static real_T c26_c_emlrt_marshallIn(SFc26_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
...
static const mxArray *c26_c_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static void c26_d_emlrt_marshallIn(SFc26_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId,
  real_T c26_y[9]);
...
static void c26_eml_scalar_eg(SFc26_Model_justmodelInstanceStruct *chartInstance);
static const mxArray *c26_d_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static int32_T c26_e_emlrt_marshallIn(SFc26_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
static void c26_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c26_mxArrayInData, const char_T *c26_varName, void *c26_outData);
static uint8_T c26_f_emlrt_marshallIn(SFc26_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c26_b_is_active_c26_Model_justmodel, const
  char_T *c26_identifier);
static uint8_T c26_g_emlrt_marshallIn(SFc26_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
static void init_dsm_address_info(SFc26_Model_justmodelInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c26_is_active_c26_Model_justmodel = 0U;
}
  ...
  (SFc26_Model_justmodelInstanceStruct *chartInstance)
{
  ...
  c26_hoistedGlobal = chartInstance->c26_is_active_c26_Model_justmodel;
  ...
  (SFc26_Model_justmodelInstanceStruct *chartInstance, const mxArray *c26_st)
{
  ...
  chartInstance->c26_is_active_c26_Model_justmodel = c26_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c26_u, 1)),
     "is_active_c26_Model_justmodel");
  sf_mex_destroy(&c26_u);
  c26_update_debugger_state_c26_Model_justmodel(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 16U, chartInstance->c26_sfEvent);
  ...
  chartInstance->c26_sfEvent = CALL_EVENT;
  c26_chartstep_c26_Model_justmodel(chartInstance);
  ...
  (SFc26_Model_justmodelInstanceStruct *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 16U, chartInstance->c26_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 16U, chartInstance->c26_sfEvent);
}
  ...
  *c26_inData)
{
  ...
  const mxArray *c26_y = NULL;
  SFc26_Model_justmodelInstanceStruct *chartInstance;
  chartInstance = (SFc26_Model_justmodelInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c26_Model_justmodel_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c26_identifier)
{
  ...
  c26_y = c26_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c26_b_is_active_c26_Model_justmodel), &c26_thisId);
  sf_mex_destroy(&c26_b_is_active_c26_Model_justmodel);
  return c26_y;
}
...
void sf_c26_Model_justmodel_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c26_Model_justmodel_get_autoinheritance_info(void)
{
...
mxArray *sf_c26_Model_justmodel_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c26_Model_justmodel(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"eta_dot_ref\",},{M[8],M[0],T\"is_active_c26_Model_justmodel\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c26_Model_justmodel_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc26_Model_justmodelInstanceStruct *chartInstance;
    chartInstance = (SFc26_Model_justmodelInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c26_Model_justmodel(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc26_Model_justmodelInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c26_Model_justmodel((SFc26_Model_justmodelInstanceStruct*)
    chartInstanceVar);
  initialize_c26_Model_justmodel((SFc26_Model_justmodelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c26_Model_justmodel(void *chartInstanceVar)
{
  enable_c26_Model_justmodel((SFc26_Model_justmodelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c26_Model_justmodel(void *chartInstanceVar)
{
  disable_c26_Model_justmodel((SFc26_Model_justmodelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c26_Model_justmodel(void *chartInstanceVar)
{
  sf_c26_Model_justmodel((SFc26_Model_justmodelInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c26_Model_justmodel(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c26_Model_justmodel
    ((SFc26_Model_justmodelInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c26_Model_justmodel();/* state var info */
...
extern void sf_internal_set_sim_state_c26_Model_justmodel(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c26_Model_justmodel((SFc26_Model_justmodelInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c26_Model_justmodel(SimStruct* S)
{
  return sf_internal_get_sim_state_c26_Model_justmodel(S);
}

static void sf_opaque_set_sim_state_c26_Model_justmodel(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c26_Model_justmodel(S, st);
}

static void sf_opaque_terminate_c26_Model_justmodel(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc26_Model_justmodelInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Model_justmodel_optimization_info();
    }

    finalize_c26_Model_justmodel((SFc26_Model_justmodelInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc26_Model_justmodel((SFc26_Model_justmodelInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c26_Model_justmodel(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c26_Model_justmodel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c26_Model_justmodel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c26_Model_justmodel(SimStruct *S)
{
  SFc26_Model_justmodelInstanceStruct *chartInstance;
  chartInstance = (SFc26_Model_justmodelInstanceStruct *)utMalloc(sizeof
    (SFc26_Model_justmodelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc26_Model_justmodelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c26_Model_justmodel;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c26_Model_justmodel;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c26_Model_justmodel;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c26_Model_justmodel;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c26_Model_justmodel;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c26_Model_justmodel;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c26_Model_justmodel;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c26_Model_justmodel;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c26_Model_justmodel;
  chartInstance->chartInfo.mdlStart = mdlStart_c26_Model_justmodel;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c26_Model_justmodel;
...
void c26_Model_justmodel_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c26_Model_justmodel(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c26_Model_justmodel(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c26_Model_justmodel(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c26_Model_justmodel_method_dispatcher.\n"
