...
static void initialize_c8_Model_justmodel(SFc8_Model_justmodelInstanceStruct
  *chartInstance);
static void initialize_params_c8_Model_justmodel
  (SFc8_Model_justmodelInstanceStruct *chartInstance);
static void enable_c8_Model_justmodel(SFc8_Model_justmodelInstanceStruct
  *chartInstance);
static void disable_c8_Model_justmodel(SFc8_Model_justmodelInstanceStruct
  *chartInstance);
static void c8_update_debugger_state_c8_Model_justmodel
  (SFc8_Model_justmodelInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_Model_justmodel
  (SFc8_Model_justmodelInstanceStruct *chartInstance);
static void set_sim_state_c8_Model_justmodel(SFc8_Model_justmodelInstanceStruct *
  chartInstance, const mxArray *c8_st);
static void finalize_c8_Model_justmodel(SFc8_Model_justmodelInstanceStruct
  *chartInstance);
static void sf_c8_Model_justmodel(SFc8_Model_justmodelInstanceStruct
  *chartInstance);
static void c8_chartstep_c8_Model_justmodel(SFc8_Model_justmodelInstanceStruct
  *chartInstance);
static void initSimStructsc8_Model_justmodel(SFc8_Model_justmodelInstanceStruct *
  chartInstance);
static void registerMessagesc8_Model_justmodel
  (SFc8_Model_justmodelInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c8_e, const char_T *c8_identifier, real_T c8_y
  [3]);
static void c8_b_emlrt_marshallIn(SFc8_Model_justmodelInstanceStruct
...
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static void c8_d_emlrt_marshallIn(SFc8_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[9]);
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static void c8_info_helper(c8_ResolvedFunctionInfo c8_info[14]);
static void c8_eml_scalar_eg(SFc8_Model_justmodelInstanceStruct *chartInstance);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_e_emlrt_marshallIn(SFc8_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_f_emlrt_marshallIn(SFc8_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_Model_justmodel, const char_T
  *c8_identifier);
static uint8_T c8_g_emlrt_marshallIn(SFc8_Model_justmodelInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_Model_justmodelInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_Model_justmodel = 0U;
}
  ...
  (SFc8_Model_justmodelInstanceStruct *chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_Model_justmodel;
  ...
  chartInstance, const mxArray *c8_st)
{
  ...
  chartInstance->c8_is_active_c8_Model_justmodel = c8_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 6)),
     "is_active_c8_Model_justmodel");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_Model_justmodel(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  c8_chartstep_c8_Model_justmodel(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_Model_justmodelInstanceStruct *chartInstance;
  chartInstance = (SFc8_Model_justmodelInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_Model_justmodel_get_eml_resolved_functions_info(void)
{
  ...
  *c8_identifier)
{
  ...
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_Model_justmodel), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_Model_justmodel);
  return c8_y;
}
...
void sf_c8_Model_justmodel_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_Model_justmodel_get_autoinheritance_info(void)
{
...
mxArray *sf_c8_Model_justmodel_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c8_Model_justmodel(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[18],T\"a\",},{M[1],M[19],T\"b\",},{M[1],M[20],T\"c\",},{M[1],M[21],T\"d\",},{M[1],M[22],T\"e\",},{M[1],M[5],T\"tau\",},{M[8],M[0],T\"is_active_c8_Model_justmodel\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_Model_justmodel_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_Model_justmodelInstanceStruct *chartInstance;
    chartInstance = (SFc8_Model_justmodelInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c8_Model_justmodel(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_Model_justmodelInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_Model_justmodel((SFc8_Model_justmodelInstanceStruct*)
    chartInstanceVar);
  initialize_c8_Model_justmodel((SFc8_Model_justmodelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_Model_justmodel(void *chartInstanceVar)
{
  enable_c8_Model_justmodel((SFc8_Model_justmodelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_Model_justmodel(void *chartInstanceVar)
{
  disable_c8_Model_justmodel((SFc8_Model_justmodelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_Model_justmodel(void *chartInstanceVar)
{
  sf_c8_Model_justmodel((SFc8_Model_justmodelInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_Model_justmodel(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_Model_justmodel
    ((SFc8_Model_justmodelInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_Model_justmodel();/* state var info */
...
extern void sf_internal_set_sim_state_c8_Model_justmodel(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_Model_justmodel((SFc8_Model_justmodelInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_Model_justmodel(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_Model_justmodel(S);
}

static void sf_opaque_set_sim_state_c8_Model_justmodel(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c8_Model_justmodel(S, st);
}

static void sf_opaque_terminate_c8_Model_justmodel(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_Model_justmodelInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Model_justmodel_optimization_info();
    }

    finalize_c8_Model_justmodel((SFc8_Model_justmodelInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc8_Model_justmodel((SFc8_Model_justmodelInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_Model_justmodel(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_Model_justmodel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_Model_justmodel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_Model_justmodel(SimStruct *S)
{
  SFc8_Model_justmodelInstanceStruct *chartInstance;
  chartInstance = (SFc8_Model_justmodelInstanceStruct *)utMalloc(sizeof
    (SFc8_Model_justmodelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_Model_justmodelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_Model_justmodel;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_Model_justmodel;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_Model_justmodel;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_Model_justmodel;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_Model_justmodel;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_Model_justmodel;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_Model_justmodel;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_Model_justmodel;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_Model_justmodel;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_Model_justmodel;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_Model_justmodel;
...
void c8_Model_justmodel_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_Model_justmodel(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_Model_justmodel(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_Model_justmodel(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_Model_justmodel_method_dispatcher.\n"
