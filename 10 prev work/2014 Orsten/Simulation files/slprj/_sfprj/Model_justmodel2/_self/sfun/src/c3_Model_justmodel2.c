...
static void initialize_c3_Model_justmodel2(SFc3_Model_justmodel2InstanceStruct
  *chartInstance);
static void initialize_params_c3_Model_justmodel2
  (SFc3_Model_justmodel2InstanceStruct *chartInstance);
static void enable_c3_Model_justmodel2(SFc3_Model_justmodel2InstanceStruct
  *chartInstance);
static void disable_c3_Model_justmodel2(SFc3_Model_justmodel2InstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_Model_justmodel2
  (SFc3_Model_justmodel2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_Model_justmodel2
  (SFc3_Model_justmodel2InstanceStruct *chartInstance);
static void set_sim_state_c3_Model_justmodel2
  (SFc3_Model_justmodel2InstanceStruct *chartInstance, const mxArray *c3_st);
static void finalize_c3_Model_justmodel2(SFc3_Model_justmodel2InstanceStruct
  *chartInstance);
static void sf_c3_Model_justmodel2(SFc3_Model_justmodel2InstanceStruct
  *chartInstance);
static void initSimStructsc3_Model_justmodel2
  (SFc3_Model_justmodel2InstanceStruct *chartInstance);
static void registerMessagesc3_Model_justmodel2
  (SFc3_Model_justmodel2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_Model_justmodel2InstanceStruct
  *chartInstance, const mxArray *c3_T, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_Model_justmodel2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_Model_justmodel2InstanceStruct
  *chartInstance, const mxArray *c3_Tension, const char_T *c3_identifier, real_T
  c3_y[2]);
static void c3_d_emlrt_marshallIn(SFc3_Model_justmodel2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[2]);
...
static real_T c3_mpower(SFc3_Model_justmodel2InstanceStruct *chartInstance,
  real_T c3_a);
static void c3_eml_scalar_eg(SFc3_Model_justmodel2InstanceStruct *chartInstance);
static void c3_eml_error(SFc3_Model_justmodel2InstanceStruct *chartInstance);
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_e_emlrt_marshallIn(SFc3_Model_justmodel2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_f_emlrt_marshallIn(SFc3_Model_justmodel2InstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_Model_justmodel2, const
  char_T *c3_identifier);
static uint8_T c3_g_emlrt_marshallIn(SFc3_Model_justmodel2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_Model_justmodel2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Model_justmodel2 = 0U;
}
  ...
  (SFc3_Model_justmodel2InstanceStruct *chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_Model_justmodel2;
  ...
  (SFc3_Model_justmodel2InstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_T = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 0)),
  ...
  chartInstance->c3_is_active_c3_Model_justmodel2 = c3_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
     "is_active_c3_Model_justmodel2");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_Model_justmodel2(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_Model_justmodel2InstanceStruct *chartInstance;
  chartInstance = (SFc3_Model_justmodel2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_Model_justmodel2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Model_justmodel2), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_Model_justmodel2);
  return c3_y;
}
...
void sf_c3_Model_justmodel2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_Model_justmodel2_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_Model_justmodel2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c3_Model_justmodel2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[8],T\"T\",},{M[1],M[5],T\"Tension\",},{M[8],M[0],T\"is_active_c3_Model_justmodel2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Model_justmodel2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_Model_justmodel2InstanceStruct *chartInstance;
    chartInstance = (SFc3_Model_justmodel2InstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c3_Model_justmodel2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_Model_justmodel2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_Model_justmodel2((SFc3_Model_justmodel2InstanceStruct*)
    chartInstanceVar);
  initialize_c3_Model_justmodel2((SFc3_Model_justmodel2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_Model_justmodel2(void *chartInstanceVar)
{
  enable_c3_Model_justmodel2((SFc3_Model_justmodel2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_Model_justmodel2(void *chartInstanceVar)
{
  disable_c3_Model_justmodel2((SFc3_Model_justmodel2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_Model_justmodel2(void *chartInstanceVar)
{
  sf_c3_Model_justmodel2((SFc3_Model_justmodel2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_Model_justmodel2(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_Model_justmodel2
    ((SFc3_Model_justmodel2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_Model_justmodel2();/* state var info */
...
extern void sf_internal_set_sim_state_c3_Model_justmodel2(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_Model_justmodel2((SFc3_Model_justmodel2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_Model_justmodel2(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_Model_justmodel2(S);
}

static void sf_opaque_set_sim_state_c3_Model_justmodel2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_Model_justmodel2(S, st);
}

static void sf_opaque_terminate_c3_Model_justmodel2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_Model_justmodel2InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Model_justmodel2_optimization_info();
    }

    finalize_c3_Model_justmodel2((SFc3_Model_justmodel2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_Model_justmodel2((SFc3_Model_justmodel2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Model_justmodel2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Model_justmodel2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_Model_justmodel2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Model_justmodel2(SimStruct *S)
{
  SFc3_Model_justmodel2InstanceStruct *chartInstance;
  chartInstance = (SFc3_Model_justmodel2InstanceStruct *)utMalloc(sizeof
    (SFc3_Model_justmodel2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_Model_justmodel2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_Model_justmodel2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_Model_justmodel2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_Model_justmodel2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_Model_justmodel2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_Model_justmodel2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_Model_justmodel2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_Model_justmodel2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_Model_justmodel2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_Model_justmodel2;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_Model_justmodel2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_Model_justmodel2;
...
void c3_Model_justmodel2_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Model_justmodel2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Model_justmodel2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Model_justmodel2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Model_justmodel2_method_dispatcher.\n"
