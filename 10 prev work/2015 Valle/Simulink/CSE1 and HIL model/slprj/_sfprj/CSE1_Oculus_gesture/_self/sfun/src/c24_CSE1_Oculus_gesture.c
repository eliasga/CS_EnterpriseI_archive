...
static void initialize_c24_CSE1_Oculus_gesture
  (SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void initialize_params_c24_CSE1_Oculus_gesture
  (SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void enable_c24_CSE1_Oculus_gesture
  (SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void disable_c24_CSE1_Oculus_gesture
  (SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void c24_update_debugger_state_c24_CSE1_Oculus_gesture
  (SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c24_CSE1_Oculus_gesture
  (SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void set_sim_state_c24_CSE1_Oculus_gesture
  (SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance, const mxArray *c24_st);
static void finalize_c24_CSE1_Oculus_gesture
  (SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void sf_gateway_c24_CSE1_Oculus_gesture
  (SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void initSimStructsc24_CSE1_Oculus_gesture
  (SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance);
...
static const mxArray *c24_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static void c24_emlrt_marshallIn(SFc24_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c24_w_d, const char_T *c24_identifier, real_T
  c24_y[9]);
static void c24_b_emlrt_marshallIn(SFc24_CSE1_Oculus_gestureInstanceStruct
...
static const mxArray *c24_c_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static real_T c24_c_emlrt_marshallIn(SFc24_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
...
static const mxArray *c24_d_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static int32_T c24_d_emlrt_marshallIn(SFc24_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void c24_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData);
static uint8_T c24_e_emlrt_marshallIn(SFc24_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c24_b_is_active_c24_CSE1_Oculus_gesture, const
  char_T *c24_identifier);
static uint8_T c24_f_emlrt_marshallIn(SFc24_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void init_dsm_address_info(SFc24_CSE1_Oculus_gestureInstanceStruct
  *chartInstance);
  ...
  (SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  chartInstance->c24_is_active_c24_CSE1_Oculus_gesture = 0U;
}
  ...
  (SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  c24_hoistedGlobal = chartInstance->c24_is_active_c24_CSE1_Oculus_gesture;
  ...
  (SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance, const mxArray *c24_st)
{
  ...
  chartInstance->c24_is_active_c24_CSE1_Oculus_gesture = c24_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c24_u, 1)),
     "is_active_c24_CSE1_Oculus_gesture");
  sf_mex_destroy(&c24_u);
  c24_update_debugger_state_c24_CSE1_Oculus_gesture(chartInstance);
  ...
  *c24_inData)
{
  ...
  const mxArray *c24_y = NULL;
  SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance;
  chartInstance = (SFc24_CSE1_Oculus_gestureInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c24_CSE1_Oculus_gesture_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c24_identifier)
{
  ...
  c24_y = c24_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c24_b_is_active_c24_CSE1_Oculus_gesture), &c24_thisId);
  sf_mex_destroy(&c24_b_is_active_c24_CSE1_Oculus_gesture);
  return c24_y;
}
...
void sf_c24_CSE1_Oculus_gesture_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c24_CSE1_Oculus_gesture_get_autoinheritance_info(void)
{
...
mxArray *sf_c24_CSE1_Oculus_gesture_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c24_CSE1_Oculus_gesture_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c24_CSE1_Oculus_gesture(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"w_d\",},{M[8],M[0],T\"is_active_c24_CSE1_Oculus_gesture\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c24_CSE1_Oculus_gesture_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc24_CSE1_Oculus_gestureInstanceStruct *)
...
static void sf_opaque_initialize_c24_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc24_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c24_CSE1_Oculus_gesture
    ((SFc24_CSE1_Oculus_gestureInstanceStruct*) chartInstanceVar);
  initialize_c24_CSE1_Oculus_gesture((SFc24_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c24_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  enable_c24_CSE1_Oculus_gesture((SFc24_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c24_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  disable_c24_CSE1_Oculus_gesture((SFc24_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c24_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  sf_gateway_c24_CSE1_Oculus_gesture((SFc24_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c24_CSE1_Oculus_gesture
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c24_CSE1_Oculus_gesture
    ((SFc24_CSE1_Oculus_gestureInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c24_CSE1_Oculus_gesture();/* state var info */
...
extern void sf_internal_set_sim_state_c24_CSE1_Oculus_gesture(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c24_CSE1_Oculus_gesture();/* state var info */
  ...
  set_sim_state_c24_CSE1_Oculus_gesture((SFc24_CSE1_Oculus_gestureInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c24_CSE1_Oculus_gesture(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c24_CSE1_Oculus_gesture(S);
}

static void sf_opaque_set_sim_state_c24_CSE1_Oculus_gesture(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c24_CSE1_Oculus_gesture(S, st);
}

static void sf_opaque_terminate_c24_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc24_CSE1_Oculus_gestureInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c24_CSE1_Oculus_gesture((SFc24_CSE1_Oculus_gestureInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc24_CSE1_Oculus_gesture((SFc24_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c24_CSE1_Oculus_gesture(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c24_CSE1_Oculus_gesture
      ((SFc24_CSE1_Oculus_gestureInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c24_CSE1_Oculus_gesture(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c24_CSE1_Oculus_gesture(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c24_CSE1_Oculus_gesture(SimStruct *S)
{
  SFc24_CSE1_Oculus_gestureInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc24_CSE1_Oculus_gestureInstanceStruct *)utMalloc(sizeof
    (SFc24_CSE1_Oculus_gestureInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc24_CSE1_Oculus_gestureInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c24_CSE1_Oculus_gesture;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c24_CSE1_Oculus_gesture;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c24_CSE1_Oculus_gesture;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c24_CSE1_Oculus_gesture;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c24_CSE1_Oculus_gesture;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c24_CSE1_Oculus_gesture;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c24_CSE1_Oculus_gesture;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c24_CSE1_Oculus_gesture;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c24_CSE1_Oculus_gesture;
  chartInstance->chartInfo.mdlStart = mdlStart_c24_CSE1_Oculus_gesture;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c24_CSE1_Oculus_gesture;
...
void c24_CSE1_Oculus_gesture_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c24_CSE1_Oculus_gesture(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c24_CSE1_Oculus_gesture(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c24_CSE1_Oculus_gesture(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c24_CSE1_Oculus_gesture_method_dispatcher.\n"
