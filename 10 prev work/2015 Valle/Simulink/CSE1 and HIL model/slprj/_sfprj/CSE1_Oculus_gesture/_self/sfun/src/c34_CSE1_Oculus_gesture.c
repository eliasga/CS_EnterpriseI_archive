...
static void initialize_c34_CSE1_Oculus_gesture
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void initialize_params_c34_CSE1_Oculus_gesture
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void enable_c34_CSE1_Oculus_gesture
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void disable_c34_CSE1_Oculus_gesture
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void c34_update_debugger_state_c34_CSE1_Oculus_gesture
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c34_CSE1_Oculus_gesture
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void set_sim_state_c34_CSE1_Oculus_gesture
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance, const mxArray *c34_st);
static void finalize_c34_CSE1_Oculus_gesture
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void sf_gateway_c34_CSE1_Oculus_gesture
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void initSimStructsc34_CSE1_Oculus_gesture
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance);
...
static const mxArray *c34_sf_marshallOut(void *chartInstanceVoid, void
  *c34_inData);
static void c34_emlrt_marshallIn(SFc34_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c34_eta_dot_filtered, const char_T
  *c34_identifier, real_T c34_y[3]);
static void c34_b_emlrt_marshallIn(SFc34_CSE1_Oculus_gestureInstanceStruct
...
static const mxArray *c34_b_sf_marshallOut(void *chartInstanceVoid, void
  *c34_inData);
static real_T c34_c_emlrt_marshallIn(SFc34_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c34_u, const emlrtMsgIdentifier *c34_parentId);
...
static const mxArray *c34_c_sf_marshallOut(void *chartInstanceVoid, void
  *c34_inData);
static int32_T c34_d_emlrt_marshallIn(SFc34_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c34_u, const emlrtMsgIdentifier *c34_parentId);
static void c34_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c34_mxArrayInData, const char_T *c34_varName, void *c34_outData);
static uint8_T c34_e_emlrt_marshallIn(SFc34_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c34_b_is_active_c34_CSE1_Oculus_gesture, const
  char_T *c34_identifier);
static uint8_T c34_f_emlrt_marshallIn(SFc34_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c34_u, const emlrtMsgIdentifier *c34_parentId);
static void init_dsm_address_info(SFc34_CSE1_Oculus_gestureInstanceStruct
  *chartInstance);
  ...
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  chartInstance->c34_is_active_c34_CSE1_Oculus_gesture = 0U;
}
  ...
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  c34_hoistedGlobal = chartInstance->c34_is_active_c34_CSE1_Oculus_gesture;
  ...
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance, const mxArray *c34_st)
{
  ...
  chartInstance->c34_is_active_c34_CSE1_Oculus_gesture = c34_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c34_u, 1)),
     "is_active_c34_CSE1_Oculus_gesture");
  sf_mex_destroy(&c34_u);
  c34_update_debugger_state_c34_CSE1_Oculus_gesture(chartInstance);
  ...
  (SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 22U, chartInstance->c34_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c34_d_a, 0U);
  chartInstance->c34_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 22U, chartInstance->c34_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 22U, chartInstance->c34_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  ...
  *c34_inData)
{
  ...
  const mxArray *c34_y = NULL;
  SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance;
  chartInstance = (SFc34_CSE1_Oculus_gestureInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c34_CSE1_Oculus_gesture_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c34_identifier)
{
  ...
  c34_y = c34_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c34_b_is_active_c34_CSE1_Oculus_gesture), &c34_thisId);
  sf_mex_destroy(&c34_b_is_active_c34_CSE1_Oculus_gesture);
  return c34_y;
}
...
void sf_c34_CSE1_Oculus_gesture_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c34_CSE1_Oculus_gesture_get_autoinheritance_info(void)
{
...
mxArray *sf_c34_CSE1_Oculus_gesture_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c34_CSE1_Oculus_gesture_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c34_CSE1_Oculus_gesture(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"eta_dot_filtered\",},{M[8],M[0],T\"is_active_c34_CSE1_Oculus_gesture\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c34_CSE1_Oculus_gesture_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc34_CSE1_Oculus_gestureInstanceStruct *)
...
static void sf_opaque_initialize_c34_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc34_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c34_CSE1_Oculus_gesture
    ((SFc34_CSE1_Oculus_gestureInstanceStruct*) chartInstanceVar);
  initialize_c34_CSE1_Oculus_gesture((SFc34_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c34_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  enable_c34_CSE1_Oculus_gesture((SFc34_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c34_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  disable_c34_CSE1_Oculus_gesture((SFc34_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c34_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  sf_gateway_c34_CSE1_Oculus_gesture((SFc34_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c34_CSE1_Oculus_gesture
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c34_CSE1_Oculus_gesture
    ((SFc34_CSE1_Oculus_gestureInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c34_CSE1_Oculus_gesture();/* state var info */
...
extern void sf_internal_set_sim_state_c34_CSE1_Oculus_gesture(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c34_CSE1_Oculus_gesture();/* state var info */
  ...
  set_sim_state_c34_CSE1_Oculus_gesture((SFc34_CSE1_Oculus_gestureInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c34_CSE1_Oculus_gesture(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c34_CSE1_Oculus_gesture(S);
}

static void sf_opaque_set_sim_state_c34_CSE1_Oculus_gesture(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c34_CSE1_Oculus_gesture(S, st);
}

static void sf_opaque_terminate_c34_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc34_CSE1_Oculus_gestureInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c34_CSE1_Oculus_gesture((SFc34_CSE1_Oculus_gestureInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc34_CSE1_Oculus_gesture((SFc34_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c34_CSE1_Oculus_gesture(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c34_CSE1_Oculus_gesture
      ((SFc34_CSE1_Oculus_gestureInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c34_CSE1_Oculus_gesture(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c34_CSE1_Oculus_gesture(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c34_CSE1_Oculus_gesture(SimStruct *S)
{
  SFc34_CSE1_Oculus_gestureInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc34_CSE1_Oculus_gestureInstanceStruct *)utMalloc(sizeof
    (SFc34_CSE1_Oculus_gestureInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc34_CSE1_Oculus_gestureInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c34_CSE1_Oculus_gesture;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c34_CSE1_Oculus_gesture;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c34_CSE1_Oculus_gesture;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c34_CSE1_Oculus_gesture;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c34_CSE1_Oculus_gesture;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c34_CSE1_Oculus_gesture;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c34_CSE1_Oculus_gesture;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c34_CSE1_Oculus_gesture;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c34_CSE1_Oculus_gesture;
  chartInstance->chartInfo.mdlStart = mdlStart_c34_CSE1_Oculus_gesture;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c34_CSE1_Oculus_gesture;
...
void c34_CSE1_Oculus_gesture_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c34_CSE1_Oculus_gesture(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c34_CSE1_Oculus_gesture(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c34_CSE1_Oculus_gesture(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c34_CSE1_Oculus_gesture_method_dispatcher.\n"
