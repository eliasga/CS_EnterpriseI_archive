...
static const char * c36_debug_family_names[4] = { "nargin", "nargout", "w_d",
  "y" };

/* Function Declarations */
static void initialize_c36_CSE1_Oculus_gesture
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void initialize_params_c36_CSE1_Oculus_gesture
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void enable_c36_CSE1_Oculus_gesture
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void disable_c36_CSE1_Oculus_gesture
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void c36_update_debugger_state_c36_CSE1_Oculus_gesture
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c36_CSE1_Oculus_gesture
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void set_sim_state_c36_CSE1_Oculus_gesture
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance, const mxArray *c36_st);
static void finalize_c36_CSE1_Oculus_gesture
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void sf_gateway_c36_CSE1_Oculus_gesture
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void initSimStructsc36_CSE1_Oculus_gesture
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance);
...
static const mxArray *c36_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static void c36_emlrt_marshallIn(SFc36_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c36_y, const char_T *c36_identifier, real_T
  c36_b_y[9]);
static void c36_b_emlrt_marshallIn(SFc36_CSE1_Oculus_gestureInstanceStruct
...
static const mxArray *c36_b_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static real_T c36_c_emlrt_marshallIn(SFc36_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
...
static void c36_eml_scalar_eg(SFc36_CSE1_Oculus_gestureInstanceStruct
  *chartInstance);
static void c36_eml_xgemm(SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance,
  real_T c36_A[9], real_T c36_B[9], real_T c36_C[9], real_T c36_b_C[9]);
static const mxArray *c36_c_sf_marshallOut(void *chartInstanceVoid, void
  *c36_inData);
static int32_T c36_d_emlrt_marshallIn(SFc36_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void c36_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData);
static uint8_T c36_e_emlrt_marshallIn(SFc36_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c36_b_is_active_c36_CSE1_Oculus_gesture, const
  char_T *c36_identifier);
static uint8_T c36_f_emlrt_marshallIn(SFc36_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c36_u, const emlrtMsgIdentifier *c36_parentId);
static void c36_b_eml_xgemm(SFc36_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, real_T c36_A[9], real_T c36_B[9], real_T c36_C[9]);
static void init_dsm_address_info(SFc36_CSE1_Oculus_gestureInstanceStruct
  *chartInstance);
  ...
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  chartInstance->c36_is_active_c36_CSE1_Oculus_gesture = 0U;
}
  ...
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  real_T (*c36_d_y)[9];
  c36_d_y = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  c36_st = NULL;
  c36_st = NULL;
  c36_y = NULL;
  sf_mex_assign(&c36_y, sf_mex_createcellmatrix(2, 1), false);
  for (c36_i0 = 0; c36_i0 < 9; c36_i0++) {
    c36_u[c36_i0] = (*c36_d_y)[c36_i0];
  }

  c36_b_y = NULL;
  sf_mex_assign(&c36_b_y, sf_mex_create("y", c36_u, 0, 0U, 1U, 0U, 2, 3, 3),
                false);
  sf_mex_setcell(c36_y, 0, c36_b_y);
  c36_hoistedGlobal = chartInstance->c36_is_active_c36_CSE1_Oculus_gesture;
  ...
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance, const mxArray *c36_st)
{
  ...
  int32_T c36_i1;
  real_T (*c36_y)[9];
  c36_y = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  c36_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c36_u, 0)), "y",
                       c36_dv0);
  for (c36_i1 = 0; c36_i1 < 9; c36_i1++) {
    (*c36_y)[c36_i1] = c36_dv0[c36_i1];
  }

  chartInstance->c36_is_active_c36_CSE1_Oculus_gesture = c36_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c36_u, 1)),
     "is_active_c36_CSE1_Oculus_gesture");
  sf_mex_destroy(&c36_u);
  c36_update_debugger_state_c36_CSE1_Oculus_gesture(chartInstance);
  ...
  (SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  real_T (*c36_b_w_d)[9];
  int32_T exitg1;
  c36_b_y = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  c36_b_w_d = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 24U, chartInstance->c36_sfEvent);
  for (c36_i2 = 0; c36_i2 < 9; c36_i2++) {
    _SFD_DATA_RANGE_CHECK((*c36_b_w_d)[c36_i2], 0U);
  }

  chartInstance->c36_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 24U, chartInstance->c36_sfEvent);
  for (c36_i3 = 0; c36_i3 < 9; c36_i3++) {
    c36_w_d[c36_i3] = (*c36_b_w_d)[c36_i3];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c36_debug_family_names,
    c36_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c36_nargin, 0U, c36_b_sf_marshallOut,
    c36_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c36_nargout, 1U, c36_b_sf_marshallOut,
    c36_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c36_w_d, 2U, c36_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c36_y, 3U, c36_sf_marshallOut,
    c36_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c36_sfEvent, 4);
  for (c36_i4 = 0; c36_i4 < 9; c36_i4++) {
    c36_a[c36_i4] = c36_w_d[c36_i4];
  }
  ...
  do {
    ...
    c36_x = c36_e / 2.0;
    c36_ed2 = c36_x;
    c36_ed2 = muDoubleScalarFloor(c36_ed2);
    if (2.0 * c36_ed2 != c36_e) {
      if (c36_firstmult) {
        for (c36_i5 = 0; c36_i5 < 9; c36_i5++) {
          c36_y[c36_i5] = c36_a[c36_i5];
        }

        c36_firstmult = false;
      } else {
        for (c36_i6 = 0; c36_i6 < 9; c36_i6++) {
          c36_b_a[c36_i6] = c36_y[c36_i6];
        }

        c36_eml_scalar_eg(chartInstance);
        c36_eml_scalar_eg(chartInstance);
        for (c36_i7 = 0; c36_i7 < 9; c36_i7++) {
          c36_y[c36_i7] = 0.0;
        }
        ...
        for (c36_i9 = 0; c36_i9 < 9; c36_i9++) {
          c36_dv1[c36_i9] = c36_b_a[c36_i9];
        }

        for (c36_i10 = 0; c36_i10 < 9; c36_i10++) {
          c36_dv2[c36_i10] = c36_a[c36_i10];
        }

        for (c36_i11 = 0; c36_i11 < 9; c36_i11++) {
          c36_dv3[c36_i11] = c36_dv1[c36_i11];
        }

        for (c36_i12 = 0; c36_i12 < 9; c36_i12++) {
          c36_dv4[c36_i12] = c36_dv2[c36_i12];
        }

        c36_b_eml_xgemm(chartInstance, c36_dv3, c36_dv4, c36_y);
      }
    }
    ...
    if (c36_ed2 == 0.0) {
      ...
      c36_e = c36_ed2;
      for (c36_i15 = 0; c36_i15 < 9; c36_i15++) {
        c36_b_a[c36_i15] = c36_a[c36_i15];
      }

      c36_eml_scalar_eg(chartInstance);
      c36_eml_scalar_eg(chartInstance);
      for (c36_i16 = 0; c36_i16 < 9; c36_i16++) {
        c36_a[c36_i16] = 0.0;
      }

      for (c36_i17 = 0; c36_i17 < 9; c36_i17++) {
        c36_c_a[c36_i17] = c36_b_a[c36_i17];
      }

      for (c36_i18 = 0; c36_i18 < 9; c36_i18++) {
        c36_d_a[c36_i18] = c36_b_a[c36_i18];
      }

      c36_b_eml_xgemm(chartInstance, c36_c_a, c36_d_a, c36_a);
    }
  } while (exitg1 == 0);

  _SFD_EML_CALL(0U, chartInstance->c36_sfEvent, -4);
  _SFD_SYMBOL_SCOPE_POP();
  for (c36_i13 = 0; c36_i13 < 9; c36_i13++) {
    (*c36_b_y)[c36_i13] = c36_y[c36_i13];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 24U, chartInstance->c36_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_CSE1_Oculus_gestureMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c36_i14 = 0; c36_i14 < 9; c36_i14++) {
    _SFD_DATA_RANGE_CHECK((*c36_b_y)[c36_i14], 1U);
  }
}
  ...
  *c36_inData)
{
  ...
  const mxArray *c36_y = NULL;
  SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance;
  chartInstance = (SFc36_CSE1_Oculus_gestureInstanceStruct *)chartInstanceVoid;
  c36_mxArrayOutData = NULL;
  c36_i19 = 0;
  for (c36_i20 = 0; c36_i20 < 3; c36_i20++) {
    for (c36_i21 = 0; c36_i21 < 3; c36_i21++) {
      c36_b_inData[c36_i21 + c36_i19] = (*(real_T (*)[9])c36_inData)[c36_i21 +
        c36_i19];
    }
  ...
  for (c36_i23 = 0; c36_i23 < 3; c36_i23++) {
    for (c36_i24 = 0; c36_i24 < 3; c36_i24++) {
      c36_u[c36_i24 + c36_i22] = c36_b_inData[c36_i24 + c36_i22];
    }
  ...
  real_T c36_y[9])
{
  ...
  int32_T c36_i25;
  (void)chartInstance;
  sf_mex_import(c36_parentId, sf_mex_dup(c36_u), c36_dv5, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c36_i25 = 0; c36_i25 < 9; c36_i25++) {
  ...
  *c36_mxArrayInData, const char_T *c36_varName, void *c36_outData)
{
  ...
  sf_mex_destroy(&c36_y);
  c36_i26 = 0;
  for (c36_i27 = 0; c36_i27 < 3; c36_i27++) {
    for (c36_i28 = 0; c36_i28 < 3; c36_i28++) {
      (*(real_T (*)[9])c36_outData)[c36_i28 + c36_i26] = c36_b_y[c36_i28 +
        c36_i26];
    }
...
const mxArray *sf_c36_CSE1_Oculus_gesture_get_eml_resolved_functions_info(void)
{
  const mxArray *c36_nameCaptureInfo = NULL;
  c36_nameCaptureInfo = NULL;
  sf_mex_assign(&c36_nameCaptureInfo, sf_mex_createstruct("structure", 2, 20, 1),
                false);
...
static void c36_info_helper(const mxArray **c36_info)
{
  ...
  sf_mex_addfield(*c36_info, c36_emlrt_marshallOut("mpower"), "name", "name", 0);
  ...
  sf_mex_addfield(*c36_info, c36_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1363713878U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c36_info, c36_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/isBuiltInNumeric.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1363714556U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c36_info, c36_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/ismatrix.m"), "resolved",
                  "resolved", 2);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1331304858U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c36_info, c36_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_floor.m"),
                  "resolved", "resolved", 3);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1286818726U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c36_info, c36_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m"), "resolved",
                  "resolved", 4);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1375980688U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c36_info, c36_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/scalarEg.p"),
                  "resolved", "resolved", 5);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1389307920U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c36_info, c36_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_abs.m"),
                  "resolved", "resolved", 6);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1286818712U), "fileTimeLo",
                  "fileTimeLo", 6);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 6);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c36_info, c36_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/eml_mtimes_helper.m"),
                  "resolved", "resolved", 8);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1383877294U), "fileTimeLo",
                  "fileTimeLo", 8);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 8);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1323170578U), "fileTimeLo",
                  "fileTimeLo", 10);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 10);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1375980690U), "fileTimeLo",
                  "fileTimeLo", 12);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 12);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1389307922U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(1381850300U), "fileTimeLo",
                  "fileTimeLo", 17);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 17);
  sf_mex_addfield(*c36_info, c36_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  real_T c36_A[9], real_T c36_B[9], real_T c36_C[9], real_T c36_b_C[9])
{
  ...
  int32_T c36_i31;
  real_T c36_b_B[9];
  for (c36_i29 = 0; c36_i29 < 9; c36_i29++) {
    c36_b_C[c36_i29] = c36_C[c36_i29];
  }

  for (c36_i30 = 0; c36_i30 < 9; c36_i30++) {
    c36_b_A[c36_i30] = c36_A[c36_i30];
  }

  for (c36_i31 = 0; c36_i31 < 9; c36_i31++) {
    c36_b_B[c36_i31] = c36_B[c36_i31];
  }
  ...
  char_T *c36_identifier)
{
  ...
  c36_y = c36_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c36_b_is_active_c36_CSE1_Oculus_gesture), &c36_thisId);
  sf_mex_destroy(&c36_b_is_active_c36_CSE1_Oculus_gesture);
  return c36_y;
}
  ...
  *chartInstance, real_T c36_A[9], real_T c36_B[9], real_T c36_C[9])
{
  ...
  for (c36_i33 = 0; c36_i33 < 3; c36_i33++) {
    ...
    for (c36_i35 = 0; c36_i35 < 3; c36_i35++) {
      c36_C[c36_i34 + c36_i33] = 0.0;
      c36_i36 = 0;
      for (c36_i37 = 0; c36_i37 < 3; c36_i37++) {
        c36_C[c36_i34 + c36_i33] += c36_A[c36_i36 + c36_i33] * c36_B[c36_i37 +
          c36_i34];
        c36_i36 += 3;
      }
...
void sf_c36_CSE1_Oculus_gesture_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(246233720U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3030906467U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(549453109U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1241832105U);
}

mxArray *sf_c36_CSE1_Oculus_gesture_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("92SLWohpEAmhoXTqpQULWG");
...
mxArray *sf_c36_CSE1_Oculus_gesture_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c36_CSE1_Oculus_gesture_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c36_CSE1_Oculus_gesture(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c36_CSE1_Oculus_gesture\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c36_CSE1_Oculus_gesture_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc36_CSE1_Oculus_gestureInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c36_y)[9];
          c36_y = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
          c36_w_d = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c36_w_d);
...
{
  return "u0gkPrcSnwp5HCiYXCSOEG";
}

static void sf_opaque_initialize_c36_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc36_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c36_CSE1_Oculus_gesture
    ((SFc36_CSE1_Oculus_gestureInstanceStruct*) chartInstanceVar);
  initialize_c36_CSE1_Oculus_gesture((SFc36_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c36_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  enable_c36_CSE1_Oculus_gesture((SFc36_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c36_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  disable_c36_CSE1_Oculus_gesture((SFc36_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c36_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  sf_gateway_c36_CSE1_Oculus_gesture((SFc36_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c36_CSE1_Oculus_gesture
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c36_CSE1_Oculus_gesture
    ((SFc36_CSE1_Oculus_gestureInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c36_CSE1_Oculus_gesture();/* state var info */
...
extern void sf_internal_set_sim_state_c36_CSE1_Oculus_gesture(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c36_CSE1_Oculus_gesture();/* state var info */
  ...
  set_sim_state_c36_CSE1_Oculus_gesture((SFc36_CSE1_Oculus_gestureInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c36_CSE1_Oculus_gesture(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c36_CSE1_Oculus_gesture(S);
}

static void sf_opaque_set_sim_state_c36_CSE1_Oculus_gesture(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c36_CSE1_Oculus_gesture(S, st);
}

static void sf_opaque_terminate_c36_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc36_CSE1_Oculus_gestureInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c36_CSE1_Oculus_gesture((SFc36_CSE1_Oculus_gestureInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc36_CSE1_Oculus_gesture((SFc36_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c36_CSE1_Oculus_gesture(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c36_CSE1_Oculus_gesture
      ((SFc36_CSE1_Oculus_gestureInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c36_CSE1_Oculus_gesture(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1977982277U));
  ssSetChecksum1(S,(917678457U));
  ssSetChecksum2(S,(3033317514U));
  ssSetChecksum3(S,(2150499566U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c36_CSE1_Oculus_gesture(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c36_CSE1_Oculus_gesture(SimStruct *S)
{
  SFc36_CSE1_Oculus_gestureInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc36_CSE1_Oculus_gestureInstanceStruct *)utMalloc(sizeof
    (SFc36_CSE1_Oculus_gestureInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc36_CSE1_Oculus_gestureInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c36_CSE1_Oculus_gesture;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c36_CSE1_Oculus_gesture;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c36_CSE1_Oculus_gesture;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c36_CSE1_Oculus_gesture;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c36_CSE1_Oculus_gesture;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c36_CSE1_Oculus_gesture;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c36_CSE1_Oculus_gesture;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c36_CSE1_Oculus_gesture;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c36_CSE1_Oculus_gesture;
  chartInstance->chartInfo.mdlStart = mdlStart_c36_CSE1_Oculus_gesture;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c36_CSE1_Oculus_gesture;
...
void c36_CSE1_Oculus_gesture_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c36_CSE1_Oculus_gesture(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c36_CSE1_Oculus_gesture(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c36_CSE1_Oculus_gesture(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c36_CSE1_Oculus_gesture_method_dispatcher.\n"
