...
static const char * c4_debug_family_names[5] = { "nargin", "nargout", "w_d",
  "zeta", "y" };

/* Function Declarations */
static void initialize_c4_CSE1_Oculus_gesture
  (SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void initialize_params_c4_CSE1_Oculus_gesture
  (SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void enable_c4_CSE1_Oculus_gesture(SFc4_CSE1_Oculus_gestureInstanceStruct
  *chartInstance);
static void disable_c4_CSE1_Oculus_gesture
  (SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_CSE1_Oculus_gesture
  (SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_CSE1_Oculus_gesture
  (SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void set_sim_state_c4_CSE1_Oculus_gesture
  (SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_CSE1_Oculus_gesture
  (SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void sf_gateway_c4_CSE1_Oculus_gesture
  (SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void initSimStructsc4_CSE1_Oculus_gesture
  (SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static void c4_emlrt_marshallIn(SFc4_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c4_y, const char_T *c4_identifier, real_T
  c4_b_y[9]);
static void c4_b_emlrt_marshallIn(SFc4_CSE1_Oculus_gestureInstanceStruct
...
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_c_emlrt_marshallIn(SFc4_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static void c4_eml_scalar_eg(SFc4_CSE1_Oculus_gestureInstanceStruct
  *chartInstance);
static void c4_eml_xgemm(SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance,
  real_T c4_A[9], real_T c4_B[9], real_T c4_C[9], real_T c4_b_C[9]);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_d_emlrt_marshallIn(SFc4_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_e_emlrt_marshallIn(SFc4_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_CSE1_Oculus_gesture, const
  char_T *c4_identifier);
static uint8_T c4_f_emlrt_marshallIn(SFc4_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_eml_xgemm(SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance,
  real_T c4_A[9], real_T c4_B[9], real_T c4_C[9]);
static void init_dsm_address_info(SFc4_CSE1_Oculus_gestureInstanceStruct
  *chartInstance);
  ...
  (SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_CSE1_Oculus_gesture = 0U;
}
  ...
  (SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  c4_hoistedGlobal = chartInstance->c4_is_active_c4_CSE1_Oculus_gesture;
  ...
  (SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_CSE1_Oculus_gesture = c4_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 1)),
     "is_active_c4_CSE1_Oculus_gesture");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_CSE1_Oculus_gesture(chartInstance);
  ...
  (SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  real_T (*c4_b_zeta)[9];
  real_T (*c4_b_w_d)[9];
  c4_b_zeta = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
  c4_b_y = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  c4_b_w_d = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  for (c4_i2 = 0; c4_i2 < 9; c4_i2++) {
    _SFD_DATA_RANGE_CHECK((*c4_b_w_d)[c4_i2], 0U);
  }

  chartInstance->c4_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  for (c4_i3 = 0; c4_i3 < 9; c4_i3++) {
    c4_w_d[c4_i3] = (*c4_b_w_d)[c4_i3];
  }

  for (c4_i4 = 0; c4_i4 < 9; c4_i4++) {
    c4_zeta[c4_i4] = (*c4_b_zeta)[c4_i4];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 1U, c4_b_sf_marshallOut,
    c4_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c4_w_d, 2U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c4_zeta, 3U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_y, 4U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 4);
  for (c4_i5 = 0; c4_i5 < 9; c4_i5++) {
    c4_b[c4_i5] = c4_zeta[c4_i5];
  }
  ...
  for (c4_i10 = 0; c4_i10 < 9; c4_i10++) {
    c4_dv1[c4_i10] = c4_b[c4_i10];
  }

  for (c4_i11 = 0; c4_i11 < 9; c4_i11++) {
    c4_dv2[c4_i11] = c4_b_b[c4_i11];
  }
  ...
  c4_b_eml_xgemm(chartInstance, c4_dv3, c4_dv4, c4_y);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, -4);
  _SFD_SYMBOL_SCOPE_POP();
  for (c4_i14 = 0; c4_i14 < 9; c4_i14++) {
    (*c4_b_y)[c4_i14] = c4_y[c4_i14];
  }
  ...
  for (c4_i15 = 0; c4_i15 < 9; c4_i15++) {
    _SFD_DATA_RANGE_CHECK((*c4_b_y)[c4_i15], 1U);
  }

  for (c4_i16 = 0; c4_i16 < 9; c4_i16++) {
    _SFD_DATA_RANGE_CHECK((*c4_b_zeta)[c4_i16], 2U);
  }
}
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance;
  chartInstance = (SFc4_CSE1_Oculus_gestureInstanceStruct *)chartInstanceVoid;
  ...
  real_T c4_y[9])
{
  ...
  int32_T c4_i23;
  (void)chartInstance;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_u), c4_dv5, 1, 0, 0U, 1, 0U, 2, 3, 3);
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  for (c4_i25 = 0; c4_i25 < 3; c4_i25++) {
    for (c4_i26 = 0; c4_i26 < 3; c4_i26++) {
      (*(real_T (*)[9])c4_outData)[c4_i26 + c4_i24] = c4_b_y[c4_i26 + c4_i24];
    }
...
const mxArray *sf_c4_CSE1_Oculus_gesture_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_CSE1_Oculus_gesture), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_CSE1_Oculus_gesture);
  return c4_y;
}
  ...
  real_T c4_A[9], real_T c4_B[9], real_T c4_C[9])
{
  ...
  for (c4_i31 = 0; c4_i31 < 3; c4_i31++) {
    ...
    for (c4_i33 = 0; c4_i33 < 3; c4_i33++) {
      c4_C[c4_i32 + c4_i31] = 0.0;
      c4_i34 = 0;
      for (c4_i35 = 0; c4_i35 < 3; c4_i35++) {
        c4_C[c4_i32 + c4_i31] += c4_A[c4_i34 + c4_i31] * c4_B[c4_i35 + c4_i32];
        c4_i34 += 3;
      }
...
void sf_c4_CSE1_Oculus_gesture_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_CSE1_Oculus_gesture_get_autoinheritance_info(void)
{
...
mxArray *sf_c4_CSE1_Oculus_gesture_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_CSE1_Oculus_gesture_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_CSE1_Oculus_gesture(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c4_CSE1_Oculus_gesture\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_CSE1_Oculus_gesture_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_CSE1_Oculus_gestureInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c4_y)[9];
          real_T (*c4_zeta)[9];
          c4_zeta = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 1);
          c4_y = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
          c4_w_d = (real_T (*)[9])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c4_w_d);
          _SFD_SET_DATA_VALUE_PTR(1U, *c4_y);
          _SFD_SET_DATA_VALUE_PTR(2U, *c4_zeta);
        }
      }
    } else {
...
static void sf_opaque_initialize_c4_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_CSE1_Oculus_gesture
    ((SFc4_CSE1_Oculus_gestureInstanceStruct*) chartInstanceVar);
  initialize_c4_CSE1_Oculus_gesture((SFc4_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  enable_c4_CSE1_Oculus_gesture((SFc4_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  disable_c4_CSE1_Oculus_gesture((SFc4_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  sf_gateway_c4_CSE1_Oculus_gesture((SFc4_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_CSE1_Oculus_gesture(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_CSE1_Oculus_gesture
    ((SFc4_CSE1_Oculus_gestureInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_CSE1_Oculus_gesture();/* state var info */
...
extern void sf_internal_set_sim_state_c4_CSE1_Oculus_gesture(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_CSE1_Oculus_gesture();/* state var info */
  ...
  set_sim_state_c4_CSE1_Oculus_gesture((SFc4_CSE1_Oculus_gestureInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_CSE1_Oculus_gesture(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c4_CSE1_Oculus_gesture(S);
}

static void sf_opaque_set_sim_state_c4_CSE1_Oculus_gesture(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_CSE1_Oculus_gesture(S, st);
}

static void sf_opaque_terminate_c4_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_CSE1_Oculus_gestureInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_CSE1_Oculus_gesture((SFc4_CSE1_Oculus_gestureInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_CSE1_Oculus_gesture((SFc4_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_CSE1_Oculus_gesture(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c4_CSE1_Oculus_gesture
      ((SFc4_CSE1_Oculus_gestureInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_CSE1_Oculus_gesture(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_CSE1_Oculus_gesture(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_CSE1_Oculus_gesture(SimStruct *S)
{
  SFc4_CSE1_Oculus_gestureInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_CSE1_Oculus_gestureInstanceStruct *)utMalloc(sizeof
    (SFc4_CSE1_Oculus_gestureInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_CSE1_Oculus_gestureInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_CSE1_Oculus_gesture;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_CSE1_Oculus_gesture;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_CSE1_Oculus_gesture;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_CSE1_Oculus_gesture;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_CSE1_Oculus_gesture;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_CSE1_Oculus_gesture;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_CSE1_Oculus_gesture;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_CSE1_Oculus_gesture;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_CSE1_Oculus_gesture;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_CSE1_Oculus_gesture;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_CSE1_Oculus_gesture;
...
void c4_CSE1_Oculus_gesture_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_CSE1_Oculus_gesture(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_CSE1_Oculus_gesture(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_CSE1_Oculus_gesture(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_CSE1_Oculus_gesture_method_dispatcher.\n"
