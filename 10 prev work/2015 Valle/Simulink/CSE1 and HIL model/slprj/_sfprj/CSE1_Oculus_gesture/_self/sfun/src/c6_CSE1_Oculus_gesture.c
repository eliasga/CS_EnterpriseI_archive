...
static void initialize_c6_CSE1_Oculus_gesture
  (SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void initialize_params_c6_CSE1_Oculus_gesture
  (SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void enable_c6_CSE1_Oculus_gesture(SFc6_CSE1_Oculus_gestureInstanceStruct
  *chartInstance);
static void disable_c6_CSE1_Oculus_gesture
  (SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_CSE1_Oculus_gesture
  (SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_CSE1_Oculus_gesture
  (SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void set_sim_state_c6_CSE1_Oculus_gesture
  (SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance, const mxArray *c6_st);
static void finalize_c6_CSE1_Oculus_gesture
  (SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void sf_gateway_c6_CSE1_Oculus_gesture
  (SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void initSimStructsc6_CSE1_Oculus_gesture
  (SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static void c6_emlrt_marshallIn(SFc6_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c6_Zeta, const char_T *c6_identifier, real_T
  c6_y[9]);
static void c6_b_emlrt_marshallIn(SFc6_CSE1_Oculus_gestureInstanceStruct
...
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_c_emlrt_marshallIn(SFc6_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
...
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_d_emlrt_marshallIn(SFc6_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_e_emlrt_marshallIn(SFc6_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_CSE1_Oculus_gesture, const
  char_T *c6_identifier);
static uint8_T c6_f_emlrt_marshallIn(SFc6_CSE1_Oculus_gestureInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_CSE1_Oculus_gestureInstanceStruct
  *chartInstance);
  ...
  (SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_CSE1_Oculus_gesture = 0U;
}
  ...
  (SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  real_T (*c6_Zeta)[9];
  c6_Zeta = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  c6_st = NULL;
  c6_st = NULL;
  c6_y = NULL;
  ...
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_CSE1_Oculus_gesture;
  ...
  (SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance, const mxArray *c6_st)
{
  ...
  chartInstance->c6_is_active_c6_CSE1_Oculus_gesture = c6_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 1)),
     "is_active_c6_CSE1_Oculus_gesture");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_CSE1_Oculus_gesture(chartInstance);
  ...
  (SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance)
{
  ...
  int32_T c6_i7;
  real_T (*c6_b_Zeta)[9];
  real_T (*c6_b_zeta_vector)[3];
  c6_b_zeta_vector = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  c6_b_Zeta = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c6_i2 = 0; c6_i2 < 3; c6_i2++) {
    c6_zeta_vector[c6_i2] = (*c6_b_zeta_vector)[c6_i2];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c6_nargout, 1U, c6_c_sf_marshallOut,
    c6_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c6_zeta_vector, 2U, c6_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c6_Zeta, 3U, c6_sf_marshallOut,
    c6_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, 4);
  for (c6_i3 = 0; c6_i3 < 3; c6_i3++) {
    c6_v[c6_i3] = c6_zeta_vector[c6_i3];
  }
  ...
  for (c6_j = 1; c6_j < 4; c6_j++) {
    c6_b_j = c6_j;
    c6_Zeta[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
               (real_T)c6_b_j), 1, 3, 1, 0) + 3 * (_SFD_EML_ARRAY_BOUNDS_CHECK(
               "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c6_b_j), 1, 3, 2, 0)
              - 1)) - 1] = c6_v[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c6_b_j), 1, 3, 1, 0) - 1];
  }

  _SFD_EML_CALL(0U, chartInstance->c6_sfEvent, -4);
  _SFD_SYMBOL_SCOPE_POP();
  for (c6_i5 = 0; c6_i5 < 9; c6_i5++) {
    (*c6_b_Zeta)[c6_i5] = c6_Zeta[c6_i5];
  }
  ...
  for (c6_i6 = 0; c6_i6 < 9; c6_i6++) {
    _SFD_DATA_RANGE_CHECK((*c6_b_Zeta)[c6_i6], 0U);
  }

  for (c6_i7 = 0; c6_i7 < 3; c6_i7++) {
    _SFD_DATA_RANGE_CHECK((*c6_b_zeta_vector)[c6_i7], 1U);
  }
}
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance;
  chartInstance = (SFc6_CSE1_Oculus_gestureInstanceStruct *)chartInstanceVoid;
  c6_mxArrayOutData = NULL;
  c6_i8 = 0;
  for (c6_i9 = 0; c6_i9 < 3; c6_i9++) {
    for (c6_i10 = 0; c6_i10 < 3; c6_i10++) {
      c6_b_inData[c6_i10 + c6_i8] = (*(real_T (*)[9])c6_inData)[c6_i10 + c6_i8];
    }
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  for (c6_i16 = 0; c6_i16 < 3; c6_i16++) {
    for (c6_i17 = 0; c6_i17 < 3; c6_i17++) {
      (*(real_T (*)[9])c6_outData)[c6_i17 + c6_i15] = c6_y[c6_i17 + c6_i15];
    }
  ...
  *c6_inData)
{
  ...
  for (c6_i18 = 0; c6_i18 < 3; c6_i18++) {
    c6_b_inData[c6_i18] = (*(real_T (*)[3])c6_inData)[c6_i18];
  }
...
const mxArray *sf_c6_CSE1_Oculus_gesture_get_eml_resolved_functions_info(void)
{
  const mxArray *c6_nameCaptureInfo = NULL;
  c6_nameCaptureInfo = NULL;
  sf_mex_assign(&c6_nameCaptureInfo, sf_mex_createstruct("structure", 2, 8, 1),
                false);
  ...
  char_T *c6_identifier)
{
  ...
  c6_y = c6_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_CSE1_Oculus_gesture), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_CSE1_Oculus_gesture);
  return c6_y;
}
...
void sf_c6_CSE1_Oculus_gesture_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_CSE1_Oculus_gesture_get_autoinheritance_info(void)
{
...
mxArray *sf_c6_CSE1_Oculus_gesture_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_CSE1_Oculus_gesture_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_CSE1_Oculus_gesture(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"Zeta\",},{M[8],M[0],T\"is_active_c6_CSE1_Oculus_gesture\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_CSE1_Oculus_gesture_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_CSE1_Oculus_gestureInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          real_T (*c6_Zeta)[9];
          real_T (*c6_zeta_vector)[3];
          c6_zeta_vector = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S,
            0);
          c6_Zeta = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, *c6_Zeta);
          _SFD_SET_DATA_VALUE_PTR(1U, *c6_zeta_vector);
        }
      }
    } else {
...
static void sf_opaque_initialize_c6_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_CSE1_Oculus_gesture
    ((SFc6_CSE1_Oculus_gestureInstanceStruct*) chartInstanceVar);
  initialize_c6_CSE1_Oculus_gesture((SFc6_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c6_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  enable_c6_CSE1_Oculus_gesture((SFc6_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c6_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  disable_c6_CSE1_Oculus_gesture((SFc6_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c6_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  sf_gateway_c6_CSE1_Oculus_gesture((SFc6_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_CSE1_Oculus_gesture(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_CSE1_Oculus_gesture
    ((SFc6_CSE1_Oculus_gestureInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_CSE1_Oculus_gesture();/* state var info */
...
extern void sf_internal_set_sim_state_c6_CSE1_Oculus_gesture(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_CSE1_Oculus_gesture();/* state var info */
  ...
  set_sim_state_c6_CSE1_Oculus_gesture((SFc6_CSE1_Oculus_gestureInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_CSE1_Oculus_gesture(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c6_CSE1_Oculus_gesture(S);
}

static void sf_opaque_set_sim_state_c6_CSE1_Oculus_gesture(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c6_CSE1_Oculus_gesture(S, st);
}

static void sf_opaque_terminate_c6_CSE1_Oculus_gesture(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_CSE1_Oculus_gestureInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_CSE1_Oculus_gesture((SFc6_CSE1_Oculus_gestureInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc6_CSE1_Oculus_gesture((SFc6_CSE1_Oculus_gestureInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_CSE1_Oculus_gesture(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c6_CSE1_Oculus_gesture
      ((SFc6_CSE1_Oculus_gestureInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_CSE1_Oculus_gesture(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_CSE1_Oculus_gesture(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_CSE1_Oculus_gesture(SimStruct *S)
{
  SFc6_CSE1_Oculus_gestureInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_CSE1_Oculus_gestureInstanceStruct *)utMalloc(sizeof
    (SFc6_CSE1_Oculus_gestureInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_CSE1_Oculus_gestureInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_CSE1_Oculus_gesture;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_CSE1_Oculus_gesture;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_CSE1_Oculus_gesture;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_CSE1_Oculus_gesture;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_CSE1_Oculus_gesture;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_CSE1_Oculus_gesture;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_CSE1_Oculus_gesture;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_CSE1_Oculus_gesture;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_CSE1_Oculus_gesture;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_CSE1_Oculus_gesture;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_CSE1_Oculus_gesture;
...
void c6_CSE1_Oculus_gesture_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_CSE1_Oculus_gesture(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_CSE1_Oculus_gesture(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_CSE1_Oculus_gesture(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_CSE1_Oculus_gesture_method_dispatcher.\n"
