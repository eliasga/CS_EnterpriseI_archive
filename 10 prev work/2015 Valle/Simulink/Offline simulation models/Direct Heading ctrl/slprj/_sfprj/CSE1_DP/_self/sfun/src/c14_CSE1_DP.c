  ...
  c14_chartNumber, uint32_T c14_instanceNumber)
{
  ...
  _SFD_SCRIPT_TRANSLATION(c14_chartNumber, c14_instanceNumber, 0U,
    ...
    "C:\\Users\\Eirik Valle\\Dropbox\\NTNU\\Master\\Resultater\\Offline Simulation Results\\D.m"));
}
...
static void c14_info_helper(const mxArray **c14_info)
{
  ...
  sf_mex_addfield(*c14_info, c14_emlrt_marshallOut(
    "[E]C:/Users/Eirik Valle/Dropbox/NTNU/Master/Resultater/Offline Simulation Results/D.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c14_info, c14_b_emlrt_marshallOut(1429443650U), "fileTimeLo",
                  "fileTimeLo", 0);
...
static void mdlSetWorkWidths_c14_CSE1_DP(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2430824211U));
  ssSetChecksum1(S,(334837515U));
  ssSetChecksum2(S,(3276474442U));
  ssSetChecksum3(S,(1205578365U));
