...
static void initialize_c24_CSE1_DP(SFc24_CSE1_DPInstanceStruct *chartInstance);
static void initialize_params_c24_CSE1_DP(SFc24_CSE1_DPInstanceStruct
  *chartInstance);
static void enable_c24_CSE1_DP(SFc24_CSE1_DPInstanceStruct *chartInstance);
static void disable_c24_CSE1_DP(SFc24_CSE1_DPInstanceStruct *chartInstance);
static void c24_update_debugger_state_c24_CSE1_DP(SFc24_CSE1_DPInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c24_CSE1_DP(SFc24_CSE1_DPInstanceStruct
  *chartInstance);
static void set_sim_state_c24_CSE1_DP(SFc24_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c24_st);
static void finalize_c24_CSE1_DP(SFc24_CSE1_DPInstanceStruct *chartInstance);
static void sf_gateway_c24_CSE1_DP(SFc24_CSE1_DPInstanceStruct *chartInstance);
static void initSimStructsc24_CSE1_DP(SFc24_CSE1_DPInstanceStruct *chartInstance);
...
static const mxArray *c24_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static void c24_emlrt_marshallIn(SFc24_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c24_w_d, const char_T *c24_identifier, real_T c24_y[9]);
static void c24_b_emlrt_marshallIn(SFc24_CSE1_DPInstanceStruct *chartInstance,
...
static const mxArray *c24_c_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static real_T c24_c_emlrt_marshallIn(SFc24_CSE1_DPInstanceStruct *chartInstance,
...
static const mxArray *c24_d_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static int32_T c24_d_emlrt_marshallIn(SFc24_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void c24_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData);
static uint8_T c24_e_emlrt_marshallIn(SFc24_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c24_b_is_active_c24_CSE1_DP, const char_T *c24_identifier);
static uint8_T c24_f_emlrt_marshallIn(SFc24_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void init_dsm_address_info(SFc24_CSE1_DPInstanceStruct *chartInstance);
...
static void initialize_c24_CSE1_DP(SFc24_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c24_is_active_c24_CSE1_DP = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T (*c24_w_d)[9];
  c24_w_d = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  c24_st = NULL;
  c24_st = NULL;
  c24_y = NULL;
  sf_mex_assign(&c24_y, sf_mex_createcellmatrix(2, 1), false);
  for (c24_i0 = 0; c24_i0 < 9; c24_i0++) {
    c24_u[c24_i0] = (*c24_w_d)[c24_i0];
  }
  ...
  c24_hoistedGlobal = chartInstance->c24_is_active_c24_CSE1_DP;
  ...
  const mxArray *c24_st)
{
  ...
  for (c24_i1 = 0; c24_i1 < 9; c24_i1++) {
    (*c24_w_d)[c24_i1] = c24_dv0[c24_i1];
  }

  chartInstance->c24_is_active_c24_CSE1_DP = c24_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c24_u, 1)),
     "is_active_c24_CSE1_DP");
  sf_mex_destroy(&c24_u);
  c24_update_debugger_state_c24_CSE1_DP(chartInstance);
...
static void sf_gateway_c24_CSE1_DP(SFc24_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  int32_T c24_i7;
  real_T (*c24_b_w_d)[9];
  real_T (*c24_b_w_d_vector)[3];
  c24_b_w_d_vector = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  c24_b_w_d = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 20U, chartInstance->c24_sfEvent);
  chartInstance->c24_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 20U, chartInstance->c24_sfEvent);
  for (c24_i2 = 0; c24_i2 < 3; c24_i2++) {
    c24_w_d_vector[c24_i2] = (*c24_b_w_d_vector)[c24_i2];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c24_nargout, 1U, c24_c_sf_marshallOut,
    c24_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c24_w_d_vector, 2U, c24_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c24_w_d, 3U, c24_sf_marshallOut,
    c24_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c24_sfEvent, 4);
  for (c24_i3 = 0; c24_i3 < 3; c24_i3++) {
    c24_v[c24_i3] = c24_w_d_vector[c24_i3];
  }
  ...
  for (c24_j = 1; c24_j < 4; c24_j++) {
    c24_b_j = c24_j;
    c24_w_d[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
               (real_T)c24_b_j), 1, 3, 1, 0) + 3 * (_SFD_EML_ARRAY_BOUNDS_CHECK(
               "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c24_b_j), 1, 3, 2, 0)
              - 1)) - 1] = c24_v[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c24_b_j), 1, 3, 1, 0) - 1];
  }

  _SFD_EML_CALL(0U, chartInstance->c24_sfEvent, -4);
  _SFD_SYMBOL_SCOPE_POP();
  for (c24_i5 = 0; c24_i5 < 9; c24_i5++) {
    (*c24_b_w_d)[c24_i5] = c24_w_d[c24_i5];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 20U, chartInstance->c24_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_CSE1_DPMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c24_i6 = 0; c24_i6 < 9; c24_i6++) {
    _SFD_DATA_RANGE_CHECK((*c24_b_w_d)[c24_i6], 0U);
  }

  for (c24_i7 = 0; c24_i7 < 3; c24_i7++) {
    _SFD_DATA_RANGE_CHECK((*c24_b_w_d_vector)[c24_i7], 1U);
  }
}
  ...
  *c24_inData)
{
  ...
  real_T c24_u[9];
  const mxArray *c24_y = NULL;
  SFc24_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc24_CSE1_DPInstanceStruct *)chartInstanceVoid;
  c24_mxArrayOutData = NULL;
  c24_i8 = 0;
  for (c24_i9 = 0; c24_i9 < 3; c24_i9++) {
    for (c24_i10 = 0; c24_i10 < 3; c24_i10++) {
      c24_b_inData[c24_i10 + c24_i8] = (*(real_T (*)[9])c24_inData)[c24_i10 +
        c24_i8];
    }
  ...
  const mxArray *c24_w_d, const char_T *c24_identifier, real_T c24_y[9])
{
  ...
  c24_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c24_w_d), &c24_thisId, c24_y);
  sf_mex_destroy(&c24_w_d);
}
  ...
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData)
{
  ...
  SFc24_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc24_CSE1_DPInstanceStruct *)chartInstanceVoid;
  c24_w_d = sf_mex_dup(c24_mxArrayInData);
  ...
  for (c24_i16 = 0; c24_i16 < 3; c24_i16++) {
    for (c24_i17 = 0; c24_i17 < 3; c24_i17++) {
      (*(real_T (*)[9])c24_outData)[c24_i17 + c24_i15] = c24_y[c24_i17 + c24_i15];
    }
  ...
  *c24_inData)
{
  ...
  for (c24_i18 = 0; c24_i18 < 3; c24_i18++) {
    c24_b_inData[c24_i18] = (*(real_T (*)[3])c24_inData)[c24_i18];
  }
...
const mxArray *sf_c24_CSE1_DP_get_eml_resolved_functions_info(void)
{
  const mxArray *c24_nameCaptureInfo = NULL;
  c24_nameCaptureInfo = NULL;
  sf_mex_assign(&c24_nameCaptureInfo, sf_mex_createstruct("structure", 2, 8, 1),
                false);
...
static void c24_info_helper(const mxArray **c24_info)
{
  ...
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut("diag"), "name", "name", 0);
  ...
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(1363713854U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m"), "context",
                  "context", 1);
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut("ismatrix"), "name", "name",
                  1);
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 1);
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/ismatrix.m"), "resolved",
                  "resolved", 1);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(1331304858U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/scalarEg.p"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(1389307920U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 6);
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut("intmax"), "name", "name", 6);
  ...
  sf_mex_addfield(*c24_info, c24_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_switch_helper.m"),
                  "resolved", "resolved", 7);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(1381850300U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c24_info, c24_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId)
{
  ...
  int32_T c24_i20;
  (void)chartInstance;
  sf_mex_import(c24_parentId, sf_mex_dup(c24_u), &c24_i20, 1, 6, 0U, 0, 0U, 0);
  c24_y = c24_i20;
  sf_mex_destroy(&c24_u);
  return c24_y;
}
  ...
  const mxArray *c24_b_is_active_c24_CSE1_DP, const char_T *c24_identifier)
{
  ...
  c24_y = c24_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c24_b_is_active_c24_CSE1_DP), &c24_thisId);
  sf_mex_destroy(&c24_b_is_active_c24_CSE1_DP);
  return c24_y;
}
...
void sf_c24_CSE1_DP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c24_CSE1_DP_get_autoinheritance_info(void)
{
...
mxArray *sf_c24_CSE1_DP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c24_CSE1_DP_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c24_CSE1_DP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"w_d\",},{M[8],M[0],T\"is_active_c24_CSE1_DP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c24_CSE1_DP_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc24_CSE1_DPInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          real_T (*c24_w_d)[9];
          real_T (*c24_w_d_vector)[3];
          c24_w_d_vector = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S,
            0);
          c24_w_d = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, *c24_w_d);
          _SFD_SET_DATA_VALUE_PTR(1U, *c24_w_d_vector);
        }
      }
    } else {
...
static void sf_opaque_initialize_c24_CSE1_DP(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc24_CSE1_DPInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c24_CSE1_DP((SFc24_CSE1_DPInstanceStruct*) chartInstanceVar);
  initialize_c24_CSE1_DP((SFc24_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c24_CSE1_DP(void *chartInstanceVar)
{
  enable_c24_CSE1_DP((SFc24_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c24_CSE1_DP(void *chartInstanceVar)
{
  disable_c24_CSE1_DP((SFc24_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c24_CSE1_DP(void *chartInstanceVar)
{
  sf_gateway_c24_CSE1_DP((SFc24_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c24_CSE1_DP(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c24_CSE1_DP((SFc24_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c24_CSE1_DP();/* state var info */
...
extern void sf_internal_set_sim_state_c24_CSE1_DP(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c24_CSE1_DP();/* state var info */
  ...
  set_sim_state_c24_CSE1_DP((SFc24_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c24_CSE1_DP(SimStruct* S)
{
  return sf_internal_get_sim_state_c24_CSE1_DP(S);
}

static void sf_opaque_set_sim_state_c24_CSE1_DP(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c24_CSE1_DP(S, st);
}

static void sf_opaque_terminate_c24_CSE1_DP(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc24_CSE1_DPInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c24_CSE1_DP((SFc24_CSE1_DPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc24_CSE1_DP((SFc24_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c24_CSE1_DP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c24_CSE1_DP((SFc24_CSE1_DPInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c24_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c24_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c24_CSE1_DP(SimStruct *S)
{
  SFc24_CSE1_DPInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc24_CSE1_DPInstanceStruct *)utMalloc(sizeof
    (SFc24_CSE1_DPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc24_CSE1_DPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c24_CSE1_DP;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c24_CSE1_DP;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c24_CSE1_DP;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c24_CSE1_DP;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c24_CSE1_DP;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c24_CSE1_DP;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c24_CSE1_DP;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c24_CSE1_DP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c24_CSE1_DP;
  chartInstance->chartInfo.mdlStart = mdlStart_c24_CSE1_DP;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c24_CSE1_DP;
...
void c24_CSE1_DP_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c24_CSE1_DP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c24_CSE1_DP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c24_CSE1_DP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c24_CSE1_DP_method_dispatcher.\n"
