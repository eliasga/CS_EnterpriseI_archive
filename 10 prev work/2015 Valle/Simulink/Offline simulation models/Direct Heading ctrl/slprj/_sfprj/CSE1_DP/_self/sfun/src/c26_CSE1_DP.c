...
static const char * c26_debug_family_names[4] = { "nargin", "nargout", "K_d1",
  "K_d" };

/* Function Declarations */
static void initialize_c26_CSE1_DP(SFc26_CSE1_DPInstanceStruct *chartInstance);
static void initialize_params_c26_CSE1_DP(SFc26_CSE1_DPInstanceStruct
  *chartInstance);
static void enable_c26_CSE1_DP(SFc26_CSE1_DPInstanceStruct *chartInstance);
static void disable_c26_CSE1_DP(SFc26_CSE1_DPInstanceStruct *chartInstance);
static void c26_update_debugger_state_c26_CSE1_DP(SFc26_CSE1_DPInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c26_CSE1_DP(SFc26_CSE1_DPInstanceStruct
  *chartInstance);
static void set_sim_state_c26_CSE1_DP(SFc26_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c26_st);
static void finalize_c26_CSE1_DP(SFc26_CSE1_DPInstanceStruct *chartInstance);
static void sf_gateway_c26_CSE1_DP(SFc26_CSE1_DPInstanceStruct *chartInstance);
static void initSimStructsc26_CSE1_DP(SFc26_CSE1_DPInstanceStruct *chartInstance);
...
static const mxArray *c26_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static void c26_emlrt_marshallIn(SFc26_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c26_K_d, const char_T *c26_identifier, real_T c26_y[9]);
static void c26_b_emlrt_marshallIn(SFc26_CSE1_DPInstanceStruct *chartInstance,
...
static const mxArray *c26_c_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static real_T c26_c_emlrt_marshallIn(SFc26_CSE1_DPInstanceStruct *chartInstance,
...
static const mxArray *c26_d_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static int32_T c26_d_emlrt_marshallIn(SFc26_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
static void c26_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c26_mxArrayInData, const char_T *c26_varName, void *c26_outData);
static uint8_T c26_e_emlrt_marshallIn(SFc26_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c26_b_is_active_c26_CSE1_DP, const char_T *c26_identifier);
static uint8_T c26_f_emlrt_marshallIn(SFc26_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
static void init_dsm_address_info(SFc26_CSE1_DPInstanceStruct *chartInstance);
...
static void initialize_c26_CSE1_DP(SFc26_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c26_is_active_c26_CSE1_DP = 0U;
}
  ...
  *chartInstance)
{
  ...
  for (c26_i0 = 0; c26_i0 < 9; c26_i0++) {
    c26_u[c26_i0] = (*c26_K_d)[c26_i0];
  }

  c26_b_y = NULL;
  sf_mex_assign(&c26_b_y, sf_mex_create("y", c26_u, 0, 0U, 1U, 0U, 2, 3, 3),
                false);
  sf_mex_setcell(c26_y, 0, c26_b_y);
  c26_hoistedGlobal = chartInstance->c26_is_active_c26_CSE1_DP;
  ...
  *c26_inData)
{
  ...
  real_T c26_u[9];
  const mxArray *c26_y = NULL;
  SFc26_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc26_CSE1_DPInstanceStruct *)chartInstanceVoid;
  c26_mxArrayOutData = NULL;
  c26_i8 = 0;
  for (c26_i9 = 0; c26_i9 < 3; c26_i9++) {
    for (c26_i10 = 0; c26_i10 < 3; c26_i10++) {
      c26_b_inData[c26_i10 + c26_i8] = (*(real_T (*)[9])c26_inData)[c26_i10 +
        c26_i8];
    }
  ...
  for (c26_i12 = 0; c26_i12 < 3; c26_i12++) {
    for (c26_i13 = 0; c26_i13 < 3; c26_i13++) {
      c26_u[c26_i13 + c26_i11] = c26_b_inData[c26_i13 + c26_i11];
    }
  ...
  const mxArray *c26_K_d, const char_T *c26_identifier, real_T c26_y[9])
{
  ...
  c26_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c26_K_d), &c26_thisId, c26_y);
  sf_mex_destroy(&c26_K_d);
}
  ...
  const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId, real_T c26_y[9])
{
  ...
  sf_mex_import(c26_parentId, sf_mex_dup(c26_u), c26_dv1, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c26_i14 = 0; c26_i14 < 9; c26_i14++) {
    c26_y[c26_i14] = c26_dv1[c26_i14];
  }
  ...
  *c26_mxArrayInData, const char_T *c26_varName, void *c26_outData)
{
  ...
  SFc26_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc26_CSE1_DPInstanceStruct *)chartInstanceVoid;
  c26_K_d = sf_mex_dup(c26_mxArrayInData);
  ...
  for (c26_i16 = 0; c26_i16 < 3; c26_i16++) {
    for (c26_i17 = 0; c26_i17 < 3; c26_i17++) {
      (*(real_T (*)[9])c26_outData)[c26_i17 + c26_i15] = c26_y[c26_i17 + c26_i15];
    }
  ...
  *c26_inData)
{
  ...
  for (c26_i18 = 0; c26_i18 < 3; c26_i18++) {
    c26_b_inData[c26_i18] = (*(real_T (*)[3])c26_inData)[c26_i18];
  }

  for (c26_i19 = 0; c26_i19 < 3; c26_i19++) {
    c26_u[c26_i19] = c26_b_inData[c26_i19];
  }
...
const mxArray *sf_c26_CSE1_DP_get_eml_resolved_functions_info(void)
{
  const mxArray *c26_nameCaptureInfo = NULL;
  c26_nameCaptureInfo = NULL;
  sf_mex_assign(&c26_nameCaptureInfo, sf_mex_createstruct("structure", 2, 8, 1),
                false);
...
static void c26_info_helper(const mxArray **c26_info)
{
  ...
  sf_mex_addfield(*c26_info, c26_emlrt_marshallOut("diag"), "name", "name", 0);
  ...
  sf_mex_addfield(*c26_info, c26_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
                  "resolved", 6);
  sf_mex_addfield(*c26_info, c26_b_emlrt_marshallOut(1362261882U), "fileTimeLo",
                  "fileTimeLo", 6);
  sf_mex_addfield(*c26_info, c26_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 6);
  sf_mex_addfield(*c26_info, c26_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c26_info, c26_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_switch_helper.m"),
                  "resolved", "resolved", 7);
  sf_mex_addfield(*c26_info, c26_b_emlrt_marshallOut(1381850300U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c26_info, c26_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c26_info, c26_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId)
{
  ...
  int32_T c26_i20;
  (void)chartInstance;
  sf_mex_import(c26_parentId, sf_mex_dup(c26_u), &c26_i20, 1, 6, 0U, 0, 0U, 0);
  c26_y = c26_i20;
  sf_mex_destroy(&c26_u);
  return c26_y;
}
  ...
  const mxArray *c26_b_is_active_c26_CSE1_DP, const char_T *c26_identifier)
{
  ...
  c26_y = c26_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c26_b_is_active_c26_CSE1_DP), &c26_thisId);
  sf_mex_destroy(&c26_b_is_active_c26_CSE1_DP);
  return c26_y;
}
...
void sf_c26_CSE1_DP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c26_CSE1_DP_get_autoinheritance_info(void)
{
...
mxArray *sf_c26_CSE1_DP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c26_CSE1_DP_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c26_CSE1_DP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"K_d\",},{M[8],M[0],T\"is_active_c26_CSE1_DP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c26_CSE1_DP_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc26_CSE1_DPInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          real_T (*c26_K_d)[9];
          real_T (*c26_K_d1)[3];
          c26_K_d1 = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
          c26_K_d = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, *c26_K_d);
          _SFD_SET_DATA_VALUE_PTR(1U, *c26_K_d1);
        }
      }
    } else {
...
static void sf_opaque_initialize_c26_CSE1_DP(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc26_CSE1_DPInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c26_CSE1_DP((SFc26_CSE1_DPInstanceStruct*) chartInstanceVar);
  initialize_c26_CSE1_DP((SFc26_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c26_CSE1_DP(void *chartInstanceVar)
{
  enable_c26_CSE1_DP((SFc26_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c26_CSE1_DP(void *chartInstanceVar)
{
  disable_c26_CSE1_DP((SFc26_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c26_CSE1_DP(void *chartInstanceVar)
{
  sf_gateway_c26_CSE1_DP((SFc26_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c26_CSE1_DP(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c26_CSE1_DP((SFc26_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c26_CSE1_DP();/* state var info */
...
extern void sf_internal_set_sim_state_c26_CSE1_DP(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c26_CSE1_DP();/* state var info */
  ...
  set_sim_state_c26_CSE1_DP((SFc26_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c26_CSE1_DP(SimStruct* S)
{
  return sf_internal_get_sim_state_c26_CSE1_DP(S);
}

static void sf_opaque_set_sim_state_c26_CSE1_DP(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c26_CSE1_DP(S, st);
}

static void sf_opaque_terminate_c26_CSE1_DP(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc26_CSE1_DPInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c26_CSE1_DP((SFc26_CSE1_DPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc26_CSE1_DP((SFc26_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c26_CSE1_DP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c26_CSE1_DP((SFc26_CSE1_DPInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c26_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c26_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c26_CSE1_DP(SimStruct *S)
{
  SFc26_CSE1_DPInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc26_CSE1_DPInstanceStruct *)utMalloc(sizeof
    (SFc26_CSE1_DPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc26_CSE1_DPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c26_CSE1_DP;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c26_CSE1_DP;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c26_CSE1_DP;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c26_CSE1_DP;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c26_CSE1_DP;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c26_CSE1_DP;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c26_CSE1_DP;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c26_CSE1_DP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c26_CSE1_DP;
  chartInstance->chartInfo.mdlStart = mdlStart_c26_CSE1_DP;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c26_CSE1_DP;
...
void c26_CSE1_DP_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c26_CSE1_DP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c26_CSE1_DP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c26_CSE1_DP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c26_CSE1_DP_method_dispatcher.\n"
