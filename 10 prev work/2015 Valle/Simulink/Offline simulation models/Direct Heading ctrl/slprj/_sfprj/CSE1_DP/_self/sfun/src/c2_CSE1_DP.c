...
static void initialize_c2_CSE1_DP(SFc2_CSE1_DPInstanceStruct *chartInstance);
static void initialize_params_c2_CSE1_DP(SFc2_CSE1_DPInstanceStruct
  *chartInstance);
static void enable_c2_CSE1_DP(SFc2_CSE1_DPInstanceStruct *chartInstance);
static void disable_c2_CSE1_DP(SFc2_CSE1_DPInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_CSE1_DP(SFc2_CSE1_DPInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_CSE1_DP(SFc2_CSE1_DPInstanceStruct
  *chartInstance);
static void set_sim_state_c2_CSE1_DP(SFc2_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c2_st);
static void finalize_c2_CSE1_DP(SFc2_CSE1_DPInstanceStruct *chartInstance);
static void sf_gateway_c2_CSE1_DP(SFc2_CSE1_DPInstanceStruct *chartInstance);
static void initSimStructsc2_CSE1_DP(SFc2_CSE1_DPInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_CSE1_DPInstanceStruct *chartInstance, const
  mxArray *c2_y, const char_T *c2_identifier, real_T c2_b_y[9]);
static void c2_b_emlrt_marshallIn(SFc2_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[9]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_CSE1_DPInstanceStruct *chartInstance,
...
static void c2_eml_scalar_eg(SFc2_CSE1_DPInstanceStruct *chartInstance);
static void c2_eml_xgemm(SFc2_CSE1_DPInstanceStruct *chartInstance, real_T c2_A
  [9], real_T c2_B[9], real_T c2_C[9], real_T c2_b_C[9]);
static void c2_inv3x3(SFc2_CSE1_DPInstanceStruct *chartInstance, real_T c2_x[9],
                      real_T c2_y[9]);
static real_T c2_norm(SFc2_CSE1_DPInstanceStruct *chartInstance, real_T c2_x[9]);
static void c2_eml_warning(SFc2_CSE1_DPInstanceStruct *chartInstance);
static void c2_b_eml_warning(SFc2_CSE1_DPInstanceStruct *chartInstance, char_T
  c2_varargin_2[14]);
static void c2_d_emlrt_marshallIn(SFc2_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c2_sprintf, const char_T *c2_identifier, char_T c2_y[14]);
static void c2_e_emlrt_marshallIn(SFc2_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, char_T c2_y[14]);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_f_emlrt_marshallIn(SFc2_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_g_emlrt_marshallIn(SFc2_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_CSE1_DP, const char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn(SFc2_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_eml_xgemm(SFc2_CSE1_DPInstanceStruct *chartInstance, real_T
  c2_A[9], real_T c2_B[9], real_T c2_C[9]);
static void init_dsm_address_info(SFc2_CSE1_DPInstanceStruct *chartInstance);
...
static void initialize_c2_CSE1_DP(SFc2_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_CSE1_DP = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_CSE1_DP;
  ...
  const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_CSE1_DP = c2_g_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 1)), "is_active_c2_CSE1_DP");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_CSE1_DP(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u[9];
  const mxArray *c2_y = NULL;
  SFc2_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc2_CSE1_DPInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_CSE1_DP_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_b_is_active_c2_CSE1_DP, const char_T *c2_identifier)
{
  ...
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_CSE1_DP), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_CSE1_DP);
  return c2_y;
}
...
void sf_c2_CSE1_DP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_CSE1_DP_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_CSE1_DP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_CSE1_DP_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_CSE1_DP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_CSE1_DP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_CSE1_DP_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_CSE1_DPInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c2_CSE1_DP(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_CSE1_DPInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c2_CSE1_DP((SFc2_CSE1_DPInstanceStruct*) chartInstanceVar);
  initialize_c2_CSE1_DP((SFc2_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_CSE1_DP(void *chartInstanceVar)
{
  enable_c2_CSE1_DP((SFc2_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_CSE1_DP(void *chartInstanceVar)
{
  disable_c2_CSE1_DP((SFc2_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_CSE1_DP(void *chartInstanceVar)
{
  sf_gateway_c2_CSE1_DP((SFc2_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_CSE1_DP(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_CSE1_DP((SFc2_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_CSE1_DP();/* state var info */
...
extern void sf_internal_set_sim_state_c2_CSE1_DP(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_CSE1_DP();/* state var info */
  ...
  set_sim_state_c2_CSE1_DP((SFc2_CSE1_DPInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_CSE1_DP(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_CSE1_DP(S);
}

static void sf_opaque_set_sim_state_c2_CSE1_DP(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_CSE1_DP(S, st);
}

static void sf_opaque_terminate_c2_CSE1_DP(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_CSE1_DPInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_CSE1_DP((SFc2_CSE1_DPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_CSE1_DP((SFc2_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_CSE1_DP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_CSE1_DP((SFc2_CSE1_DPInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_CSE1_DP(SimStruct *S)
{
  SFc2_CSE1_DPInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_CSE1_DPInstanceStruct *)utMalloc(sizeof
    (SFc2_CSE1_DPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_CSE1_DPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_CSE1_DP;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_CSE1_DP;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_CSE1_DP;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_CSE1_DP;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_CSE1_DP;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_CSE1_DP;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_CSE1_DP;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_CSE1_DP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_CSE1_DP;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_CSE1_DP;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_CSE1_DP;
...
void c2_CSE1_DP_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_CSE1_DP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_CSE1_DP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_CSE1_DP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_CSE1_DP_method_dispatcher.\n"
