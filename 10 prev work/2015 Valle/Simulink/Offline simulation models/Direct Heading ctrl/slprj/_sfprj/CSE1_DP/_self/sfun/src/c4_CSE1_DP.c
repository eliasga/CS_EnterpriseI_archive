...
static void initialize_c4_CSE1_DP(SFc4_CSE1_DPInstanceStruct *chartInstance);
static void initialize_params_c4_CSE1_DP(SFc4_CSE1_DPInstanceStruct
  *chartInstance);
static void enable_c4_CSE1_DP(SFc4_CSE1_DPInstanceStruct *chartInstance);
static void disable_c4_CSE1_DP(SFc4_CSE1_DPInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_CSE1_DP(SFc4_CSE1_DPInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c4_CSE1_DP(SFc4_CSE1_DPInstanceStruct
  *chartInstance);
static void set_sim_state_c4_CSE1_DP(SFc4_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c4_st);
static void finalize_c4_CSE1_DP(SFc4_CSE1_DPInstanceStruct *chartInstance);
static void sf_gateway_c4_CSE1_DP(SFc4_CSE1_DPInstanceStruct *chartInstance);
static void initSimStructsc4_CSE1_DP(SFc4_CSE1_DPInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static void c4_emlrt_marshallIn(SFc4_CSE1_DPInstanceStruct *chartInstance, const
  mxArray *c4_y, const char_T *c4_identifier, real_T c4_b_y[9]);
static void c4_b_emlrt_marshallIn(SFc4_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[9]);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_c_emlrt_marshallIn(SFc4_CSE1_DPInstanceStruct *chartInstance,
...
static void c4_eml_scalar_eg(SFc4_CSE1_DPInstanceStruct *chartInstance);
static void c4_eml_xgemm(SFc4_CSE1_DPInstanceStruct *chartInstance, real_T c4_A
  [9], real_T c4_B[9], real_T c4_C[9], real_T c4_b_C[9]);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_d_emlrt_marshallIn(SFc4_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_e_emlrt_marshallIn(SFc4_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c4_b_is_active_c4_CSE1_DP, const char_T *c4_identifier);
static uint8_T c4_f_emlrt_marshallIn(SFc4_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_eml_xgemm(SFc4_CSE1_DPInstanceStruct *chartInstance, real_T
  c4_A[9], real_T c4_B[9], real_T c4_C[9]);
static void init_dsm_address_info(SFc4_CSE1_DPInstanceStruct *chartInstance);
...
static void initialize_c4_CSE1_DP(SFc4_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_CSE1_DP = 0U;
}
  ...
  *chartInstance)
{
  ...
  c4_hoistedGlobal = chartInstance->c4_is_active_c4_CSE1_DP;
  ...
  const mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_CSE1_DP = c4_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 1)), "is_active_c4_CSE1_DP");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_CSE1_DP(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  real_T c4_u[9];
  const mxArray *c4_y = NULL;
  SFc4_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc4_CSE1_DPInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_CSE1_DP_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c4_b_is_active_c4_CSE1_DP, const char_T *c4_identifier)
{
  ...
  c4_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_CSE1_DP), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_CSE1_DP);
  return c4_y;
}
...
void sf_c4_CSE1_DP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_CSE1_DP_get_autoinheritance_info(void)
{
...
mxArray *sf_c4_CSE1_DP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_CSE1_DP_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_CSE1_DP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c4_CSE1_DP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_CSE1_DP_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_CSE1_DPInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c4_CSE1_DP(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_CSE1_DPInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c4_CSE1_DP((SFc4_CSE1_DPInstanceStruct*) chartInstanceVar);
  initialize_c4_CSE1_DP((SFc4_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_CSE1_DP(void *chartInstanceVar)
{
  enable_c4_CSE1_DP((SFc4_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_CSE1_DP(void *chartInstanceVar)
{
  disable_c4_CSE1_DP((SFc4_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_CSE1_DP(void *chartInstanceVar)
{
  sf_gateway_c4_CSE1_DP((SFc4_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_CSE1_DP(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_CSE1_DP((SFc4_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_CSE1_DP();/* state var info */
...
extern void sf_internal_set_sim_state_c4_CSE1_DP(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_CSE1_DP();/* state var info */
  ...
  set_sim_state_c4_CSE1_DP((SFc4_CSE1_DPInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_CSE1_DP(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_CSE1_DP(S);
}

static void sf_opaque_set_sim_state_c4_CSE1_DP(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_CSE1_DP(S, st);
}

static void sf_opaque_terminate_c4_CSE1_DP(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_CSE1_DPInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_CSE1_DP((SFc4_CSE1_DPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_CSE1_DP((SFc4_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_CSE1_DP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c4_CSE1_DP((SFc4_CSE1_DPInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_CSE1_DP(SimStruct *S)
{
  SFc4_CSE1_DPInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_CSE1_DPInstanceStruct *)utMalloc(sizeof
    (SFc4_CSE1_DPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_CSE1_DPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_CSE1_DP;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_CSE1_DP;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_CSE1_DP;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_CSE1_DP;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_CSE1_DP;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_CSE1_DP;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_CSE1_DP;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c4_CSE1_DP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_CSE1_DP;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_CSE1_DP;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_CSE1_DP;
...
void c4_CSE1_DP_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_CSE1_DP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_CSE1_DP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_CSE1_DP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_CSE1_DP_method_dispatcher.\n"
