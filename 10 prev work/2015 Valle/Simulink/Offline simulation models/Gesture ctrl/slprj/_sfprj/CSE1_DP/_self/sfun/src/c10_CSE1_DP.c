...
static const char * c10_debug_family_names[57] = { "u", "v", "r", "tau", "m",
  "I_z", "x_g", "X_ud", "Y_vd", "N_vd", "Y_rd", "N_rd", "m_11", "m_22", "m_23",
  "m_32", "m_33", "M", "X_u", "X_v", "X_uu", "X_vv", "X_uuu", "X_vvv", "Y_v",
  "Y_r", "Y_vv", "Y_rr", "Y_vvv", "Y_rrr", "Y_rv", "Y_vr", "N_v", "N_r", "N_vv",
  "N_rr", "N_vvv", "N_rrr", "N_rv", "N_vr", "c_13", "c_23", "C", "d_11", "d_22",
  "d_33", "d_12", "d_23", "d_32", "D", "nargin", "nargout", "tau_u", "tau_v",
  "tau_r", "nu", "nu_dot" };

/* Function Declarations */
static void initialize_c10_CSE1_DP(SFc10_CSE1_DPInstanceStruct *chartInstance);
static void initialize_params_c10_CSE1_DP(SFc10_CSE1_DPInstanceStruct
  *chartInstance);
static void enable_c10_CSE1_DP(SFc10_CSE1_DPInstanceStruct *chartInstance);
static void disable_c10_CSE1_DP(SFc10_CSE1_DPInstanceStruct *chartInstance);
static void c10_update_debugger_state_c10_CSE1_DP(SFc10_CSE1_DPInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c10_CSE1_DP(SFc10_CSE1_DPInstanceStruct
  *chartInstance);
static void set_sim_state_c10_CSE1_DP(SFc10_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c10_st);
static void finalize_c10_CSE1_DP(SFc10_CSE1_DPInstanceStruct *chartInstance);
static void sf_gateway_c10_CSE1_DP(SFc10_CSE1_DPInstanceStruct *chartInstance);
static void c10_chartstep_c10_CSE1_DP(SFc10_CSE1_DPInstanceStruct *chartInstance);
static void initSimStructsc10_CSE1_DP(SFc10_CSE1_DPInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber, uint32_T c10_instanceNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_emlrt_marshallIn(SFc10_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c10_nu_dot, const char_T *c10_identifier, real_T c10_y[3]);
static void c10_b_emlrt_marshallIn(SFc10_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId, real_T c10_y[3]);
static void c10_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_c_emlrt_marshallIn(SFc10_CSE1_DPInstanceStruct *chartInstance,
...
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_d_emlrt_marshallIn(SFc10_CSE1_DPInstanceStruct *chartInstance,
...
static real_T c10_mpower(SFc10_CSE1_DPInstanceStruct *chartInstance, real_T
  c10_a);
static void c10_eml_scalar_eg(SFc10_CSE1_DPInstanceStruct *chartInstance);
static void c10_b_eml_scalar_eg(SFc10_CSE1_DPInstanceStruct *chartInstance);
static void c10_eml_xgemm(SFc10_CSE1_DPInstanceStruct *chartInstance, real_T
  c10_A[9], real_T c10_B[3], real_T c10_C[3], real_T c10_b_C[3]);
static void c10_mldivide(SFc10_CSE1_DPInstanceStruct *chartInstance, real_T
  c10_A[9], real_T c10_B[3], real_T c10_Y[3]);
static void c10_eml_warning(SFc10_CSE1_DPInstanceStruct *chartInstance);
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_e_emlrt_marshallIn(SFc10_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint8_T c10_f_emlrt_marshallIn(SFc10_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c10_b_is_active_c10_CSE1_DP, const char_T *c10_identifier);
static uint8_T c10_g_emlrt_marshallIn(SFc10_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_b_eml_xgemm(SFc10_CSE1_DPInstanceStruct *chartInstance, real_T
  c10_A[9], real_T c10_B[3], real_T c10_C[3]);
static void init_dsm_address_info(SFc10_CSE1_DPInstanceStruct *chartInstance);
...
static void initialize_c10_CSE1_DP(SFc10_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_CSE1_DP = 0U;
}
  ...
  const mxArray *c10_st)
{
  ...
  for (c10_i1 = 0; c10_i1 < 3; c10_i1++) {
    (*c10_nu_dot)[c10_i1] = c10_dv0[c10_i1];
  }

  chartInstance->c10_is_active_c10_CSE1_DP = c10_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 1)),
     "is_active_c10_CSE1_DP");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_CSE1_DP(chartInstance);
...
static void sf_gateway_c10_CSE1_DP(SFc10_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  real_T (*c10_nu)[3];
  real_T (*c10_nu_dot)[3];
  c10_nu = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 3);
  c10_nu_dot = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c10_tau_r = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c10_tau_v = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c10_tau_u = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 9U, chartInstance->c10_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c10_tau_u, 0U);
  _SFD_DATA_RANGE_CHECK(*c10_tau_v, 1U);
  _SFD_DATA_RANGE_CHECK(*c10_tau_r, 2U);
  chartInstance->c10_sfEvent = CALL_EVENT;
  c10_chartstep_c10_CSE1_DP(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_CSE1_DPMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c10_i2 = 0; c10_i2 < 3; c10_i2++) {
    _SFD_DATA_RANGE_CHECK((*c10_nu_dot)[c10_i2], 3U);
  }

  for (c10_i3 = 0; c10_i3 < 3; c10_i3++) {
    _SFD_DATA_RANGE_CHECK((*c10_nu)[c10_i3], 4U);
  }
}
...
static void c10_chartstep_c10_CSE1_DP(SFc10_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  int32_T c10_i4;
  real_T c10_nu[3];
  uint32_T c10_debug_family_var_map[57];
  real_T c10_u;
  real_T c10_v;
  real_T c10_r;
  real_T c10_tau[3];
  ...
  real_T c10_nu_dot[3];
  int32_T c10_i5;
  static real_T c10_dv1[9] = { 16.79, 0.0, 0.0, 0.0, 24.79, 0.55462499999999992,
  ...
  real_T *c10_b_tau_v;
  real_T *c10_b_tau_u;
  real_T (*c10_b_nu_dot)[3];
  real_T (*c10_b_nu)[3];
  c10_b_nu = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 3);
  c10_b_nu_dot = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c10_b_tau_r = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c10_b_tau_v = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c10_b_tau_u = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 9U, chartInstance->c10_sfEvent);
  c10_hoistedGlobal = *c10_b_tau_u;
  c10_b_hoistedGlobal = *c10_b_tau_v;
  c10_c_hoistedGlobal = *c10_b_tau_r;
  c10_tau_u = c10_hoistedGlobal;
  c10_tau_v = c10_b_hoistedGlobal;
  c10_tau_r = c10_c_hoistedGlobal;
  for (c10_i4 = 0; c10_i4 < 3; c10_i4++) {
    c10_nu[c10_i4] = (*c10_b_nu)[c10_i4];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 57U, 57U, c10_debug_family_names,
    c10_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_u, 0U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_v, 1U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_r, 2U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c10_tau, 3U, c10_sf_marshallOut,
    c10_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_m, 4U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_I_z, 5U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_x_g, 6U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_X_ud, 7U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_Y_vd, 8U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_N_vd, 9U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_Y_rd, 10U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_N_rd, 11U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_m_11, 12U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_m_22, 13U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_m_23, 14U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_m_32, 15U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_m_33, 16U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c10_M, 17U, c10_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_X_u, 18U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_X_v, 19U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_X_uu, 20U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_X_vv, 21U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_X_uuu, 22U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_X_vvv, 23U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_Y_v, 24U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_Y_r, 25U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_Y_vv, 26U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_Y_rr, 27U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_Y_vvv, 28U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_Y_rrr, 29U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_Y_rv, 30U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_Y_vr, 31U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_N_v, 32U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_N_r, 33U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_N_vv, 34U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_N_rr, 35U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_N_vvv, 36U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_N_rrr, 37U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_N_rv, 38U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_N_vr, 39U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_c_13, 40U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_c_23, 41U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c10_C, 42U, c10_c_sf_marshallOut,
    c10_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_d_11, 43U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_d_22, 44U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_d_33, 45U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_d_12, 46U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_d_23, 47U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_d_32, 48U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c10_D, 49U, c10_c_sf_marshallOut,
    c10_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_nargin, 50U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_nargout, 51U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_tau_u, 52U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_tau_v, 53U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c10_tau_r, 54U, c10_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c10_nu, 55U, c10_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c10_nu_dot, 56U, c10_sf_marshallOut,
    c10_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c10_c_13 = -24.79 * c10_v - 0.55462499999999992 * c10_r;
  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, 49);
  c10_c_23 = 16.79 * c10_u;
  ...
  c10_d_11 = (-c10_X_u - 0.3545 * c10_u) - -3.787 * c10_mpower(chartInstance,
    c10_u);
  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, 56);
  c10_x = c10_r;
  c10_b_x = c10_x;
  c10_y = muDoubleScalarAbs(c10_b_x);
  c10_d_22 = ((-c10_Y_v - -2.776 * c10_v) - -64.91 * c10_mpower(chartInstance,
    c10_v)) - -0.805 * c10_y;
  ...
  c10_e_x = c10_v;
  c10_f_x = c10_e_x;
  c10_c_y = muDoubleScalarAbs(c10_f_x);
  c10_d_33 = ((-c10_N_r - -0.75 * c10_b_y) - 0.0 * c10_mpower(chartInstance,
    c10_r)) - 0.08 * c10_c_y;
  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, 59);
  c10_d_12 = (-c10_X_v - -2.443 * c10_v) - 0.0 * c10_mpower(chartInstance, c10_v);
  ...
  c10_i_x = c10_v;
  c10_j_x = c10_i_x;
  c10_e_y = muDoubleScalarAbs(c10_j_x);
  c10_d_23 = ((-c10_Y_r - -3.45 * c10_d_y) - 0.0 * c10_mpower(chartInstance,
    c10_r)) - -0.845 * c10_e_y;
  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, 61);
  c10_k_x = c10_r;
  c10_l_x = c10_k_x;
  c10_f_y = muDoubleScalarAbs(c10_l_x);
  c10_d_32 = ((-c10_N_v - -0.2088 * c10_v) - 0.0 * c10_mpower(chartInstance,
    c10_v)) - 0.13 * c10_f_y;
  ...
  for (c10_i6 = 0; c10_i6 < 9; c10_i6++) {
    c10_a[c10_i6] = c10_C[c10_i6] + c10_D[c10_i6];
  }

  for (c10_i7 = 0; c10_i7 < 3; c10_i7++) {
    c10_b[c10_i7] = c10_nu[c10_i7];
  }
  ...
  for (c10_i9 = 0; c10_i9 < 9; c10_i9++) {
    c10_b_a[c10_i9] = c10_a[c10_i9];
  }

  for (c10_i10 = 0; c10_i10 < 3; c10_i10++) {
    c10_b_b[c10_i10] = c10_b[c10_i10];
  }

  c10_b_eml_xgemm(chartInstance, c10_b_a, c10_b_b, c10_g_y);
  for (c10_i11 = 0; c10_i11 < 9; c10_i11++) {
    c10_dv2[c10_i11] = c10_dv1[c10_i11];
  }

  for (c10_i12 = 0; c10_i12 < 3; c10_i12++) {
    c10_b_tau[c10_i12] = c10_tau[c10_i12] - c10_g_y[c10_i12];
  }

  c10_mldivide(chartInstance, c10_dv2, c10_b_tau, c10_dv3);
  for (c10_i13 = 0; c10_i13 < 3; c10_i13++) {
    c10_nu_dot[c10_i13] = c10_dv3[c10_i13];
  }

  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, -70);
  _SFD_SYMBOL_SCOPE_POP();
  for (c10_i14 = 0; c10_i14 < 3; c10_i14++) {
    (*c10_b_nu_dot)[c10_i14] = c10_nu_dot[c10_i14];
  }
  ...
  *c10_inData)
{
  ...
  real_T c10_u[3];
  const mxArray *c10_y = NULL;
  SFc10_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc10_CSE1_DPInstanceStruct *)chartInstanceVoid;
  c10_mxArrayOutData = NULL;
  for (c10_i15 = 0; c10_i15 < 3; c10_i15++) {
    c10_b_inData[c10_i15] = (*(real_T (*)[3])c10_inData)[c10_i15];
  }

  for (c10_i16 = 0; c10_i16 < 3; c10_i16++) {
    c10_u[c10_i16] = c10_b_inData[c10_i16];
  }
  ...
  const mxArray *c10_nu_dot, const char_T *c10_identifier, real_T c10_y[3])
{
  ...
  c10_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c10_nu_dot), &c10_thisId,
    c10_y);
  sf_mex_destroy(&c10_nu_dot);
}
  ...
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId, real_T c10_y[3])
{
  ...
  int32_T c10_i17;
  (void)chartInstance;
  sf_mex_import(c10_parentId, sf_mex_dup(c10_u), c10_dv4, 1, 0, 0U, 1, 0U, 1, 3);
  for (c10_i17 = 0; c10_i17 < 3; c10_i17++) {
    c10_y[c10_i17] = c10_dv4[c10_i17];
  }
  ...
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData)
{
  ...
  SFc10_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc10_CSE1_DPInstanceStruct *)chartInstanceVoid;
  c10_nu_dot = sf_mex_dup(c10_mxArrayInData);
  ...
  for (c10_i18 = 0; c10_i18 < 3; c10_i18++) {
    (*(real_T (*)[3])c10_outData)[c10_i18] = c10_y[c10_i18];
  }
  ...
  *c10_inData)
{
  ...
  for (c10_i20 = 0; c10_i20 < 3; c10_i20++) {
    for (c10_i21 = 0; c10_i21 < 3; c10_i21++) {
      c10_b_inData[c10_i21 + c10_i19] = (*(real_T (*)[9])c10_inData)[c10_i21 +
        c10_i19];
    }
  ...
  for (c10_i23 = 0; c10_i23 < 3; c10_i23++) {
    for (c10_i24 = 0; c10_i24 < 3; c10_i24++) {
      c10_u[c10_i24 + c10_i22] = c10_b_inData[c10_i24 + c10_i22];
    }
  ...
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId, real_T c10_y[9])
{
  ...
  int32_T c10_i25;
  (void)chartInstance;
  sf_mex_import(c10_parentId, sf_mex_dup(c10_u), c10_dv5, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c10_i25 = 0; c10_i25 < 9; c10_i25++) {
    c10_y[c10_i25] = c10_dv5[c10_i25];
  }
  ...
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData)
{
  ...
  SFc10_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc10_CSE1_DPInstanceStruct *)chartInstanceVoid;
  c10_D = sf_mex_dup(c10_mxArrayInData);
  c10_identifier = c10_varName;
  c10_thisId.fIdentifier = c10_identifier;
  c10_thisId.fParent = NULL;
  c10_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c10_D), &c10_thisId, c10_y);
  sf_mex_destroy(&c10_D);
  c10_i26 = 0;
...
const mxArray *sf_c10_CSE1_DP_get_eml_resolved_functions_info(void)
{
...
static void c10_info_helper(const mxArray **c10_info)
{
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1363713878U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/isBuiltInNumeric.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1363714556U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/ismatrix.m"), "resolved",
                  "resolved", 2);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1331304858U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m"), "resolved",
                  "resolved", 3);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1363713880U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/scalarEg.p"),
                  "resolved", "resolved", 6);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1389307920U), "fileTimeLo",
                  "fileTimeLo", 6);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 6);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
                  "resolved", 9);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1363713854U), "fileTimeLo",
                  "fileTimeLo", 9);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 9);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1286818726U), "fileTimeLo",
                  "fileTimeLo", 11);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 11);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("abs"), "name", "name", 13);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m"), "resolved",
                  "resolved", 13);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1363713852U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1286818712U), "fileTimeLo",
                  "fileTimeLo", 15);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 15);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1389307922U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xgemm.p!below_threshold"),
                  "context", "context", 24);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "coder.internal.blas.threshold"), "name", "name", 24);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1381850300U), "fileTimeLo",
                  "fileTimeLo", 25);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 25);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/xgemm.p"),
                  "context", "context", 27);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "coder.internal.refblas.xgemm"), "name", "name", 27);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, sf_mex_duplicatearraysafe(&c10_lhs27), "lhs", "lhs",
                  27);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(""), "context", "context", 28);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("mldivide"), "name", "name",
                  28);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 28);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mldivide.p"), "resolved",
                  "resolved", 28);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1388460096U), "fileTimeLo",
                  "fileTimeLo", 28);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 28);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1319729966U), "mFileTimeLo",
                  "mFileTimeLo", 28);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 28);
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mldivide.p"), "context",
                  "context", 29);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("eml_lusolve"), "name",
                  "name", 29);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 29);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_lusolve.m"), "resolved",
                  "resolved", 29);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1370009886U), "fileTimeLo",
                  "fileTimeLo", 29);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 29);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_lusolve.m!lusolve3x3"),
                  "context", "context", 30);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("eml_xcabs1"), "name", "name",
                  30);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 30);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xcabs1.m"),
                  "context", "context", 31);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "coder.internal.refblas.xcabs1"), "name", "name", 31);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 31);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_lusolve.m!warn_singular"),
                  "context", "context", 38);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("eml_warning"), "name",
                  "name", 38);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 38);
  sf_mex_addfield(*c10_info, c10_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_warning.m"), "resolved",
                  "resolved", 38);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(1286818802U), "fileTimeLo",
                  "fileTimeLo", 38);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 38);
  sf_mex_addfield(*c10_info, c10_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  c10_A[9], real_T c10_B[3], real_T c10_C[3], real_T c10_b_C[3])
{
  ...
  for (c10_i29 = 0; c10_i29 < 3; c10_i29++) {
    c10_b_C[c10_i29] = c10_C[c10_i29];
  }

  for (c10_i30 = 0; c10_i30 < 9; c10_i30++) {
    c10_b_A[c10_i30] = c10_A[c10_i30];
  }

  for (c10_i31 = 0; c10_i31 < 3; c10_i31++) {
    c10_b_B[c10_i31] = c10_B[c10_i31];
  }
  ...
  c10_A[9], real_T c10_B[3], real_T c10_Y[3])
{
  ...
  c10_maxval = c10_y + c10_b_y;
  c10_g_x = c10_b_A[1];
  c10_h_x = c10_g_x;
  c10_i_x = c10_h_x;
  c10_j_x = c10_i_x;
  c10_c_y = muDoubleScalarAbs(c10_j_x);
  c10_k_x = 0.0;
  c10_l_x = c10_k_x;
  c10_d_y = muDoubleScalarAbs(c10_l_x);
  c10_a21 = c10_c_y + c10_d_y;
  if (c10_a21 > c10_maxval) {
    c10_maxval = c10_a21;
    c10_r1 = 2;
    c10_r2 = 1;
  }
  ...
  c10_o_x = c10_n_x;
  c10_p_x = c10_o_x;
  c10_e_y = muDoubleScalarAbs(c10_p_x);
  c10_q_x = 0.0;
  c10_r_x = c10_q_x;
  c10_f_y = muDoubleScalarAbs(c10_r_x);
  c10_d = c10_e_y + c10_f_y;
  if (c10_d > c10_maxval) {
    c10_r1 = 3;
    c10_r2 = 2;
    c10_r3 = 1;
  ...
  c10_s_x = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c10_r2), 1, 3, 1, 0) - 1];
  c10_g_y = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c10_r1), 1, 3, 1, 0) - 1];
  c10_t_x = c10_s_x;
  c10_h_y = c10_g_y;
  c10_u_x = c10_t_x;
  c10_i_y = c10_h_y;
  c10_z = c10_u_x / c10_i_y;
  c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r2), 1, 3, 1, 0) - 1] = c10_z;
  c10_v_x = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c10_r3), 1, 3, 1, 0) - 1];
  c10_j_y = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c10_r1), 1, 3, 1, 0) - 1];
  c10_w_x = c10_v_x;
  c10_k_y = c10_j_y;
  c10_x_x = c10_w_x;
  c10_l_y = c10_k_y;
  c10_b_z = c10_x_x / c10_l_y;
  c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r3), 1, 3, 1, 0) - 1] = c10_b_z;
  c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r2), 1, 3, 1, 0) + 2] = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("",
    (int32_T)_SFD_INTEGER_CHECK("", (real_T)c10_r2), 1, 3, 1, 0) + 2] -
    c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r2), 1, 3, 1, 0) - 1] * c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("",
    (int32_T)_SFD_INTEGER_CHECK("", (real_T)c10_r1), 1, 3, 1, 0) + 2];
  c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r3), 1, 3, 1, 0) + 2] = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("",
    (int32_T)_SFD_INTEGER_CHECK("", (real_T)c10_r3), 1, 3, 1, 0) + 2] -
    c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r3), 1, 3, 1, 0) - 1] * c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("",
    (int32_T)_SFD_INTEGER_CHECK("", (real_T)c10_r1), 1, 3, 1, 0) + 2];
  c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r2), 1, 3, 1, 0) + 5] = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("",
    (int32_T)_SFD_INTEGER_CHECK("", (real_T)c10_r2), 1, 3, 1, 0) + 5] -
    c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r2), 1, 3, 1, 0) - 1] * c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("",
    (int32_T)_SFD_INTEGER_CHECK("", (real_T)c10_r1), 1, 3, 1, 0) + 5];
  c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r3), 1, 3, 1, 0) + 5] = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("",
    (int32_T)_SFD_INTEGER_CHECK("", (real_T)c10_r3), 1, 3, 1, 0) + 5] -
    c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r3), 1, 3, 1, 0) - 1] * c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("",
    (int32_T)_SFD_INTEGER_CHECK("", (real_T)c10_r1), 1, 3, 1, 0) + 5];
  c10_y_x = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c10_r3), 1, 3, 1, 0) + 2];
  c10_ab_x = c10_y_x;
  c10_bb_x = c10_ab_x;
  c10_cb_x = c10_bb_x;
  c10_m_y = muDoubleScalarAbs(c10_cb_x);
  c10_db_x = 0.0;
  c10_eb_x = c10_db_x;
  c10_n_y = muDoubleScalarAbs(c10_eb_x);
  c10_b_d = c10_m_y + c10_n_y;
  c10_fb_x = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
    ("", (real_T)c10_r2), 1, 3, 1, 0) + 2];
  c10_gb_x = c10_fb_x;
  c10_hb_x = c10_gb_x;
  c10_ib_x = c10_hb_x;
  c10_o_y = muDoubleScalarAbs(c10_ib_x);
  c10_jb_x = 0.0;
  c10_kb_x = c10_jb_x;
  c10_p_y = muDoubleScalarAbs(c10_kb_x);
  c10_c_d = c10_o_y + c10_p_y;
  if (c10_b_d > c10_c_d) {
    c10_rtemp = c10_r2;
    c10_r2 = c10_r3;
    c10_r3 = c10_rtemp;
  ...
  c10_lb_x = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
    ("", (real_T)c10_r3), 1, 3, 1, 0) + 2];
  c10_q_y = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c10_r2), 1, 3, 1, 0) + 2];
  c10_mb_x = c10_lb_x;
  c10_r_y = c10_q_y;
  c10_nb_x = c10_mb_x;
  c10_s_y = c10_r_y;
  c10_c_z = c10_nb_x / c10_s_y;
  c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r3), 1, 3, 1, 0) + 2] = c10_c_z;
  c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r3), 1, 3, 1, 0) + 5] = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("",
    (int32_T)_SFD_INTEGER_CHECK("", (real_T)c10_r3), 1, 3, 1, 0) + 5] -
    c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
  ...
  if (c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        (real_T)c10_r1), 1, 3, 1, 0) - 1] == 0.0) {
    guard2 = true;
  } else if (c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
              ("", (real_T)c10_r2), 1, 3, 1, 0) + 2] == 0.0) {
    guard2 = true;
  } else {
    if (c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
          (real_T)c10_r3), 1, 3, 1, 0) + 5] == 0.0) {
      guard1 = true;
    }
  }
  ...
  c10_b_eml_scalar_eg(chartInstance);
  c10_Y[0] = c10_B[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c10_r1), 1, 3, 1, 0) - 1];
  c10_Y[1] = c10_B[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c10_r2), 1, 3, 1, 0) - 1] - c10_Y[0] *
    c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r2), 1, 3, 1, 0) - 1];
  c10_Y[2] = (c10_B[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c10_r3), 1, 3, 1, 0) - 1] - c10_Y[0] *
              c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
    _SFD_INTEGER_CHECK("", (real_T)c10_r3), 1, 3, 1, 0) - 1]) - c10_Y[1] *
    c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c10_r3), 1, 3, 1, 0) + 2];
  c10_ob_x = c10_Y[2];
  c10_t_y = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c10_r3), 1, 3, 1, 0) + 5];
  c10_pb_x = c10_ob_x;
  c10_u_y = c10_t_y;
  c10_qb_x = c10_pb_x;
  c10_v_y = c10_u_y;
  c10_d_z = c10_qb_x / c10_v_y;
  c10_Y[2] = c10_d_z;
  c10_Y[0] -= c10_Y[2] * c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
    _SFD_INTEGER_CHECK("", (real_T)c10_r1), 1, 3, 1, 0) + 5];
  c10_Y[1] -= c10_Y[2] * c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
    _SFD_INTEGER_CHECK("", (real_T)c10_r2), 1, 3, 1, 0) + 5];
  c10_rb_x = c10_Y[1];
  c10_w_y = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c10_r2), 1, 3, 1, 0) + 2];
  c10_sb_x = c10_rb_x;
  c10_x_y = c10_w_y;
  c10_tb_x = c10_sb_x;
  c10_y_y = c10_x_y;
  c10_e_z = c10_tb_x / c10_y_y;
  c10_Y[1] = c10_e_z;
  c10_Y[0] -= c10_Y[1] * c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
    _SFD_INTEGER_CHECK("", (real_T)c10_r1), 1, 3, 1, 0) + 2];
  c10_ub_x = c10_Y[0];
  c10_ab_y = c10_b_A[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK
    ("", (real_T)c10_r1), 1, 3, 1, 0) - 1];
  c10_vb_x = c10_ub_x;
  c10_bb_y = c10_ab_y;
  c10_wb_x = c10_vb_x;
  c10_cb_y = c10_bb_y;
  c10_f_z = c10_wb_x / c10_cb_y;
  c10_Y[0] = c10_f_z;
}
...
{
  int32_T c10_i33;
  static char_T c10_varargin_1[27] = { 'C', 'o', 'd', 'e', 'r', ':', 'M', 'A',
  ...
  const mxArray *c10_y = NULL;
  (void)chartInstance;
  for (c10_i33 = 0; c10_i33 < 27; c10_i33++) {
    c10_u[c10_i33] = c10_varargin_1[c10_i33];
  }
  ...
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId)
{
  ...
  int32_T c10_i34;
  (void)chartInstance;
  sf_mex_import(c10_parentId, sf_mex_dup(c10_u), &c10_i34, 1, 6, 0U, 0, 0U, 0);
  c10_y = c10_i34;
  sf_mex_destroy(&c10_u);
  return c10_y;
}
  ...
  const mxArray *c10_b_is_active_c10_CSE1_DP, const char_T *c10_identifier)
{
  ...
  c10_y = c10_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_CSE1_DP), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_CSE1_DP);
  return c10_y;
}
  ...
  c10_A[9], real_T c10_B[3], real_T c10_C[3])
{
  ...
  for (c10_i35 = 0; c10_i35 < 3; c10_i35++) {
    ...
    for (c10_i37 = 0; c10_i37 < 3; c10_i37++) {
      c10_C[c10_i35] += c10_A[c10_i36 + c10_i35] * c10_B[c10_i37];
      c10_i36 += 3;
    }
  }
}
...
void sf_c10_CSE1_DP_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2123312067U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2389933579U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3609914365U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3165509888U);
}

mxArray *sf_c10_CSE1_DP_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("iA0FmmlGCcZ0eTmHnuKyAE");
...
mxArray *sf_c10_CSE1_DP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_CSE1_DP_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c10_CSE1_DP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"nu_dot\",},{M[8],M[0],T\"is_active_c10_CSE1_DP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_CSE1_DP_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc10_CSE1_DPInstanceStruct *) chartInfo->chartInstance;
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"tau_u");
          _SFD_SET_DATA_PROPS(1,1,1,0,"tau_v");
          _SFD_SET_DATA_PROPS(2,1,1,0,"tau_r");
          _SFD_SET_DATA_PROPS(3,2,0,1,"nu_dot");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1678);
...

        {
          ...
          c10_tau_v = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c10_tau_u = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c10_tau_u);
          _SFD_SET_DATA_VALUE_PTR(1U, c10_tau_v);
          _SFD_SET_DATA_VALUE_PTR(2U, c10_tau_r);
          _SFD_SET_DATA_VALUE_PTR(3U, *c10_nu_dot);
          _SFD_SET_DATA_VALUE_PTR(4U, *c10_nu);
        }
      }
    } else {
...
{
  return "9W6yH3umXLA7bkDTAU1ILH";
}

static void sf_opaque_initialize_c10_CSE1_DP(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_CSE1_DPInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c10_CSE1_DP((SFc10_CSE1_DPInstanceStruct*) chartInstanceVar);
  initialize_c10_CSE1_DP((SFc10_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_CSE1_DP(void *chartInstanceVar)
{
  enable_c10_CSE1_DP((SFc10_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_CSE1_DP(void *chartInstanceVar)
{
  disable_c10_CSE1_DP((SFc10_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_CSE1_DP(void *chartInstanceVar)
{
  sf_gateway_c10_CSE1_DP((SFc10_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c10_CSE1_DP(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c10_CSE1_DP((SFc10_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c10_CSE1_DP();/* state var info */
...
extern void sf_internal_set_sim_state_c10_CSE1_DP(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c10_CSE1_DP();/* state var info */
  ...
  set_sim_state_c10_CSE1_DP((SFc10_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c10_CSE1_DP(SimStruct* S)
{
  return sf_internal_get_sim_state_c10_CSE1_DP(S);
}

static void sf_opaque_set_sim_state_c10_CSE1_DP(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c10_CSE1_DP(S, st);
}

static void sf_opaque_terminate_c10_CSE1_DP(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_CSE1_DPInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c10_CSE1_DP((SFc10_CSE1_DPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc10_CSE1_DP((SFc10_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_CSE1_DP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c10_CSE1_DP((SFc10_CSE1_DPInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c10_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1154873856U));
  ssSetChecksum1(S,(2746247279U));
  ssSetChecksum2(S,(2440064257U));
  ssSetChecksum3(S,(2470665129U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c10_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_CSE1_DP(SimStruct *S)
{
  SFc10_CSE1_DPInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc10_CSE1_DPInstanceStruct *)utMalloc(sizeof
    (SFc10_CSE1_DPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_CSE1_DPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c10_CSE1_DP;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c10_CSE1_DP;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c10_CSE1_DP;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_CSE1_DP;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_CSE1_DP;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c10_CSE1_DP;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c10_CSE1_DP;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c10_CSE1_DP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_CSE1_DP;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_CSE1_DP;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_CSE1_DP;
...
void c10_CSE1_DP_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_CSE1_DP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_CSE1_DP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_CSE1_DP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_CSE1_DP_method_dispatcher.\n"
