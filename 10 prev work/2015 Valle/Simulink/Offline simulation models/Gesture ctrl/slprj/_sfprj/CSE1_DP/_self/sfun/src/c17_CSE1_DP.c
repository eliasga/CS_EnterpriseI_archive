...
static void initialize_c17_CSE1_DP(SFc17_CSE1_DPInstanceStruct *chartInstance);
static void initialize_params_c17_CSE1_DP(SFc17_CSE1_DPInstanceStruct
  *chartInstance);
static void enable_c17_CSE1_DP(SFc17_CSE1_DPInstanceStruct *chartInstance);
static void disable_c17_CSE1_DP(SFc17_CSE1_DPInstanceStruct *chartInstance);
static void c17_update_debugger_state_c17_CSE1_DP(SFc17_CSE1_DPInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c17_CSE1_DP(SFc17_CSE1_DPInstanceStruct
  *chartInstance);
static void set_sim_state_c17_CSE1_DP(SFc17_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c17_st);
static void finalize_c17_CSE1_DP(SFc17_CSE1_DPInstanceStruct *chartInstance);
static void sf_gateway_c17_CSE1_DP(SFc17_CSE1_DPInstanceStruct *chartInstance);
static void initSimStructsc17_CSE1_DP(SFc17_CSE1_DPInstanceStruct *chartInstance);
...
static const mxArray *c17_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static void c17_emlrt_marshallIn(SFc17_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c17_K_i, const char_T *c17_identifier, real_T c17_y[9]);
static void c17_b_emlrt_marshallIn(SFc17_CSE1_DPInstanceStruct *chartInstance,
...
static const mxArray *c17_c_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static real_T c17_c_emlrt_marshallIn(SFc17_CSE1_DPInstanceStruct *chartInstance,
...
static const mxArray *c17_d_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static int32_T c17_d_emlrt_marshallIn(SFc17_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void c17_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c17_mxArrayInData, const char_T *c17_varName, void *c17_outData);
static uint8_T c17_e_emlrt_marshallIn(SFc17_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c17_b_is_active_c17_CSE1_DP, const char_T *c17_identifier);
static uint8_T c17_f_emlrt_marshallIn(SFc17_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void init_dsm_address_info(SFc17_CSE1_DPInstanceStruct *chartInstance);
...
static void initialize_c17_CSE1_DP(SFc17_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c17_is_active_c17_CSE1_DP = 0U;
}
  ...
  *chartInstance)
{
  ...
  c17_hoistedGlobal = chartInstance->c17_is_active_c17_CSE1_DP;
  ...
  const mxArray *c17_st)
{
  ...
  chartInstance->c17_is_active_c17_CSE1_DP = c17_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c17_u, 1)),
     "is_active_c17_CSE1_DP");
  sf_mex_destroy(&c17_u);
  c17_update_debugger_state_c17_CSE1_DP(chartInstance);
  ...
  *c17_inData)
{
  ...
  real_T c17_u[9];
  const mxArray *c17_y = NULL;
  SFc17_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc17_CSE1_DPInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c17_CSE1_DP_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c17_b_is_active_c17_CSE1_DP, const char_T *c17_identifier)
{
  ...
  c17_y = c17_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c17_b_is_active_c17_CSE1_DP), &c17_thisId);
  sf_mex_destroy(&c17_b_is_active_c17_CSE1_DP);
  return c17_y;
}
...
void sf_c17_CSE1_DP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c17_CSE1_DP_get_autoinheritance_info(void)
{
...
mxArray *sf_c17_CSE1_DP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c17_CSE1_DP_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c17_CSE1_DP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"K_i\",},{M[8],M[0],T\"is_active_c17_CSE1_DP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c17_CSE1_DP_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc17_CSE1_DPInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c17_CSE1_DP(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc17_CSE1_DPInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c17_CSE1_DP((SFc17_CSE1_DPInstanceStruct*) chartInstanceVar);
  initialize_c17_CSE1_DP((SFc17_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c17_CSE1_DP(void *chartInstanceVar)
{
  enable_c17_CSE1_DP((SFc17_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c17_CSE1_DP(void *chartInstanceVar)
{
  disable_c17_CSE1_DP((SFc17_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c17_CSE1_DP(void *chartInstanceVar)
{
  sf_gateway_c17_CSE1_DP((SFc17_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c17_CSE1_DP(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c17_CSE1_DP((SFc17_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c17_CSE1_DP();/* state var info */
...
extern void sf_internal_set_sim_state_c17_CSE1_DP(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c17_CSE1_DP();/* state var info */
  ...
  set_sim_state_c17_CSE1_DP((SFc17_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c17_CSE1_DP(SimStruct* S)
{
  return sf_internal_get_sim_state_c17_CSE1_DP(S);
}

static void sf_opaque_set_sim_state_c17_CSE1_DP(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c17_CSE1_DP(S, st);
}

static void sf_opaque_terminate_c17_CSE1_DP(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc17_CSE1_DPInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c17_CSE1_DP((SFc17_CSE1_DPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc17_CSE1_DP((SFc17_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c17_CSE1_DP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c17_CSE1_DP((SFc17_CSE1_DPInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c17_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c17_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c17_CSE1_DP(SimStruct *S)
{
  SFc17_CSE1_DPInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc17_CSE1_DPInstanceStruct *)utMalloc(sizeof
    (SFc17_CSE1_DPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc17_CSE1_DPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c17_CSE1_DP;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c17_CSE1_DP;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c17_CSE1_DP;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c17_CSE1_DP;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c17_CSE1_DP;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c17_CSE1_DP;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c17_CSE1_DP;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c17_CSE1_DP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c17_CSE1_DP;
  chartInstance->chartInfo.mdlStart = mdlStart_c17_CSE1_DP;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c17_CSE1_DP;
...
void c17_CSE1_DP_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c17_CSE1_DP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c17_CSE1_DP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c17_CSE1_DP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c17_CSE1_DP_method_dispatcher.\n"
