...
static const char * c28_debug_family_names[4] = { "nargin", "nargout", "K_p1",
  "K_p" };

/* Function Declarations */
static void initialize_c28_CSE1_DP(SFc28_CSE1_DPInstanceStruct *chartInstance);
static void initialize_params_c28_CSE1_DP(SFc28_CSE1_DPInstanceStruct
  *chartInstance);
static void enable_c28_CSE1_DP(SFc28_CSE1_DPInstanceStruct *chartInstance);
static void disable_c28_CSE1_DP(SFc28_CSE1_DPInstanceStruct *chartInstance);
static void c28_update_debugger_state_c28_CSE1_DP(SFc28_CSE1_DPInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c28_CSE1_DP(SFc28_CSE1_DPInstanceStruct
  *chartInstance);
static void set_sim_state_c28_CSE1_DP(SFc28_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c28_st);
static void finalize_c28_CSE1_DP(SFc28_CSE1_DPInstanceStruct *chartInstance);
static void sf_gateway_c28_CSE1_DP(SFc28_CSE1_DPInstanceStruct *chartInstance);
static void initSimStructsc28_CSE1_DP(SFc28_CSE1_DPInstanceStruct *chartInstance);
...
static const mxArray *c28_sf_marshallOut(void *chartInstanceVoid, void
  *c28_inData);
static void c28_emlrt_marshallIn(SFc28_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c28_K_p, const char_T *c28_identifier, real_T c28_y[9]);
static void c28_b_emlrt_marshallIn(SFc28_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId, real_T c28_y[9]);
...
static const mxArray *c28_c_sf_marshallOut(void *chartInstanceVoid, void
  *c28_inData);
static real_T c28_c_emlrt_marshallIn(SFc28_CSE1_DPInstanceStruct *chartInstance,
...
static const mxArray *c28_d_sf_marshallOut(void *chartInstanceVoid, void
  *c28_inData);
static int32_T c28_d_emlrt_marshallIn(SFc28_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId);
static void c28_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c28_mxArrayInData, const char_T *c28_varName, void *c28_outData);
static uint8_T c28_e_emlrt_marshallIn(SFc28_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c28_b_is_active_c28_CSE1_DP, const char_T *c28_identifier);
static uint8_T c28_f_emlrt_marshallIn(SFc28_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId);
static void init_dsm_address_info(SFc28_CSE1_DPInstanceStruct *chartInstance);
...
static void initialize_c28_CSE1_DP(SFc28_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c28_is_active_c28_CSE1_DP = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T (*c28_K_p)[9];
  c28_K_p = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  c28_st = NULL;
  c28_st = NULL;
  c28_y = NULL;
  sf_mex_assign(&c28_y, sf_mex_createcellmatrix(2, 1), false);
  for (c28_i0 = 0; c28_i0 < 9; c28_i0++) {
    c28_u[c28_i0] = (*c28_K_p)[c28_i0];
  }
  ...
  c28_hoistedGlobal = chartInstance->c28_is_active_c28_CSE1_DP;
  ...
  const mxArray *c28_st)
{
  ...
  for (c28_i1 = 0; c28_i1 < 9; c28_i1++) {
    (*c28_K_p)[c28_i1] = c28_dv0[c28_i1];
  }

  chartInstance->c28_is_active_c28_CSE1_DP = c28_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c28_u, 1)),
     "is_active_c28_CSE1_DP");
  sf_mex_destroy(&c28_u);
  c28_update_debugger_state_c28_CSE1_DP(chartInstance);
...
static void sf_gateway_c28_CSE1_DP(SFc28_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  real_T (*c28_b_K_p)[9];
  real_T (*c28_b_K_p1)[3];
  c28_b_K_p1 = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  c28_b_K_p = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c28_i2 = 0; c28_i2 < 3; c28_i2++) {
    c28_K_p1[c28_i2] = (*c28_b_K_p1)[c28_i2];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c28_nargout, 1U, c28_c_sf_marshallOut,
    c28_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c28_K_p1, 2U, c28_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c28_K_p, 3U, c28_sf_marshallOut,
    c28_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c28_sfEvent, 4);
  for (c28_i3 = 0; c28_i3 < 3; c28_i3++) {
    c28_v[c28_i3] = c28_K_p1[c28_i3];
  }
  ...
  for (c28_j = 1; c28_j < 4; c28_j++) {
    c28_b_j = c28_j;
    c28_K_p[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
               (real_T)c28_b_j), 1, 3, 1, 0) + 3 * (_SFD_EML_ARRAY_BOUNDS_CHECK(
               "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c28_b_j), 1, 3, 2, 0)
              - 1)) - 1] = c28_v[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c28_b_j), 1, 3, 1, 0) - 1];
  }

  _SFD_EML_CALL(0U, chartInstance->c28_sfEvent, -4);
  _SFD_SYMBOL_SCOPE_POP();
  for (c28_i5 = 0; c28_i5 < 9; c28_i5++) {
    (*c28_b_K_p)[c28_i5] = c28_K_p[c28_i5];
  }
  ...
  for (c28_i6 = 0; c28_i6 < 9; c28_i6++) {
    _SFD_DATA_RANGE_CHECK((*c28_b_K_p)[c28_i6], 0U);
  }

  for (c28_i7 = 0; c28_i7 < 3; c28_i7++) {
    _SFD_DATA_RANGE_CHECK((*c28_b_K_p1)[c28_i7], 1U);
  }
}
  ...
  *c28_inData)
{
  ...
  real_T c28_u[9];
  const mxArray *c28_y = NULL;
  SFc28_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc28_CSE1_DPInstanceStruct *)chartInstanceVoid;
  c28_mxArrayOutData = NULL;
  c28_i8 = 0;
  for (c28_i9 = 0; c28_i9 < 3; c28_i9++) {
    for (c28_i10 = 0; c28_i10 < 3; c28_i10++) {
      c28_b_inData[c28_i10 + c28_i8] = (*(real_T (*)[9])c28_inData)[c28_i10 +
        c28_i8];
    }
  ...
  for (c28_i12 = 0; c28_i12 < 3; c28_i12++) {
    for (c28_i13 = 0; c28_i13 < 3; c28_i13++) {
      c28_u[c28_i13 + c28_i11] = c28_b_inData[c28_i13 + c28_i11];
    }
  ...
  const mxArray *c28_K_p, const char_T *c28_identifier, real_T c28_y[9])
{
  ...
  c28_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c28_K_p), &c28_thisId, c28_y);
  sf_mex_destroy(&c28_K_p);
}
  ...
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId, real_T c28_y[9])
{
  ...
  sf_mex_import(c28_parentId, sf_mex_dup(c28_u), c28_dv1, 1, 0, 0U, 1, 0U, 2, 3,
                3);
  for (c28_i14 = 0; c28_i14 < 9; c28_i14++) {
    c28_y[c28_i14] = c28_dv1[c28_i14];
  }
  ...
  *c28_mxArrayInData, const char_T *c28_varName, void *c28_outData)
{
  ...
  SFc28_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc28_CSE1_DPInstanceStruct *)chartInstanceVoid;
  c28_K_p = sf_mex_dup(c28_mxArrayInData);
  ...
  for (c28_i16 = 0; c28_i16 < 3; c28_i16++) {
    for (c28_i17 = 0; c28_i17 < 3; c28_i17++) {
      (*(real_T (*)[9])c28_outData)[c28_i17 + c28_i15] = c28_y[c28_i17 + c28_i15];
    }
  ...
  *c28_inData)
{
  ...
  for (c28_i18 = 0; c28_i18 < 3; c28_i18++) {
    c28_b_inData[c28_i18] = (*(real_T (*)[3])c28_inData)[c28_i18];
  }

  for (c28_i19 = 0; c28_i19 < 3; c28_i19++) {
    c28_u[c28_i19] = c28_b_inData[c28_i19];
  }
...
const mxArray *sf_c28_CSE1_DP_get_eml_resolved_functions_info(void)
{
  const mxArray *c28_nameCaptureInfo = NULL;
  c28_nameCaptureInfo = NULL;
  sf_mex_assign(&c28_nameCaptureInfo, sf_mex_createstruct("structure", 2, 8, 1),
                false);
...
static void c28_info_helper(const mxArray **c28_info)
{
  ...
  sf_mex_addfield(*c28_info, c28_emlrt_marshallOut("diag"), "name", "name", 0);
  ...
  sf_mex_addfield(*c28_info, c28_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c28_info, c28_b_emlrt_marshallOut(1363713854U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c28_info, c28_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m"), "context",
                  "context", 1);
  sf_mex_addfield(*c28_info, c28_emlrt_marshallOut("ismatrix"), "name", "name",
                  1);
  sf_mex_addfield(*c28_info, c28_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 1);
  sf_mex_addfield(*c28_info, c28_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/ismatrix.m"), "resolved",
                  "resolved", 1);
  sf_mex_addfield(*c28_info, c28_b_emlrt_marshallOut(1331304858U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c28_info, c28_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c28_info, c28_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c28_info, c28_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/scalarEg.p"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c28_info, c28_b_emlrt_marshallOut(1389307920U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c28_info, c28_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c28_info, c28_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c28_info, c28_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_switch_helper.m"),
                  "resolved", "resolved", 7);
  sf_mex_addfield(*c28_info, c28_b_emlrt_marshallOut(1381850300U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c28_info, c28_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c28_info, c28_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId)
{
  ...
  int32_T c28_i20;
  (void)chartInstance;
  sf_mex_import(c28_parentId, sf_mex_dup(c28_u), &c28_i20, 1, 6, 0U, 0, 0U, 0);
  c28_y = c28_i20;
  sf_mex_destroy(&c28_u);
  return c28_y;
}
  ...
  const mxArray *c28_b_is_active_c28_CSE1_DP, const char_T *c28_identifier)
{
  ...
  c28_y = c28_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c28_b_is_active_c28_CSE1_DP), &c28_thisId);
  sf_mex_destroy(&c28_b_is_active_c28_CSE1_DP);
  return c28_y;
}
...
void sf_c28_CSE1_DP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c28_CSE1_DP_get_autoinheritance_info(void)
{
...
mxArray *sf_c28_CSE1_DP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c28_CSE1_DP_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c28_CSE1_DP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"K_p\",},{M[8],M[0],T\"is_active_c28_CSE1_DP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c28_CSE1_DP_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc28_CSE1_DPInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          real_T (*c28_K_p)[9];
          real_T (*c28_K_p1)[3];
          c28_K_p1 = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
          c28_K_p = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, *c28_K_p);
          _SFD_SET_DATA_VALUE_PTR(1U, *c28_K_p1);
        }
      }
    } else {
...
static void sf_opaque_initialize_c28_CSE1_DP(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc28_CSE1_DPInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c28_CSE1_DP((SFc28_CSE1_DPInstanceStruct*) chartInstanceVar);
  initialize_c28_CSE1_DP((SFc28_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c28_CSE1_DP(void *chartInstanceVar)
{
  enable_c28_CSE1_DP((SFc28_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c28_CSE1_DP(void *chartInstanceVar)
{
  disable_c28_CSE1_DP((SFc28_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c28_CSE1_DP(void *chartInstanceVar)
{
  sf_gateway_c28_CSE1_DP((SFc28_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c28_CSE1_DP(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c28_CSE1_DP((SFc28_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c28_CSE1_DP();/* state var info */
...
extern void sf_internal_set_sim_state_c28_CSE1_DP(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c28_CSE1_DP();/* state var info */
  ...
  set_sim_state_c28_CSE1_DP((SFc28_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c28_CSE1_DP(SimStruct* S)
{
  return sf_internal_get_sim_state_c28_CSE1_DP(S);
}

static void sf_opaque_set_sim_state_c28_CSE1_DP(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c28_CSE1_DP(S, st);
}

static void sf_opaque_terminate_c28_CSE1_DP(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc28_CSE1_DPInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c28_CSE1_DP((SFc28_CSE1_DPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc28_CSE1_DP((SFc28_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c28_CSE1_DP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c28_CSE1_DP((SFc28_CSE1_DPInstanceStruct*)
...
static void mdlRTW_c28_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c28_CSE1_DP(SimStruct *S)
{
  SFc28_CSE1_DPInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc28_CSE1_DPInstanceStruct *)utMalloc(sizeof
    (SFc28_CSE1_DPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc28_CSE1_DPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c28_CSE1_DP;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c28_CSE1_DP;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c28_CSE1_DP;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c28_CSE1_DP;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c28_CSE1_DP;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c28_CSE1_DP;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c28_CSE1_DP;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c28_CSE1_DP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c28_CSE1_DP;
  chartInstance->chartInfo.mdlStart = mdlStart_c28_CSE1_DP;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c28_CSE1_DP;
...
void c28_CSE1_DP_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c28_CSE1_DP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c28_CSE1_DP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c28_CSE1_DP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c28_CSE1_DP_method_dispatcher.\n"
