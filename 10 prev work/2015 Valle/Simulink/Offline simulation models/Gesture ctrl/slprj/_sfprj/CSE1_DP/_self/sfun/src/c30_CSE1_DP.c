...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(615929694U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2933704591U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3452333970U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(726973916U);
}
...
mxArray *sf_c30_CSE1_DP_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("OmEpEhaNsMQ30sqEd7WIED");
...
static void mdlSetWorkWidths_c30_CSE1_DP(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3694950839U));
  ssSetChecksum1(S,(628864979U));
  ssSetChecksum2(S,(1273759539U));
  ssSetChecksum3(S,(4179552281U));
