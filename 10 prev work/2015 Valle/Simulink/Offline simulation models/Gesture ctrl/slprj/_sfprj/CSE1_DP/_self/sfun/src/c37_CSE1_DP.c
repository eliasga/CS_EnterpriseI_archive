...
static void initialize_c37_CSE1_DP(SFc37_CSE1_DPInstanceStruct *chartInstance);
static void initialize_params_c37_CSE1_DP(SFc37_CSE1_DPInstanceStruct
  *chartInstance);
static void enable_c37_CSE1_DP(SFc37_CSE1_DPInstanceStruct *chartInstance);
static void disable_c37_CSE1_DP(SFc37_CSE1_DPInstanceStruct *chartInstance);
static void c37_update_debugger_state_c37_CSE1_DP(SFc37_CSE1_DPInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c37_CSE1_DP(SFc37_CSE1_DPInstanceStruct
  *chartInstance);
static void set_sim_state_c37_CSE1_DP(SFc37_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c37_st);
static void finalize_c37_CSE1_DP(SFc37_CSE1_DPInstanceStruct *chartInstance);
static void sf_gateway_c37_CSE1_DP(SFc37_CSE1_DPInstanceStruct *chartInstance);
static void initSimStructsc37_CSE1_DP(SFc37_CSE1_DPInstanceStruct *chartInstance);
...
static const mxArray *c37_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static void c37_emlrt_marshallIn(SFc37_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c37_w_d, const char_T *c37_identifier, real_T c37_y[9]);
static void c37_b_emlrt_marshallIn(SFc37_CSE1_DPInstanceStruct *chartInstance,
...
static const mxArray *c37_c_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static real_T c37_c_emlrt_marshallIn(SFc37_CSE1_DPInstanceStruct *chartInstance,
...
static const mxArray *c37_d_sf_marshallOut(void *chartInstanceVoid, void
  *c37_inData);
static int32_T c37_d_emlrt_marshallIn(SFc37_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void c37_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData);
static uint8_T c37_e_emlrt_marshallIn(SFc37_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c37_b_is_active_c37_CSE1_DP, const char_T *c37_identifier);
static uint8_T c37_f_emlrt_marshallIn(SFc37_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId);
static void init_dsm_address_info(SFc37_CSE1_DPInstanceStruct *chartInstance);
...
static void initialize_c37_CSE1_DP(SFc37_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c37_is_active_c37_CSE1_DP = 0U;
}
  ...
  *chartInstance)
{
  ...
  real_T (*c37_w_d)[9];
  c37_w_d = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  c37_st = NULL;
  c37_st = NULL;
  c37_y = NULL;
  sf_mex_assign(&c37_y, sf_mex_createcellmatrix(2, 1), false);
  for (c37_i0 = 0; c37_i0 < 9; c37_i0++) {
    c37_u[c37_i0] = (*c37_w_d)[c37_i0];
  }
  ...
  c37_hoistedGlobal = chartInstance->c37_is_active_c37_CSE1_DP;
  ...
  const mxArray *c37_st)
{
  ...
  c37_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c37_u, 0)),
                       "w_d", c37_dv0);
  for (c37_i1 = 0; c37_i1 < 9; c37_i1++) {
    (*c37_w_d)[c37_i1] = c37_dv0[c37_i1];
  }

  chartInstance->c37_is_active_c37_CSE1_DP = c37_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c37_u, 1)),
     "is_active_c37_CSE1_DP");
  sf_mex_destroy(&c37_u);
  c37_update_debugger_state_c37_CSE1_DP(chartInstance);
...
static void sf_gateway_c37_CSE1_DP(SFc37_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  int32_T c37_i7;
  real_T (*c37_b_w_d)[9];
  real_T (*c37_b_w_d_vector)[3];
  c37_b_w_d_vector = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  c37_b_w_d = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c37_i2 = 0; c37_i2 < 3; c37_i2++) {
    c37_w_d_vector[c37_i2] = (*c37_b_w_d_vector)[c37_i2];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 4U, 4U, c37_debug_family_names,
    c37_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c37_nargin, 0U, c37_c_sf_marshallOut,
    c37_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c37_nargout, 1U, c37_c_sf_marshallOut,
    c37_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c37_w_d_vector, 2U, c37_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c37_w_d, 3U, c37_sf_marshallOut,
    c37_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c37_sfEvent, 4);
  for (c37_i3 = 0; c37_i3 < 3; c37_i3++) {
    c37_v[c37_i3] = c37_w_d_vector[c37_i3];
  }
  ...
  for (c37_j = 1; c37_j < 4; c37_j++) {
    c37_b_j = c37_j;
    c37_w_d[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
               (real_T)c37_b_j), 1, 3, 1, 0) + 3 * (_SFD_EML_ARRAY_BOUNDS_CHECK(
               "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)c37_b_j), 1, 3, 2, 0)
              - 1)) - 1] = c37_v[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c37_b_j), 1, 3, 1, 0) - 1];
  }

  _SFD_EML_CALL(0U, chartInstance->c37_sfEvent, -4);
  _SFD_SYMBOL_SCOPE_POP();
  for (c37_i5 = 0; c37_i5 < 9; c37_i5++) {
    (*c37_b_w_d)[c37_i5] = c37_w_d[c37_i5];
  }
  ...
  for (c37_i6 = 0; c37_i6 < 9; c37_i6++) {
    _SFD_DATA_RANGE_CHECK((*c37_b_w_d)[c37_i6], 0U);
  }

  for (c37_i7 = 0; c37_i7 < 3; c37_i7++) {
    _SFD_DATA_RANGE_CHECK((*c37_b_w_d_vector)[c37_i7], 1U);
  }
}
  ...
  *c37_inData)
{
  ...
  real_T c37_u[9];
  const mxArray *c37_y = NULL;
  SFc37_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc37_CSE1_DPInstanceStruct *)chartInstanceVoid;
  c37_mxArrayOutData = NULL;
  c37_i8 = 0;
  for (c37_i9 = 0; c37_i9 < 3; c37_i9++) {
    for (c37_i10 = 0; c37_i10 < 3; c37_i10++) {
      c37_b_inData[c37_i10 + c37_i8] = (*(real_T (*)[9])c37_inData)[c37_i10 +
        c37_i8];
    }
  ...
  const mxArray *c37_w_d, const char_T *c37_identifier, real_T c37_y[9])
{
  ...
  c37_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c37_w_d), &c37_thisId, c37_y);
  sf_mex_destroy(&c37_w_d);
}
  ...
  *c37_mxArrayInData, const char_T *c37_varName, void *c37_outData)
{
  ...
  SFc37_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc37_CSE1_DPInstanceStruct *)chartInstanceVoid;
  c37_w_d = sf_mex_dup(c37_mxArrayInData);
  ...
  for (c37_i16 = 0; c37_i16 < 3; c37_i16++) {
    for (c37_i17 = 0; c37_i17 < 3; c37_i17++) {
      (*(real_T (*)[9])c37_outData)[c37_i17 + c37_i15] = c37_y[c37_i17 + c37_i15];
    }
  ...
  *c37_inData)
{
  ...
  for (c37_i18 = 0; c37_i18 < 3; c37_i18++) {
    c37_b_inData[c37_i18] = (*(real_T (*)[3])c37_inData)[c37_i18];
  }

  for (c37_i19 = 0; c37_i19 < 3; c37_i19++) {
    c37_u[c37_i19] = c37_b_inData[c37_i19];
  }
...
const mxArray *sf_c37_CSE1_DP_get_eml_resolved_functions_info(void)
{
  const mxArray *c37_nameCaptureInfo = NULL;
  c37_nameCaptureInfo = NULL;
  sf_mex_assign(&c37_nameCaptureInfo, sf_mex_createstruct("structure", 2, 8, 1),
                false);
...
static void c37_info_helper(const mxArray **c37_info)
{
  ...
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut("diag"), "name", "name", 0);
  ...
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(1363713854U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m"), "context",
                  "context", 1);
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut("ismatrix"), "name", "name",
                  1);
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 1);
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/ismatrix.m"), "resolved",
                  "resolved", 1);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(1331304858U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m"),
                  "resolved", "resolved", 2);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(1323170578U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m"), "resolved",
                  "resolved", 3);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(1375980688U), "fileTimeLo",
                  "fileTimeLo", 3);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 3);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/scalarEg.p"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(1389307920U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 6);
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut("intmax"), "name", "name", 6);
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
                  "resolved", 6);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(1362261882U), "fileTimeLo",
                  "fileTimeLo", 6);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 6);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c37_info, c37_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_switch_helper.m"),
                  "resolved", "resolved", 7);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(1381850300U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c37_info, c37_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  const mxArray *c37_u, const emlrtMsgIdentifier *c37_parentId)
{
  ...
  int32_T c37_i20;
  (void)chartInstance;
  sf_mex_import(c37_parentId, sf_mex_dup(c37_u), &c37_i20, 1, 6, 0U, 0, 0U, 0);
  c37_y = c37_i20;
  sf_mex_destroy(&c37_u);
  return c37_y;
}
  ...
  const mxArray *c37_b_is_active_c37_CSE1_DP, const char_T *c37_identifier)
{
  ...
  c37_y = c37_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c37_b_is_active_c37_CSE1_DP), &c37_thisId);
  sf_mex_destroy(&c37_b_is_active_c37_CSE1_DP);
  return c37_y;
}
...
void sf_c37_CSE1_DP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c37_CSE1_DP_get_autoinheritance_info(void)
{
...
mxArray *sf_c37_CSE1_DP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c37_CSE1_DP_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c37_CSE1_DP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"w_d\",},{M[8],M[0],T\"is_active_c37_CSE1_DP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c37_CSE1_DP_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc37_CSE1_DPInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          real_T (*c37_w_d)[9];
          real_T (*c37_w_d_vector)[3];
          c37_w_d_vector = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S,
            0);
          c37_w_d = (real_T (*)[9])ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, *c37_w_d);
          _SFD_SET_DATA_VALUE_PTR(1U, *c37_w_d_vector);
        }
      }
    } else {
...
static void sf_opaque_initialize_c37_CSE1_DP(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc37_CSE1_DPInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c37_CSE1_DP((SFc37_CSE1_DPInstanceStruct*) chartInstanceVar);
  initialize_c37_CSE1_DP((SFc37_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c37_CSE1_DP(void *chartInstanceVar)
{
  enable_c37_CSE1_DP((SFc37_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c37_CSE1_DP(void *chartInstanceVar)
{
  disable_c37_CSE1_DP((SFc37_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c37_CSE1_DP(void *chartInstanceVar)
{
  sf_gateway_c37_CSE1_DP((SFc37_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c37_CSE1_DP(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c37_CSE1_DP((SFc37_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c37_CSE1_DP();/* state var info */
...
extern void sf_internal_set_sim_state_c37_CSE1_DP(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c37_CSE1_DP();/* state var info */
  ...
  set_sim_state_c37_CSE1_DP((SFc37_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c37_CSE1_DP(SimStruct* S)
{
  return sf_internal_get_sim_state_c37_CSE1_DP(S);
}

static void sf_opaque_set_sim_state_c37_CSE1_DP(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c37_CSE1_DP(S, st);
}

static void sf_opaque_terminate_c37_CSE1_DP(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc37_CSE1_DPInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c37_CSE1_DP((SFc37_CSE1_DPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc37_CSE1_DP((SFc37_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c37_CSE1_DP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c37_CSE1_DP((SFc37_CSE1_DPInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c37_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c37_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c37_CSE1_DP(SimStruct *S)
{
  SFc37_CSE1_DPInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc37_CSE1_DPInstanceStruct *)utMalloc(sizeof
    (SFc37_CSE1_DPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc37_CSE1_DPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c37_CSE1_DP;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c37_CSE1_DP;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c37_CSE1_DP;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c37_CSE1_DP;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c37_CSE1_DP;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c37_CSE1_DP;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c37_CSE1_DP;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c37_CSE1_DP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c37_CSE1_DP;
  chartInstance->chartInfo.mdlStart = mdlStart_c37_CSE1_DP;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c37_CSE1_DP;
...
void c37_CSE1_DP_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c37_CSE1_DP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c37_CSE1_DP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c37_CSE1_DP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c37_CSE1_DP_method_dispatcher.\n"
