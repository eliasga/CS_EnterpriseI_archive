...
static void initialize_c39_CSE1_DP(SFc39_CSE1_DPInstanceStruct *chartInstance);
static void initialize_params_c39_CSE1_DP(SFc39_CSE1_DPInstanceStruct
  *chartInstance);
static void enable_c39_CSE1_DP(SFc39_CSE1_DPInstanceStruct *chartInstance);
static void disable_c39_CSE1_DP(SFc39_CSE1_DPInstanceStruct *chartInstance);
static void c39_update_debugger_state_c39_CSE1_DP(SFc39_CSE1_DPInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c39_CSE1_DP(SFc39_CSE1_DPInstanceStruct
  *chartInstance);
static void set_sim_state_c39_CSE1_DP(SFc39_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c39_st);
static void finalize_c39_CSE1_DP(SFc39_CSE1_DPInstanceStruct *chartInstance);
static void sf_gateway_c39_CSE1_DP(SFc39_CSE1_DPInstanceStruct *chartInstance);
static void initSimStructsc39_CSE1_DP(SFc39_CSE1_DPInstanceStruct *chartInstance);
...
static const mxArray *c39_sf_marshallOut(void *chartInstanceVoid, void
  *c39_inData);
static void c39_emlrt_marshallIn(SFc39_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c39_K_p, const char_T *c39_identifier, real_T c39_y[9]);
static void c39_b_emlrt_marshallIn(SFc39_CSE1_DPInstanceStruct *chartInstance,
...
static const mxArray *c39_c_sf_marshallOut(void *chartInstanceVoid, void
  *c39_inData);
static real_T c39_c_emlrt_marshallIn(SFc39_CSE1_DPInstanceStruct *chartInstance,
...
static const mxArray *c39_d_sf_marshallOut(void *chartInstanceVoid, void
  *c39_inData);
static int32_T c39_d_emlrt_marshallIn(SFc39_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c39_u, const emlrtMsgIdentifier *c39_parentId);
static void c39_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c39_mxArrayInData, const char_T *c39_varName, void *c39_outData);
static uint8_T c39_e_emlrt_marshallIn(SFc39_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c39_b_is_active_c39_CSE1_DP, const char_T *c39_identifier);
static uint8_T c39_f_emlrt_marshallIn(SFc39_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c39_u, const emlrtMsgIdentifier *c39_parentId);
static void init_dsm_address_info(SFc39_CSE1_DPInstanceStruct *chartInstance);
...
static void initialize_c39_CSE1_DP(SFc39_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c39_is_active_c39_CSE1_DP = 0U;
}
  ...
  *chartInstance)
{
  ...
  c39_hoistedGlobal = chartInstance->c39_is_active_c39_CSE1_DP;
  ...
  const mxArray *c39_st)
{
  ...
  chartInstance->c39_is_active_c39_CSE1_DP = c39_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c39_u, 1)),
     "is_active_c39_CSE1_DP");
  sf_mex_destroy(&c39_u);
  c39_update_debugger_state_c39_CSE1_DP(chartInstance);
  ...
  *c39_inData)
{
  ...
  real_T c39_u[9];
  const mxArray *c39_y = NULL;
  SFc39_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc39_CSE1_DPInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c39_CSE1_DP_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c39_b_is_active_c39_CSE1_DP, const char_T *c39_identifier)
{
  ...
  c39_y = c39_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c39_b_is_active_c39_CSE1_DP), &c39_thisId);
  sf_mex_destroy(&c39_b_is_active_c39_CSE1_DP);
  return c39_y;
}
...
void sf_c39_CSE1_DP_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c39_CSE1_DP_get_autoinheritance_info(void)
{
...
mxArray *sf_c39_CSE1_DP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c39_CSE1_DP_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c39_CSE1_DP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"K_p\",},{M[8],M[0],T\"is_active_c39_CSE1_DP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c39_CSE1_DP_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc39_CSE1_DPInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c39_CSE1_DP(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc39_CSE1_DPInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c39_CSE1_DP((SFc39_CSE1_DPInstanceStruct*) chartInstanceVar);
  initialize_c39_CSE1_DP((SFc39_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c39_CSE1_DP(void *chartInstanceVar)
{
  enable_c39_CSE1_DP((SFc39_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c39_CSE1_DP(void *chartInstanceVar)
{
  disable_c39_CSE1_DP((SFc39_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c39_CSE1_DP(void *chartInstanceVar)
{
  sf_gateway_c39_CSE1_DP((SFc39_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c39_CSE1_DP(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c39_CSE1_DP((SFc39_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c39_CSE1_DP();/* state var info */
...
extern void sf_internal_set_sim_state_c39_CSE1_DP(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c39_CSE1_DP();/* state var info */
  ...
  set_sim_state_c39_CSE1_DP((SFc39_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c39_CSE1_DP(SimStruct* S)
{
  return sf_internal_get_sim_state_c39_CSE1_DP(S);
}

static void sf_opaque_set_sim_state_c39_CSE1_DP(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c39_CSE1_DP(S, st);
}

static void sf_opaque_terminate_c39_CSE1_DP(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc39_CSE1_DPInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c39_CSE1_DP((SFc39_CSE1_DPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc39_CSE1_DP((SFc39_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c39_CSE1_DP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c39_CSE1_DP((SFc39_CSE1_DPInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c39_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c39_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c39_CSE1_DP(SimStruct *S)
{
  SFc39_CSE1_DPInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc39_CSE1_DPInstanceStruct *)utMalloc(sizeof
    (SFc39_CSE1_DPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc39_CSE1_DPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c39_CSE1_DP;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c39_CSE1_DP;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c39_CSE1_DP;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c39_CSE1_DP;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c39_CSE1_DP;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c39_CSE1_DP;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c39_CSE1_DP;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c39_CSE1_DP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c39_CSE1_DP;
  chartInstance->chartInfo.mdlStart = mdlStart_c39_CSE1_DP;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c39_CSE1_DP;
...
void c39_CSE1_DP_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c39_CSE1_DP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c39_CSE1_DP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c39_CSE1_DP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c39_CSE1_DP_method_dispatcher.\n"
