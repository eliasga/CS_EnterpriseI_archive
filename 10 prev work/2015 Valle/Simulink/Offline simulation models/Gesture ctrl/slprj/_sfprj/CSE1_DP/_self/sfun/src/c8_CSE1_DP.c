...
static const char * c8_debug_family_names[7] = { "psi", "J", "nargin", "nargout",
  "nu", "eta", "eta_dot" };

/* Function Declarations */
static void initialize_c8_CSE1_DP(SFc8_CSE1_DPInstanceStruct *chartInstance);
static void initialize_params_c8_CSE1_DP(SFc8_CSE1_DPInstanceStruct
  *chartInstance);
static void enable_c8_CSE1_DP(SFc8_CSE1_DPInstanceStruct *chartInstance);
static void disable_c8_CSE1_DP(SFc8_CSE1_DPInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_CSE1_DP(SFc8_CSE1_DPInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c8_CSE1_DP(SFc8_CSE1_DPInstanceStruct
  *chartInstance);
static void set_sim_state_c8_CSE1_DP(SFc8_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c8_st);
static void finalize_c8_CSE1_DP(SFc8_CSE1_DPInstanceStruct *chartInstance);
static void sf_gateway_c8_CSE1_DP(SFc8_CSE1_DPInstanceStruct *chartInstance);
static void initSimStructsc8_CSE1_DP(SFc8_CSE1_DPInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static void c8_emlrt_marshallIn(SFc8_CSE1_DPInstanceStruct *chartInstance, const
  mxArray *c8_eta_dot, const char_T *c8_identifier, real_T c8_y[3]);
static void c8_b_emlrt_marshallIn(SFc8_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[3]);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static real_T c8_c_emlrt_marshallIn(SFc8_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_d_emlrt_marshallIn(SFc8_CSE1_DPInstanceStruct *chartInstance,
...
static void c8_eml_scalar_eg(SFc8_CSE1_DPInstanceStruct *chartInstance);
static void c8_eml_xgemm(SFc8_CSE1_DPInstanceStruct *chartInstance, real_T c8_A
  [9], real_T c8_B[3], real_T c8_C[3], real_T c8_b_C[3]);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_e_emlrt_marshallIn(SFc8_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_f_emlrt_marshallIn(SFc8_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c8_b_is_active_c8_CSE1_DP, const char_T *c8_identifier);
static uint8_T c8_g_emlrt_marshallIn(SFc8_CSE1_DPInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_eml_xgemm(SFc8_CSE1_DPInstanceStruct *chartInstance, real_T
  c8_A[9], real_T c8_B[3], real_T c8_C[3]);
static void init_dsm_address_info(SFc8_CSE1_DPInstanceStruct *chartInstance);
...
static void initialize_c8_CSE1_DP(SFc8_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_CSE1_DP = 0U;
}
  ...
  const mxArray *c8_st)
{
  ...
  for (c8_i1 = 0; c8_i1 < 3; c8_i1++) {
    (*c8_eta_dot)[c8_i1] = c8_dv0[c8_i1];
  }

  chartInstance->c8_is_active_c8_CSE1_DP = c8_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c8_u, 1)), "is_active_c8_CSE1_DP");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_CSE1_DP(chartInstance);
...
static void sf_gateway_c8_CSE1_DP(SFc8_CSE1_DPInstanceStruct *chartInstance)
{
  ...
  int32_T c8_i5;
  int32_T c8_i6;
  static real_T c8_dv1[3] = { 0.0, 0.0, 1.0 };
  ...
  int32_T c8_i16;
  int32_T c8_i17;
  real_T (*c8_b_eta_dot)[3];
  real_T (*c8_b_eta)[3];
  real_T (*c8_b_nu)[3];
  c8_b_eta = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  c8_b_eta_dot = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c8_b_nu = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 7U, chartInstance->c8_sfEvent);
  for (c8_i2 = 0; c8_i2 < 3; c8_i2++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_nu)[c8_i2], 0U);
  }

  chartInstance->c8_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 7U, chartInstance->c8_sfEvent);
  for (c8_i3 = 0; c8_i3 < 3; c8_i3++) {
    c8_nu[c8_i3] = (*c8_b_nu)[c8_i3];
  }

  for (c8_i4 = 0; c8_i4 < 3; c8_i4++) {
    c8_eta[c8_i4] = (*c8_b_eta)[c8_i4];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 7U, 7U, c8_debug_family_names,
    c8_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_psi, 0U, c8_b_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_J, 1U, c8_c_sf_marshallOut,
    c8_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c8_nargout, 3U, c8_b_sf_marshallOut,
    c8_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c8_nu, 4U, c8_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c8_eta, 5U, c8_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c8_eta_dot, 6U, c8_sf_marshallOut,
    c8_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c8_i14 = 0; c8_i14 < 3; c8_i14++) {
    c8_dv5[c8_i14] = c8_dv3[c8_i14];
  }

  c8_b_eml_xgemm(chartInstance, c8_dv4, c8_dv5, c8_eta_dot);
  _SFD_EML_CALL(0U, chartInstance->c8_sfEvent, -9);
  _SFD_SYMBOL_SCOPE_POP();
  for (c8_i15 = 0; c8_i15 < 3; c8_i15++) {
    (*c8_b_eta_dot)[c8_i15] = c8_eta_dot[c8_i15];
  }
  ...
  for (c8_i16 = 0; c8_i16 < 3; c8_i16++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_eta_dot)[c8_i16], 1U);
  }

  for (c8_i17 = 0; c8_i17 < 3; c8_i17++) {
    _SFD_DATA_RANGE_CHECK((*c8_b_eta)[c8_i17], 2U);
  }
}
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  real_T c8_u[3];
  const mxArray *c8_y = NULL;
  SFc8_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc8_CSE1_DPInstanceStruct *)chartInstanceVoid;
  c8_mxArrayOutData = NULL;
  for (c8_i18 = 0; c8_i18 < 3; c8_i18++) {
    c8_b_inData[c8_i18] = (*(real_T (*)[3])c8_inData)[c8_i18];
  }
  ...
  mxArray *c8_eta_dot, const char_T *c8_identifier, real_T c8_y[3])
{
  ...
  c8_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_eta_dot), &c8_thisId, c8_y);
  sf_mex_destroy(&c8_eta_dot);
}
  ...
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[3])
{
  ...
  int32_T c8_i20;
  (void)chartInstance;
  sf_mex_import(c8_parentId, sf_mex_dup(c8_u), c8_dv6, 1, 0, 0U, 1, 0U, 1, 3);
  for (c8_i20 = 0; c8_i20 < 3; c8_i20++) {
    c8_y[c8_i20] = c8_dv6[c8_i20];
  }
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  SFc8_CSE1_DPInstanceStruct *chartInstance;
  chartInstance = (SFc8_CSE1_DPInstanceStruct *)chartInstanceVoid;
  c8_eta_dot = sf_mex_dup(c8_mxArrayInData);
  ...
  for (c8_i21 = 0; c8_i21 < 3; c8_i21++) {
    (*(real_T (*)[3])c8_outData)[c8_i21] = c8_y[c8_i21];
  }
  ...
  *c8_inData)
{
  ...
  for (c8_i23 = 0; c8_i23 < 3; c8_i23++) {
    for (c8_i24 = 0; c8_i24 < 3; c8_i24++) {
      c8_b_inData[c8_i24 + c8_i22] = (*(real_T (*)[9])c8_inData)[c8_i24 + c8_i22];
    }
  ...
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId, real_T c8_y[9])
{
  ...
  int32_T c8_i28;
  (void)chartInstance;
  sf_mex_import(c8_parentId, sf_mex_dup(c8_u), c8_dv7, 1, 0, 0U, 1, 0U, 2, 3, 3);
  for (c8_i28 = 0; c8_i28 < 9; c8_i28++) {
    c8_y[c8_i28] = c8_dv7[c8_i28];
  }
  ...
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData)
{
  ...
  c8_thisId.fIdentifier = c8_identifier;
  c8_thisId.fParent = NULL;
  c8_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c8_J), &c8_thisId, c8_y);
  sf_mex_destroy(&c8_J);
  c8_i29 = 0;
  for (c8_i30 = 0; c8_i30 < 3; c8_i30++) {
    for (c8_i31 = 0; c8_i31 < 3; c8_i31++) {
      (*(real_T (*)[9])c8_outData)[c8_i31 + c8_i29] = c8_y[c8_i31 + c8_i29];
    }
...
const mxArray *sf_c8_CSE1_DP_get_eml_resolved_functions_info(void)
{
  const mxArray *c8_nameCaptureInfo = NULL;
  c8_nameCaptureInfo = NULL;
  sf_mex_assign(&c8_nameCaptureInfo, sf_mex_createstruct("structure", 2, 17, 1),
                false);
...
static void c8_info_helper(const mxArray **c8_info)
{
  ...
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/eml_mtimes_helper.m"),
                  "context", "context", 9);
  sf_mex_addfield(*c8_info, c8_emlrt_marshallOut("eml_xgemm"), "name", "name", 9);
  ...
  [9], real_T c8_B[3], real_T c8_C[3], real_T c8_b_C[3])
{
  ...
  for (c8_i32 = 0; c8_i32 < 3; c8_i32++) {
    c8_b_C[c8_i32] = c8_C[c8_i32];
  }

  for (c8_i33 = 0; c8_i33 < 9; c8_i33++) {
    c8_b_A[c8_i33] = c8_A[c8_i33];
  }

  for (c8_i34 = 0; c8_i34 < 3; c8_i34++) {
    c8_b_B[c8_i34] = c8_B[c8_i34];
  }
  ...
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId)
{
  ...
  int32_T c8_i35;
  (void)chartInstance;
  sf_mex_import(c8_parentId, sf_mex_dup(c8_u), &c8_i35, 1, 6, 0U, 0, 0U, 0);
  c8_y = c8_i35;
  sf_mex_destroy(&c8_u);
  return c8_y;
}
  ...
  const mxArray *c8_b_is_active_c8_CSE1_DP, const char_T *c8_identifier)
{
  ...
  c8_y = c8_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_CSE1_DP), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_CSE1_DP);
  return c8_y;
}
  ...
  c8_A[9], real_T c8_B[3], real_T c8_C[3])
{
  ...
  for (c8_i36 = 0; c8_i36 < 3; c8_i36++) {
    ...
    for (c8_i38 = 0; c8_i38 < 3; c8_i38++) {
      c8_C[c8_i36] += c8_A[c8_i37 + c8_i36] * c8_B[c8_i38];
      c8_i37 += 3;
    }
  }
}
...
void sf_c8_CSE1_DP_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1395079243U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1288549997U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2360211020U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(577340113U);
}

mxArray *sf_c8_CSE1_DP_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("okeqYHwyl9PihwAJUQ2HdG");
...
mxArray *sf_c8_CSE1_DP_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_CSE1_DP_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c8_CSE1_DP(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"eta_dot\",},{M[8],M[0],T\"is_active_c8_CSE1_DP\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_CSE1_DP_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc8_CSE1_DPInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c8_eta_dot)[3];
          real_T (*c8_eta)[3];
          c8_eta = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
          c8_eta_dot = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
          c8_nu = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, *c8_nu);
          _SFD_SET_DATA_VALUE_PTR(1U, *c8_eta_dot);
          _SFD_SET_DATA_VALUE_PTR(2U, *c8_eta);
        }
      }
    } else {
...
{
  return "ZjfmuoepoxiTfNG0Mw0opE";
}

static void sf_opaque_initialize_c8_CSE1_DP(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_CSE1_DPInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c8_CSE1_DP((SFc8_CSE1_DPInstanceStruct*) chartInstanceVar);
  initialize_c8_CSE1_DP((SFc8_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_CSE1_DP(void *chartInstanceVar)
{
  enable_c8_CSE1_DP((SFc8_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_CSE1_DP(void *chartInstanceVar)
{
  disable_c8_CSE1_DP((SFc8_CSE1_DPInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_CSE1_DP(void *chartInstanceVar)
{
  sf_gateway_c8_CSE1_DP((SFc8_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_CSE1_DP(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_CSE1_DP((SFc8_CSE1_DPInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_CSE1_DP();/* state var info */
...
extern void sf_internal_set_sim_state_c8_CSE1_DP(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c8_CSE1_DP();/* state var info */
  ...
  set_sim_state_c8_CSE1_DP((SFc8_CSE1_DPInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_CSE1_DP(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_CSE1_DP(S);
}

static void sf_opaque_set_sim_state_c8_CSE1_DP(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c8_CSE1_DP(S, st);
}

static void sf_opaque_terminate_c8_CSE1_DP(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_CSE1_DPInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c8_CSE1_DP((SFc8_CSE1_DPInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_CSE1_DP((SFc8_CSE1_DPInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_CSE1_DP(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c8_CSE1_DP((SFc8_CSE1_DPInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3279935310U));
  ssSetChecksum1(S,(1396820417U));
  ssSetChecksum2(S,(2348012743U));
  ssSetChecksum3(S,(388097403U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c8_CSE1_DP(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_CSE1_DP(SimStruct *S)
{
  SFc8_CSE1_DPInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_CSE1_DPInstanceStruct *)utMalloc(sizeof
    (SFc8_CSE1_DPInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_CSE1_DPInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c8_CSE1_DP;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c8_CSE1_DP;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c8_CSE1_DP;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_CSE1_DP;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_CSE1_DP;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c8_CSE1_DP;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c8_CSE1_DP;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c8_CSE1_DP;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_CSE1_DP;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_CSE1_DP;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_CSE1_DP;
...
void c8_CSE1_DP_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_CSE1_DP(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_CSE1_DP(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_CSE1_DP(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_CSE1_DP_method_dispatcher.\n"
