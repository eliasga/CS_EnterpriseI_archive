...
static const char * c2_debug_family_names[15] = { "speed_min", "speed_max",
  "torque_min", "torque_max", "bellow_zone", "t_timer", "reference_speed",
  "nargin", "nargout", "optimal_speed", "generator_torque", "time",
  "bellow_zone_old", "t_timer_old", "y" };
...
static void sf_gateway_c2_untitled(SFc2_untitledInstanceStruct *chartInstance)
{
  ...
  real_T c2_optimal_speed;
  real_T c2_generator_torque;
  real_T c2_time;
  real_T c2_bellow_zone_old;
  real_T c2_t_timer_old;
  uint32_T c2_debug_family_var_map[15];
  real_T c2_speed_min;
  real_T c2_speed_max;
  real_T c2_torque_min;
  real_T c2_torque_max;
  real_T c2_bellow_zone;
  real_T c2_t_timer;
  real_T c2_reference_speed;
  real_T c2_nargin = 5.0;
  real_T c2_nargout = 1.0;
  real_T c2_y[3];
  int32_T c2_i2;
  int32_T c2_i3;
  real_T *c2_b_optimal_speed;
  real_T *c2_b_generator_torque;
  real_T *c2_b_time;
  real_T *c2_b_bellow_zone_old;
  real_T *c2_b_t_timer_old;
  real_T (*c2_b_y)[3];
  boolean_T guard1 = false;
  boolean_T guard2 = false;
  c2_b_t_timer_old = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c2_b_bellow_zone_old = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c2_b_time = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c2_b_generator_torque = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c2_b_y = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c2_b_optimal_speed = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c2_b_optimal_speed, 0U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c2_sfEvent);
  c2_hoistedGlobal = *c2_b_optimal_speed;
  c2_b_hoistedGlobal = *c2_b_generator_torque;
  c2_c_hoistedGlobal = *c2_b_time;
  c2_d_hoistedGlobal = *c2_b_bellow_zone_old;
  c2_e_hoistedGlobal = *c2_b_t_timer_old;
  c2_optimal_speed = c2_hoistedGlobal;
  c2_generator_torque = c2_b_hoistedGlobal;
  c2_time = c2_c_hoistedGlobal;
  c2_bellow_zone_old = c2_d_hoistedGlobal;
  c2_t_timer_old = c2_e_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 15U, 15U, c2_debug_family_names,
    c2_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_speed_min, 0U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_speed_max, 1U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_torque_min, 2U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_torque_max, 3U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_bellow_zone, 4U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_t_timer, 5U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_reference_speed, 6U,
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 8U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_optimal_speed, 9U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_generator_torque, 10U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_time, 11U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_bellow_zone_old, 12U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_t_timer_old, 13U, c2_b_sf_marshallOut);
  ...
  c2_torque_min = 29011.0;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 6);
  c2_torque_max = 41388.999999999993;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 7);
  c2_bellow_zone = c2_bellow_zone_old;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 8);
  c2_t_timer = c2_t_timer_old;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 10);
  guard1 = false;
  if (CV_EML_COND(0, 1, 0, c2_bellow_zone == 1.0)) {
    if (CV_EML_COND(0, 1, 1, c2_generator_torque > c2_torque_min)) {
      CV_EML_MCDC(0, 1, 0, true);
      CV_EML_IF(0, 1, 0, true);
      _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 11);
      if (CV_EML_IF(0, 1, 1, c2_generator_torque > c2_torque_max)) {
        _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 12);
        if (CV_EML_IF(0, 1, 2, c2_t_timer == 0.0)) {
          _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 13);
          c2_t_timer = c2_time;
        }

        _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 15);
        if (CV_EML_IF(0, 1, 3, c2_time - c2_t_timer > 10.0)) {
          _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 16);
          c2_bellow_zone = 0.0;
          _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 17);
          c2_reference_speed = c2_optimal_speed;
        }
      } else {
        _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 20);
        c2_t_timer = 0.0;
        _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 21);
        c2_reference_speed = c2_speed_min;
      }
    } else {
      guard1 = true;
    }
  ...
  if (guard1 == true) {
    ...
    guard2 = false;
    if (CV_EML_COND(0, 1, 2, c2_bellow_zone == 0.0)) {
      if (CV_EML_COND(0, 1, 3, c2_generator_torque < c2_torque_max)) {
        CV_EML_MCDC(0, 1, 1, true);
        CV_EML_IF(0, 1, 4, true);
        _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 24);
        if (CV_EML_IF(0, 1, 5, c2_generator_torque < c2_torque_min)) {
          _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 25);
          if (CV_EML_IF(0, 1, 6, c2_t_timer == 0.0)) {
            _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 26);
            c2_t_timer = c2_time;
          }

          _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 28);
          if (CV_EML_IF(0, 1, 7, c2_time - c2_t_timer > 10.0)) {
          ...
          c2_reference_speed = c2_speed_max;
        }
      } else {
        guard2 = true;
      }
  ...
  c2_y[0] = c2_reference_speed;
  c2_y[1] = c2_bellow_zone;
  c2_y[2] = c2_t_timer;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -42);
  ...
  _SFD_DATA_RANGE_CHECK(*c2_b_generator_torque, 2U);
  _SFD_DATA_RANGE_CHECK(*c2_b_time, 3U);
  _SFD_DATA_RANGE_CHECK(*c2_b_bellow_zone_old, 4U);
  _SFD_DATA_RANGE_CHECK(*c2_b_t_timer_old, 5U);
}
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  for (c2_i4 = 0; c2_i4 < 3; c2_i4++) {
    c2_b_inData[c2_i4] = (*(real_T (*)[3])c2_inData)[c2_i4];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i7 = 0; c2_i7 < 3; c2_i7++) {
    (*(real_T (*)[3])c2_outData)[c2_i7] = c2_b_y[c2_i7];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(936206552U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2441664390U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2844854697U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2212176160U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("s9MR9aAOLOFkqhdwWuGCj");
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"optimal_speed");
          _SFD_SET_DATA_PROPS(1,2,0,1,"y");
          _SFD_SET_DATA_PROPS(2,1,1,0,"generator_torque");
          _SFD_SET_DATA_PROPS(3,1,1,0,"time");
          _SFD_SET_DATA_PROPS(4,1,1,0,"bellow_zone_old");
          _SFD_SET_DATA_PROPS(5,1,1,0,"t_timer_old");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,368,416,699,1077);
        _SFD_CV_INIT_EML_IF(0,1,1,422,452,631,697);
        _SFD_CV_INIT_EML_IF(0,1,2,462,475,-1,514);
        _SFD_CV_INIT_EML_IF(0,1,3,524,542,-1,625);
        _SFD_CV_INIT_EML_IF(0,1,4,699,751,1034,1077);
        _SFD_CV_INIT_EML_IF(0,1,5,757,787,966,1032);
        _SFD_CV_INIT_EML_IF(0,1,6,797,810,-1,849);
        _SFD_CV_INIT_EML_IF(0,1,7,859,877,-1,960);

        {
          static int condStart[] = { 371, 389 };

          static int condEnd[] = { 385, 416 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,371,416,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 706, 724 };

          static int condEnd[] = { 720, 751 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,706,751,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...

        {
          ...
          real_T *c2_t_timer_old;
          real_T (*c2_y)[3];
          c2_t_timer_old = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
          c2_bellow_zone_old = (real_T *)ssGetInputPortSignal(chartInstance->S,
            3);
          c2_time = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c2_generator_torque = (real_T *)ssGetInputPortSignal(chartInstance->S,
            1);
          c2_y = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
          c2_optimal_speed = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c2_optimal_speed);
          _SFD_SET_DATA_VALUE_PTR(1U, *c2_y);
          _SFD_SET_DATA_VALUE_PTR(2U, c2_generator_torque);
          _SFD_SET_DATA_VALUE_PTR(3U, c2_time);
          _SFD_SET_DATA_VALUE_PTR(4U, c2_bellow_zone_old);
          _SFD_SET_DATA_VALUE_PTR(5U, c2_t_timer_old);
        }
      }
    } else {
  ...
  *st)
{
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_untitled();/* state var info */
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2279169296U));
  ssSetChecksum1(S,(3753899919U));
  ssSetChecksum2(S,(3827947999U));
  ssSetChecksum3(S,(2874614902U));
