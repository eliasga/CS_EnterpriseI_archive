 ...
 */
#ifndef RTW_HEADER_BP_MC1_h_
#define RTW_HEADER_BP_MC1_h_
#ifndef BP_MC1_COMMON_INCLUDES_
# define BP_MC1_COMMON_INCLUDES_
#include <stddef.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* BP_MC1_COMMON_INCLUDES_ */

#include "BP_MC1_types.h"
...
#define BP_MC1_rtModel                 RT_MODEL_BP_MC1

/* Block signals (auto storage) */
typedef struct {
  real_T u1;                           /* '<S3>/Scaling_JS_L_X' */
  real_T Sign;                         /* '<S4>/Sign' */
  real_T PortVPS_X;                    /* '<S4>/Product1' */
  real_T PortVPS_X_g;                  /* '<S4>/Neg1' */
  real_T u1_p;                         /* '<S3>/Scaling_JS_L_Y' */
  real_T PortVSP_Y;                    /* '<S4>/Product2' */
  real_T PortVSP_Y_i;                  /* '<S4>/Neg2' */
  real_T u1_g;                         /* '<S3>/Scaling_JS_R_X' */
  real_T StarboardVSP_X;               /* '<S4>/Product3' */
  real_T u1_pj;                        /* '<S3>/Scaling_JS_R_Y' */
  real_T StarboardVSP_Y;               /* '<S4>/Product4' */
  real_T Servo1;                       /* '<S4>/Servo1' */
  real_T Servo2;                       /* '<S4>/Servo2' */
  real_T Servo3;                       /* '<S4>/Servo3' */
  real_T Servo4;                       /* '<S4>/Servo4' */
  real_T VPS_Speed_Gain;               /* '<S4>/VPS_Speed_Gain' */
  real_T Sum;                          /* '<S4>/Sum' */
  real_T BowThrusterdirection;         /* '<S2>/Add' */
  real_T BT_D_Gain1;                   /* '<S4>/BT_D_Gain1' */
  real_T BT_D_Gain2;                   /* '<S4>/BT_D_Gain2' */
  real_T Add;                          /* '<S4>/Add' */
  real_T BT_L_Gain1;                   /* '<S4>/BT_L_Gain1' */
  real_T BT_L_Gain2;                   /* '<S4>/BT_L_Gain2' */
  real_T Sum1;                         /* '<S4>/Sum1' */
  real_T Sum2;                         /* '<S4>/Sum2' */
  real_T Switch;                       /* '<S5>/Switch' */
  real_T Switch2;                      /* '<S5>/Switch2' */
  boolean_T LowerRelop1;               /* '<S5>/LowerRelop1' */
  boolean_T UpperRelop;                /* '<S5>/UpperRelop' */
} BlockIO_BP_MC1;
...
#define rtB                            BP_MC1_B
#define BlockIO                        BlockIO_BP_MC1
#define rtXdot                         BP_MC1_Xdot
#define StateDerivatives               StateDerivatives_BP_MC1
#define tXdis                          BP_MC1_Xdis
#define StateDisabled                  StateDisabled_BP_MC1
#define rtP                            BP_MC1_P
#define Parameters                     Parameters_BP_MC1
#define rtDWork                        BP_MC1_DWork
#define D_Work                         D_Work_BP_MC1

/* Parameters (auto storage) */
struct Parameters_BP_MC1_ {
  ...
  real_T SITOut4Servo4_P6;             /* Expression: btype
                                        * Referenced by: '<S4>/SIT Out4 Servo4'
                                        */
  real_T SITOut5VSPSPort_P1;           /* Expression: width
                                        * Referenced by: '<S4>/SIT Out5 VSPS Port '
                                        */
  real_T SITOut5VSPSPort_P2;           /* Expression: dtype
                                        * Referenced by: '<S4>/SIT Out5 VSPS Port '
                                        */
  real_T SITOut5VSPSPort_P3;           /* Expression: portnum
                                        * Referenced by: '<S4>/SIT Out5 VSPS Port '
                                        */
  real_T SITOut5VSPSPort_P4;           /* Expression: stime
                                        * Referenced by: '<S4>/SIT Out5 VSPS Port '
                                        */
  real_T SITOut5VSPSPort_P5;           /* Expression: stype
                                        * Referenced by: '<S4>/SIT Out5 VSPS Port '
                                        */
  real_T SITOut5VSPSPort_P6;           /* Expression: btype
                                        * Referenced by: '<S4>/SIT Out5 VSPS Port '
                                        */
  real_T SITOut6VSPSStarboard_P1;      /* Expression: width
                                        * Referenced by: '<S4>/SIT Out6 VSPS Starboard'
                                        */
  real_T SITOut6VSPSStarboard_P2;      /* Expression: dtype
                                        * Referenced by: '<S4>/SIT Out6 VSPS Starboard'
                                        */
  real_T SITOut6VSPSStarboard_P3;      /* Expression: portnum
                                        * Referenced by: '<S4>/SIT Out6 VSPS Starboard'
                                        */
  real_T SITOut6VSPSStarboard_P4;      /* Expression: stime
                                        * Referenced by: '<S4>/SIT Out6 VSPS Starboard'
                                        */
  real_T SITOut6VSPSStarboard_P5;      /* Expression: stype
                                        * Referenced by: '<S4>/SIT Out6 VSPS Starboard'
                                        */
  real_T SITOut6VSPSStarboard_P6;      /* Expression: btype
                                        * Referenced by: '<S4>/SIT Out6 VSPS Starboard'
                                        */
  ...
  real_T Scaling_JS_L_X_Gain;          /* Expression: 1/32767
                                        ...
                                        */
  real_T LabVIEW_VSPS_Value;           /* Expression: 0
  ...
  real_T VPS_Power_Offset_Value;       /* Expression: 0.05
                                        ...
                                        */
  real_T SITOut7BT_P1;                 /* Expression: width
                                        * Referenced by: '<S4>/SIT Out7 BT'
                                        */
  real_T SITOut7BT_P2;                 /* Expression: dtype
                                        * Referenced by: '<S4>/SIT Out7 BT'
                                        */
  real_T SITOut7BT_P3;                 /* Expression: portnum
                                        * Referenced by: '<S4>/SIT Out7 BT'
                                        */
  real_T SITOut7BT_P4;                 /* Expression: stime
                                        * Referenced by: '<S4>/SIT Out7 BT'
                                        */
  real_T SITOut7BT_P5;                 /* Expression: stype
                                        * Referenced by: '<S4>/SIT Out7 BT'
                                        */
  real_T SITOut7BT_P6;                 /* Expression: btype
                                        * Referenced by: '<S4>/SIT Out7 BT'
                                        */
  ...
  real_T BT_D_Gain2_Gain;              /* Expression: 0.02
                                        ...
                                        */
  real_T LabVIEW_BT_Limit_Value;       /* Expression: 0
...
extern Parameters_BP_MC1 BP_MC1_P;

/* Block signals (auto storage) */
extern BlockIO_BP_MC1 BP_MC1_B;

/* Block states (auto storage) */
extern D_Work_BP_MC1 BP_MC1_DWork;

/* Real-time Model object */
extern RT_MODEL_BP_MC1 *BP_MC1_M;
 ...
 *
 * '<Root>' : BP_MC1
 * '<S1>'   : BP_MC1/Labview Output
 * '<S2>'   : BP_MC1/Manual Thrust controll
 * '<S3>'   : BP_MC1/PS3 Controller Output
 * '<S4>'   : BP_MC1/Thurster Allocation
 * '<S5>'   : BP_MC1/Thurster Allocation/Saturation Dynamic
 */
#endif                                 /* RTW_HEADER_BP_MC1_h_ */
...
Parameters_BP_MC1 rtParameter[NUMST+!TID01EQ];

#define BP_MC1_P                       (*param_lookup[tid][READSIDE])

Parameters_BP_MC1 *param_lookup[NUMST][2] = {
  { &rtParameter[0], &rtParameter[1] },
};

#else

Parameters_BP_MC1 rtParameter[2];

#define BP_MC1_P                       rtParameter[READSIDE]
#endif
