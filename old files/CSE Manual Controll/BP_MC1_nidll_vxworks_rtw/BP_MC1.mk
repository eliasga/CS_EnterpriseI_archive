...
#
# File    : BP_MC1.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           := BP_MC1
MODULES         := BP_MC1_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_look.c rt_look2d_normal.c rt_nonfinite.c 
MAKEFILE        := BP_MC1.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\DOCUME~1\NAMDIN~1.IIM\Desktop\MANUAL~1\BP_MC1_nidll_vxworks_rtw
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\DOCUME~1\NAMDIN~1.IIM\Desktop\MANUAL~1
