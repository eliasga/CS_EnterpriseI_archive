...
#
# File    : CSE1_CV3_1Straight.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           := CSE1_CV3_1Straight
MODULES         := CSE1_CV3_1Straight_data.c is_little_endian_rt.c rtGetInf.c rtGetNaN.c rt_atan2_snf.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_hypot_snf.c rt_logging.c rt_look.c rt_look2d_normal.c rt_lu_real.c rt_matdivrr_dbl.c rt_nonfinite.c rt_pow_snf.c rt_rem_snf.c rt_round_snf.c rt_zcfcn.c svd_d_rt.c svd_helper_rt.c 
MAKEFILE        := CSE1_CV3_1Straight.mk
...
MODELLIB                  := CSE1_CV3_1Straightlib.lib
MODELREF_LINK_LIBS   	  := 
MODELREF_INC_PATH         := 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\DOCUME~1\mcl\Desktop\MAINWO~1\USERIN~1\model\Simulink\CSE1_CV3_1Straight_nidll_vxworks_rtw
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\DOCUME~1\mcl\Desktop\MAINWO~1\USERIN~1\model\Simulink
