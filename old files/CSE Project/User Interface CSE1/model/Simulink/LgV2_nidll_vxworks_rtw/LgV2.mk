...
#
# File    : LgV2.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           := LgV2
MODULES         := LgV2_data.c is_little_endian_rt.c rtGetInf.c rtGetNaN.c rt_atan2_snf.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_hypot_snf.c rt_logging.c rt_look.c rt_look2d_normal.c rt_lu_real.c rt_matdivrr_dbl.c rt_nonfinite.c rt_rem_snf.c rt_round_snf.c rt_zcfcn.c svd_d_rt.c svd_helper_rt.c 
MAKEFILE        := LgV2.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\DOCUME~1\mcl\Desktop\CSEPRO~1\USERIN~1\model\Simulink\LgV2_nidll_vxworks_rtw
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\DOCUME~1\mcl\Desktop\CSEPRO~1\USERIN~1\model\Simulink
