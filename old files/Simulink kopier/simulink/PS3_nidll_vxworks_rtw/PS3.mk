...
#
# File    : PS3.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           := PS3
MODULES         := PS3_data.c is_little_endian_rt.c rtGetInf.c rtGetNaN.c rt_logging.c rt_look.c rt_look2d_normal.c rt_nonfinite.c svd_d_rt.c svd_helper_rt.c 
MAKEFILE        := PS3.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\DOCUME~1\mcl\Desktop\CSENTE~1\HMIs\models\simulink\PS3_nidll_vxworks_rtw
