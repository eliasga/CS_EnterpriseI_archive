...
#
# File    : Thruster.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           := Thruster
MODULES         := Thruster_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_look.c rt_look2d_normal.c rt_nonfinite.c 
MAKEFILE        := Thruster.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\DOCUME~1\mcl\Desktop\CSENTE~1\HMIs\models\simulink\Thruster_nidll_vxworks_rtw
