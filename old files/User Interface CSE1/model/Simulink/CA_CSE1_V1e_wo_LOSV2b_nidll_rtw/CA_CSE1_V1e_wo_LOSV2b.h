 ...
 */
#ifndef RTW_HEADER_CA_CSE1_V1e_wo_LOSV2b_h_
#define RTW_HEADER_CA_CSE1_V1e_wo_LOSV2b_h_
#ifndef CA_CSE1_V1e_wo_LOSV2b_COMMON_INCLUDES_
# define CA_CSE1_V1e_wo_LOSV2b_COMMON_INCLUDES_
#include <stdio.h>
#include <stddef.h>
#include <float.h>
#include <math.h>
...
#include "rt_MAX.h"
#include "rt_MIN.h"
#endif                                 /* CA_CSE1_V1e_wo_LOSV2b_COMMON_INCLUDES_ */

#include "CA_CSE1_V1e_wo_LOSV2b_types.h"
...
#define CA_CSE1_V1e_wo_LOSV2b_rtModel  RT_MODEL_CA_CSE1_V1e_wo_LOSV2b
...
typedef struct {
  ...
  real_T u1_p;                         /* '<S30>/Scaling_JS_L_X' */
  real_T PS3u_2;                       /* '<S9>/PS3 u_2' */
  real_T u1_a;                         /* '<S30>/Scaling_JS_R_Y' */
  real_T PS3u_3;                       /* '<S9>/PS3 u_3' */
  real_T u1_i;                         /* '<S30>/Scaling_JS_R_X' */
  ...
  real_T Saturation_c[7];              /* '<S1>/Saturation' */
  ...
  real_T Product1_b[3];                /* '<S46>/Product1' */
  real_T l_x1_j;                       /* '<S57>/-l_x1' */
  real_T l_y2_p;                       /* '<S57>/-l_y2' */
  real_T l_x2_o;                       /* '<S57>/-l_x2' */
  real_T x5_d[15];                     /* '<S57>/3x5' */
  ...
  real_T ThrusterGainmatrix_e[25];     /* '<S55>/Thruster Gain matrix' */
  real_T sampletime;                   /* '<S56>/sample time' */
  real_T Yk1;                          /* '<S56>/Delay Input2' */
  real_T R11_b;                        /* '<S52>/R11' */
  real_T R21_a;                        /* '<S52>/R21' */
  real_T R12_m;                        /* '<S52>/R12' */
  real_T R22_h;                        /* '<S52>/R22' */
  ...
  real_T Sum_e;                        /* '<S38>/Sum' */
  real_T VSPSPort;                     /* '<S38>/VSPS Port' */
  real_T VSPSStarboard;                /* '<S38>/VSPS Starboard' */
  real_T l_x1_e;                       /* '<S37>/-l_x1' */
  real_T l_y2_l;                       /* '<S37>/-l_y2' */
  real_T l_x2_j;                       /* '<S37>/-l_x2' */
  real_T x5_df[15];                    /* '<S37>/3x5' */
  ...
  real_T ThrusterGainmatrix_l[25];     /* '<S36>/Thruster Gain matrix' */
  ...
  real_T Saturation_m;                 /* '<S21>/Saturation' */
  real_T Sign_k;                       /* '<S21>/Sign' */
  real_T Gain_k;                       /* '<S21>/Gain' */
  real_T Sum1_i;                       /* '<S21>/Sum1' */
  real_T MathFunction;                 /* '<S21>/Math Function' */
  real_T Sum_jb;                       /* '<S21>/Sum' */
  real_T MultiportSwitch_j[3];         /* '<S7>/Multiport Switch' */
  ...
  real_T Sign_i;                       /* '<S17>/Sign' */
  real_T Gain_h;                       /* '<S17>/Gain' */
  real_T Sum1_h;                       /* '<S17>/Sum1' */
  real_T MathFunction_a;               /* '<S17>/Math Function' */
  real_T Sum_k;                        /* '<S17>/Sum' */
  real_T Saturation_m4;                /* '<S16>/Saturation' */
  real_T Sign_b;                       /* '<S16>/Sign' */
  real_T Gain_ki;                      /* '<S16>/Gain' */
  real_T Sum1_o;                       /* '<S16>/Sum1' */
  real_T MathFunction_d;               /* '<S16>/Math Function' */
  real_T Sum_o;                        /* '<S16>/Sum' */
  ...
  real_T Kp[3];                        /* '<S11>/Kp' */
  real_T Product2_d[3];                /* '<S11>/Product2' */
  ...
  real_T ThrusterGainmatrix_f[25];     /* '<S12>/Thruster Gain matrix' */
  real_T K_e1_b[25];                   /* '<S7>/K_e^-1' */
  real_T l_x1_jy;                      /* '<S14>/-l_x1' */
  real_T l_y2_n;                       /* '<S14>/-l_y2' */
  real_T l_x2_jn;                      /* '<S14>/-l_x2' */
  real_T x5_o[15];                     /* '<S14>/3x5' */
  real_T T_e_a[15];                    /* '<S7>/T_e^+' */
  real_T Product_b[15];                /* '<S7>/Product' */
  real_T TmpHiddenBufferAtProduct1Inpo_d[3];/* 'synthesized block' */
  real_T Product1_be[5];               /* '<S7>/Product1' */
  real_T DPu_1;                        /* '<S7>/DP u_1' */
  real_T DPu_2;                        /* '<S7>/DP u_2' */
  real_T DPu_3;                        /* '<S7>/DP u_3' */
  real_T DPu_4;                        /* '<S7>/DP u_4' */
  real_T DPu_5;                        /* '<S7>/DP u_5' */
  real_T Gain1_o[3];                   /* '<S13>/Gain1' */
  real_T xi_w[3];                      /* '<S13>/Integrator2' */
  real_T Gain2[3];                     /* '<S13>/Gain2' */
  real_T Sum4[3];                      /* '<S13>/Sum4' */
  real_T Sum2_d[3];                    /* '<S13>/Sum2' */
  real_T Saturation_n;                 /* '<S22>/Saturation' */
  real_T Sign_h;                       /* '<S22>/Sign' */
  real_T Gain_f;                       /* '<S22>/Gain' */
  real_T Sum1_c;                       /* '<S22>/Sum1' */
  real_T MathFunction_j;               /* '<S22>/Math Function' */
  real_T Sum_i;                        /* '<S22>/Sum' */
  real_T TmpHiddenBufferAtK11Inport1[3];/* 'synthesized block' */
  real_T K4[3];                        /* '<S13>/K4' */
  real_T Row1_c;                       /* '<S19>/Row1' */
  real_T Row2_b;                       /* '<S19>/Row2' */
  real_T Row3_n;                       /* '<S19>/Row3' */
  real_T bias[3];                      /* '<S13>/Integrator3' */
  real_T Row1_k;                       /* '<S20>/Row1' */
  real_T Row2_bv;                      /* '<S20>/Row2' */
  real_T Row3_l;                       /* '<S20>/Row3' */
  real_T Sum1_a[3];                    /* '<S13>/Sum1' */
  ...
  boolean_T UpperRelop_d;              /* '<S39>/UpperRelop' */
  boolean_T LowerRelop1_o;             /* '<S40>/LowerRelop1' */
  boolean_T UpperRelop_o;              /* '<S40>/UpperRelop' */
  boolean_T LowerRelop1_j;             /* '<S41>/LowerRelop1' */
  boolean_T UpperRelop_h;              /* '<S41>/UpperRelop' */
} BlockIO_CA_CSE1_V1e_wo_LOSV2b;
...
typedef struct {
  ...
  real_T K_e1_DWORK4_m[25];            /* '<S7>/K_e^-1' */
  struct {
    real_T TimeStampA;
  ...
  struct {
    void *FilePtr;
    void *LogFilePtr;
  } ToFile_PWORK_m;                    /* '<S7>/To File' */

  struct {
    void *FilePtr;
    void *LogFilePtr;
  } ToFile_PWORK_p;                    /* '<S11>/To File' */
  ...
  struct {
    int_T Count;
    int_T Decimation;
  } ToFile_IWORK_b;                    /* '<S7>/To File' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile_IWORK_j;                    /* '<S11>/To File' */

  int_T LinearSimulator_MODE;          /* '<S5>/Linear Simulator' */
  int_T DPcontrol_MODE;                /* '<S1>/DP control' */
  int_T CSE1_MODE;                     /* '<S5>/CSE1' */
  uint8_T SignalProbe_DWORK1[22];      /* '<Root>/SignalProbe' */
} D_Work_CA_CSE1_V1e_wo_LOSV2b;
...
typedef struct {
  ...
  real_T Integrator1_CSTATE_i[3];      /* '<S13>/Integrator1' */
  real_T Integrator_CSTATE_o[3];       /* '<S13>/Integrator' */
  real_T Integrator_CSTATE_e[3];       /* '<S11>/Integrator' */
...
} ContinuousStates_CA_CSE1_V1e_wo;
...
typedef struct {
  ...
  boolean_T Integrator1_CSTATE_i[3];   /* '<S13>/Integrator1' */
  boolean_T Integrator_CSTATE_o[3];    /* '<S13>/Integrator' */
  boolean_T Integrator_CSTATE_e[3];    /* '<S11>/Integrator' */
...
} StateDisabled_CA_CSE1_V1e_wo_LO;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Integrator_Reset_ZCE;     /* '<S46>/Integrator' */
  ZCSigState Integrator1_Reset_ZCE;    /* '<S46>/Integrator1' */
  ZCSigState Integrator_Reset_ZCE_b;   /* '<S11>/Integrator' */
} PrevZCSigStates_CA_CSE1_V1e_wo_;
...
#define rtB                            CA_CSE1_V1e_wo_LOSV2b_B
#define BlockIO                        BlockIO_CA_CSE1_V1e_wo_LOSV2b
#define rtX                            CA_CSE1_V1e_wo_LOSV2b_X
#define ContinuousStates               ContinuousStates_CA_CSE1_V1e_wo
#define rtP                            CA_CSE1_V1e_wo_LOSV2b_P
#define Parameters                     Parameters_CA_CSE1_V1e_wo_LOSV2
#define rtDWork                        CA_CSE1_V1e_wo_LOSV2b_DWork
#define D_Work                         D_Work_CA_CSE1_V1e_wo_LOSV2b
#define rtPrevZCSigState               CA_CSE1_V1e_wo_L_PrevZCSigState
#define PrevZCSigStates                PrevZCSigStates_CA_CSE1_V1e_wo_

/* Parameters (auto storage) */
struct Parameters_CA_CSE1_V1e_wo_LOSV2_ {
  ...
  real_T Constant_Value_c;             /* Expression: const
                                        * '<S10>/Constant'
                                        */
  real_T Saturation_UpperSat_m;        /* Expression: 1.0
                                        * '<S1>/Saturation'
                                        */
  real_T Saturation_LowerSat_f;        /* Expression: -1.0
                                        * '<S1>/Saturation'
                                        */
  ...
  real_T GainK_e5_DP_Gain;             /* Expression: 1
                                        * '<S12>/Gain K_e5_DP'
                                        */
  real_T T_e11_Value_p;                /* Expression: 1
                                        * '<S14>/T_e11'
                                        */
  ...
  real_T T_e22_Value_o;                /* Expression: 1
                                        * '<S14>/T_e22'
                                        */
  real_T l_x1_Value_l;                 /* Expression: 0.425
                                        * '<S14>/l_x1'
                                        */
  real_T l_x1_Gain_a;                  /* Expression: -1
                                        * '<S14>/-l_x1'
                                        */
  ...
  real_T l_y2_Value_o;                 /* Expression: 0.055
                                        * '<S14>/l_y2'
                                        */
  real_T l_y2_Gain_j;                  /* Expression: -1
                                        * '<S14>/-l_y2'
                                        */
  real_T T_e14_Value_o;                /* Expression: 0
                                        * '<S14>/T_e14'
                                        */
  real_T T_e24_Value_h;                /* Expression: 1
                                        * '<S14>/T_e24'
                                        */
  real_T l_x2_Value_o;                 /* Expression: 0.425
                                        * '<S14>/l_x2'
                                        */
  ...
  real_T T_e15_Value_g;                /* Expression: 0
                                        * '<S14>/T_e15'
                                        */
  real_T T_e25_Value_f;                /* Expression: 1
                                        * '<S14>/T_e25'
                                        */
  real_T l_x3_Value_h;                 /* Expression: 0.425
                                        * '<S14>/l_x3'
                                        */
  ...
  real_T DPu_5_Gain;                   /* Expression: 1
                                        * '<S7>/DP u_5'
                                        */
  real_T Gain1_Gain_m[9];              /* Expression: 2*lambda*w_o
                                        * '<S13>/Gain1'
                                        */
  ...
  real_T Saturation_UpperSat_a;        /* Expression: 1e10
                                        * '<S22>/Saturation'
                                        */
  real_T Saturation_LowerSat_fw;       /* Expression: -1e10
                                        * '<S22>/Saturation'
                                        */
  ...
  real_T invT_b_Gain[9];               /* Expression: diag([1/T_b(1,1) 1/T_b(2,2) 1/T_b(3,3)])
                                        * '<S13>/inv(T_b)'
                                        */
  real_T Saturation_UpperSat_ga;       /* Expression: 1.0
                                        * '<S7>/Saturation'
                                        */
  real_T Saturation_LowerSat_o;        /* Expression: -1.0
                                        * '<S7>/Saturation'
                                        */
  ...
  real_T BT_Power_Offset3_Value;       /* Expression: 0.05
                                        ...
                                        */
  real_T Constant_Value_ef;            /* Expression: 0
                                        * '<S35>/Constant'
                                        */
  ...
  real_T l_y1_Value_a;                 /* Expression: 0.055
                                        * '<S37>/l_y1'
                                        */
  real_T T_e12_Value_o;                /* Expression: 0
                                        * '<S37>/T_e12'
                                        */
  real_T T_e22_Value_p;                /* Expression: 1
                                        * '<S37>/T_e22'
                                        */
  real_T l_x1_Value_j;                 /* Expression: 0.425
                                        * '<S37>/l_x1'
                                        */
  real_T l_x1_Gain_f;                  /* Expression: -1
                                        * '<S37>/-l_x1'
                                        */
  real_T T_e13_Value_l;                /* Expression: 1
                                        * '<S37>/T_e13'
                                        */
  ...
  real_T l_y2_Value_g;                 /* Expression: 0.055
                                        * '<S37>/l_y2'
                                        */
  real_T l_y2_Gain_c;                  /* Expression: -1
                                        * '<S37>/-l_y2'
                                        */
  real_T T_e14_Value_g;                /* Expression: 0
                                        * '<S37>/T_e14'
                                        */
  real_T T_e24_Value_i;                /* Expression: 1
                                        * '<S37>/T_e24'
                                        */
  real_T l_x2_Value_f;                 /* Expression: 0.425
                                        * '<S37>/l_x2'
                                        */
  real_T l_x2_Gain_j;                  /* Expression: -1
                                        * '<S37>/-l_x2'
                                        */
  ...
  real_T T_e25_Value_j;                /* Expression: 1
                                        * '<S37>/T_e25'
                                        */
  real_T l_x3_Value_m;                 /* Expression: 0.425
                                        * '<S37>/l_x3'
                                        */
  ...
  real_T GainBTpower_Gain;             /* Expression: 1
                                        * '<S47>/Gain BT power'
                                        */
  real_T Neg_Gain_o;                   /* Expression: -1
                                        * '<S47>/Neg'
                                        */
  ...
  real_T T_e21_Value_l;                /* Expression: 0
                                        * '<S57>/T_e21'
                                        */
  real_T l_y1_Value_n;                 /* Expression: 0.055
                                        * '<S57>/l_y1'
                                        */
  real_T T_e12_Value_p;                /* Expression: 0
                                        * '<S57>/T_e12'
                                        */
  real_T T_e22_Value_k;                /* Expression: 1
                                        * '<S57>/T_e22'
                                        */
  real_T l_x1_Value_d;                 /* Expression: 0.425
                                        * '<S57>/l_x1'
                                        */
  real_T l_x1_Gain_o;                  /* Expression: -1
                                        * '<S57>/-l_x1'
                                        */
  real_T T_e13_Value_k;                /* Expression: 1
                                        * '<S57>/T_e13'
                                        */
  real_T T_e23_Value_e;                /* Expression: 0
                                        * '<S57>/T_e23'
                                        */
  ...
  real_T l_y2_Gain_h;                  /* Expression: -1
                                        * '<S57>/-l_y2'
                                        */
  real_T T_e14_Value_d;                /* Expression: 0
                                        * '<S57>/T_e14'
                                        */
  real_T T_e24_Value_g;                /* Expression: 1
                                        * '<S57>/T_e24'
                                        */
  real_T l_x2_Value_k;                 /* Expression: 0.425
                                        * '<S57>/l_x2'
                                        */
  real_T l_x2_Gain_c;                  /* Expression: -1
                                        * '<S57>/-l_x2'
                                        */
  real_T T_e15_Value_p;                /* Expression: 0
                                        * '<S57>/T_e15'
                                        */
  real_T T_e25_Value_o;                /* Expression: 1
                                        * '<S57>/T_e25'
                                        */
  real_T l_x3_Value_b;                 /* Expression: 0.425
                                        * '<S57>/l_x3'
                                        */
...
struct RT_MODEL_CA_CSE1_V1e_wo_LOSV2b {
  const char_T *path;
...
extern Parameters_CA_CSE1_V1e_wo_LOSV2 CA_CSE1_V1e_wo_LOSV2b_P;

/* Block signals (auto storage) */
extern BlockIO_CA_CSE1_V1e_wo_LOSV2b CA_CSE1_V1e_wo_LOSV2b_B;

/* Continuous states (auto storage) */
extern ContinuousStates_CA_CSE1_V1e_wo CA_CSE1_V1e_wo_LOSV2b_X;

/* Block states (auto storage) */
extern D_Work_CA_CSE1_V1e_wo_LOSV2b CA_CSE1_V1e_wo_LOSV2b_DWork;

/* Model entry point functions */
extern void CA_CSE1_V1e_wo_LOSV2b_initialize(boolean_T firstTime);
extern void CA_CSE1_V1e_wo_LOSV2b_output(int_T tid);
extern void CA_CSE1_V1e_wo_LOSV2b_update(int_T tid);
extern void CA_CSE1_V1e_wo_LOSV2b_terminate(void);

/* Real-time Model object */
extern RT_MODEL_CA_CSE1_V1e_wo_LOSV2b *CA_CSE1_V1e_wo_LOSV2b_M;
 ...
 *
 * '<Root>' : CA_CSE1_V1e_wo_LOSV2b
 * '<S1>'   : CA_CSE1_V1e_wo_LOSV2b/Control Systems
 * '<S2>'   : CA_CSE1_V1e_wo_LOSV2b/Guidance Systems
 * '<S3>'   : CA_CSE1_V1e_wo_LOSV2b/HMI
 * '<S4>'   : CA_CSE1_V1e_wo_LOSV2b/Naviagation Systems
 * '<S5>'   : CA_CSE1_V1e_wo_LOSV2b/Plants
 * '<S6>'   : CA_CSE1_V1e_wo_LOSV2b/Control Systems/Accuracy Control
 * '<S7>'   : CA_CSE1_V1e_wo_LOSV2b/Control Systems/DP control
 * '<S8>'   : CA_CSE1_V1e_wo_LOSV2b/Control Systems/Joystick Control
 * '<S9>'   : CA_CSE1_V1e_wo_LOSV2b/Control Systems/Manual Thrust control
 * '<S10>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/if DP Control Mode
 * '<S11>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/DP control/DP controller
 * '<S12>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/DP control/K_e
 * '<S13>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/DP control/Passive DP wave filter1
 * '<S14>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/DP control/T_e
 * '<S15>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/DP control/DP controller/Transposed rotation  matrix in yaw1
 * '<S16>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/DP control/DP controller/[-inf inf] to [-pi pi]
 * '<S17>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/DP control/DP controller/[-inf inf] to [-pi pi]1
 * '<S18>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/DP control/Passive DP wave filter1/Rotation matrix in yaw 1
 * '<S19>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/DP control/Passive DP wave filter1/Transposed rotation  matrix in yaw
 * '<S20>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/DP control/Passive DP wave filter1/Transposed rotation  matrix in yaw1
 * '<S21>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/DP control/Passive DP wave filter1/[-inf inf] to [-pi pi]
 * '<S22>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/DP control/Passive DP wave filter1/[-inf inf] to [-pi pi]1
 * '<S23>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/Joystick Control/K_e
 * '<S24>'  : CA_CSE1_V1e_wo_LOSV2b/Control Systems/Joystick Control/T_e
 * '<S25>'  : CA_CSE1_V1e_wo_LOSV2b/Guidance Systems/DP
 * '<S26>'  : CA_CSE1_V1e_wo_LOSV2b/HMI/Accuracy control
 * '<S27>'  : CA_CSE1_V1e_wo_LOSV2b/HMI/DP input
 * '<S28>'  : CA_CSE1_V1e_wo_LOSV2b/HMI/PS3 input
 * '<S29>'  : CA_CSE1_V1e_wo_LOSV2b/HMI/DP input/Degrees to Radians
 * '<S30>'  : CA_CSE1_V1e_wo_LOSV2b/HMI/PS3 input/PS3 signals
 * '<S31>'  : CA_CSE1_V1e_wo_LOSV2b/Naviagation Systems/Qualisys 6 DOF
 * '<S32>'  : CA_CSE1_V1e_wo_LOSV2b/Naviagation Systems/Qualisys 6 DOF/Euler angles to inverse rotation matrix
 * '<S33>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/CSE1
 * '<S34>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator
 * '<S35>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/CSE1/Bow Thruster
 * '<S36>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/CSE1/K_e
 * '<S37>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/CSE1/T_e
 * '<S38>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/CSE1/Voith Schneider Propeller
 * '<S39>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/CSE1/Bow Thruster/Saturation Dynamic
 * '<S40>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/CSE1/Bow Thruster/Saturation Dynamic1
 * '<S41>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/CSE1/Bow Thruster/Saturation Dynamic2
 * '<S42>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/CSE1/Voith Schneider Propeller /Cartesian to Polar Port
 * '<S43>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/CSE1/Voith Schneider Propeller /Cartesian to Polar Starboard
 * '<S44>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/CSE1/Voith Schneider Propeller /Radians to Degrees Port
 * '<S45>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/CSE1/Voith Schneider Propeller /Radians to Degrees Staroard
 * '<S46>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator/Vessel Dynamics
 * '<S47>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator/u to tau
 * '<S48>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator/Vessel Dynamics/D_L
 * '<S49>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator/Vessel Dynamics/Initial eta
 * '<S50>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator/Vessel Dynamics/Initial nu
 * '<S51>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator/Vessel Dynamics/M_inv
 * '<S52>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator/Vessel Dynamics/R(psi)
 * '<S53>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator/u to tau/Cartesian to Polar Port
 * '<S54>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator/u to tau/Cartesian to Polar Stbd
 * '<S55>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator/u to tau/K_e
 * '<S56>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator/u to tau/Rate Limiter Dynamic
 * '<S57>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator/u to tau/T_e
 * '<S58>'  : CA_CSE1_V1e_wo_LOSV2b/Plants/Linear Simulator/u to tau/Rate Limiter Dynamic/Saturation Dynamic
 */
#endif                                 /* RTW_HEADER_CA_CSE1_V1e_wo_LOSV2b_h_ */
...
Parameters_CA_CSE1_V1e_wo_LOSV2 rtParameter[NUMST+!TID01EQ];

#define CA_CSE1_V1e_wo_LOSV2b_P        (*param_lookup[tid][READSIDE])

Parameters_CA_CSE1_V1e_wo_LOSV2 *param_lookup[NUMST][2] = {
...
Parameters_CA_CSE1_V1e_wo_LOSV2 rtParameter[2];

#define CA_CSE1_V1e_wo_LOSV2b_P        rtParameter[READSIDE]
#endif
